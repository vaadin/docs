...
const generatedDocsThemePath = path.resolve(frontendGeneratedFolder, 'theme-docs.generated.js');
...
module.exports = function (config) {
  ...
  // Handle V14 Flow generating theme path that is not configured in resolve
  config.resolve.alias['generated/theme-docs.generated.js'] = generatedDocsThemePath;
