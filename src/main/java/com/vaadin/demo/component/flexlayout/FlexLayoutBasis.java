...
@Route("flex-layout-basis")
public class FlexLayoutBasis extends Div {

    public FlexLayoutBasis() {
        ...
        layout.setFlexBasis("100px", item2, item4);
        layout.setFlexBasis("75px", item3);
        // end::snippet[]
    ...
    public static class Exporter extends // hidden-source-line
            DemoExporter<FlexLayoutBasis> { // hidden-source-line
    } // hidden-source-line
}
