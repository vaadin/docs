...
@Route("chart-type-flags")
public class ChartTypeFlags extends Div {
    public ChartTypeFlags() {
        // tag::snippet[]
    ...
    public static class Exporter extends DemoExporter<ChartTypeFlags> { // hidden-source-line
    } // hidden-source-line
}
