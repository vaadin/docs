...
@Route("chart-type-heat-map")
public class ChartTypeHeatMap extends Div {
    public ChartTypeHeatMap() {
        // tag::snippet[]
    ...
    public static class Exporter extends DemoExporter<ChartTypeHeatMap> { // hidden-source-line
    } // hidden-source-line
}
