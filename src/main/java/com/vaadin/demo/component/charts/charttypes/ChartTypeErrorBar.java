...
@Route("chart-type-error-bar")
public class ChartTypeErrorBar extends Div {
    public ChartTypeErrorBar() {
        // tag::snippet[]
    ...
    public static class Exporter extends DemoExporter<ChartTypeErrorBar> { // hidden-source-line
    } // hidden-source-line
}
