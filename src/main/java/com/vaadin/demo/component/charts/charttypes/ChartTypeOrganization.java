...
@Route("chart-type-organization")
public class ChartTypeOrganization extends Div {
    public ChartTypeOrganization() {
        // tag::snippet[]
    ...
    public static class Exporter extends DemoExporter<ChartTypeOrganization> { // hidden-source-line
    } // hidden-source-line
}
