...
@Route("chart-type-scatter")
public class ChartTypeScatter extends Div {
    ...
    public static class Exporter extends DemoExporter<ChartTypeScatter> { // hidden-source-line
    } // hidden-source-line
}
