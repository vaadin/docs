...
@Route("chart-type-solid-gauge")
public class ChartTypeSolidGauge extends Div {
    public ChartTypeSolidGauge() {
        // tag::snippet[]
    ...
    public static class Exporter extends DemoExporter<ChartTypeSolidGauge> { // hidden-source-line
    } // hidden-source-line
}
