...
@Route("chart-type-polygon")
public class ChartTypePolygon extends Div {
    public ChartTypePolygon() {
        // tag::snippet[]
    ...
    public static class Exporter extends DemoExporter<ChartTypePolygon> { // hidden-source-line
    } // hidden-source-line
}
