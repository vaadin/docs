...
@Route("accordion-best-practices")
public class AccordionBestPractices extends Div {

    public AccordionBestPractices() {
        // tag::snippet[]
    ...
    public static class Exporter extends DemoExporter<AccordionBestPractices> { // hidden-full-source-line
