...
To be able to run tests locally, you might need to install a webdriver for your browser, see  <<dummy/../installing-webdrivers#,Installing Web Drivers>> for more details.
