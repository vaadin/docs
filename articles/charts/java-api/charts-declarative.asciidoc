...
In this tutorial, we go through how https://demo.vaadin.com/sampler/#addons/vaadin-charts/line-and-scatter/line[the Basic Line example] in the Vaadin Charts demo can be implemented using the declarative format.
