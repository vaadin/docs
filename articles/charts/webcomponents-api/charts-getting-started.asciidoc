...
The easiest way to get started is to use https://bower.io/[Bower].
...
For further examples, please see the on-line demo at https://demo.vaadin.com/vaadin-charts[demo.vaadin.com/vaadin-charts].

The API documentation can be explored at https://demo.vaadin.com/vaadin-charts-api/[demo.vaadin.com/vaadin-charts-api].
