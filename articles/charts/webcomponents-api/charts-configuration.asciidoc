...
Please, see more details about these in the https://demo.vaadin.com/vaadin-charts-api/[API]. For data configuration, see <<dummy/../../../charts/webcomponents-api/charts-data#charts.data,"Chart
Data">>.
...
See the https://demo.vaadin.com/vaadin-charts-api/[API] documentation of `plot-options` and each chart type under it for more
...
please refer to the https://demo.vaadin.com/vaadin-charts-api/[API] of Vaadin Charts.
