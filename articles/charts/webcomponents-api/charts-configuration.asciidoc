...
See the https://demo.vaadin.com/charts3-api/[API] documentation of `plot-options` and each chart type under it for more
...
please refer to the https://demo.vaadin.com/charts3-api/[API] of Vaadin Charts.
