...
tag name in https://html.spec.whatwg.org/#the-area-element[html specification].
...
See the https://demo.vaadin.com/charts3-api/[API] documentation for details regarding the plot options.
...
https://demo.vaadin.com/charts3-api/[API]
