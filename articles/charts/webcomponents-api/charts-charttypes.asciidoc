...
tag name in
https://html.spec.whatwg.org/#the-area-element[html specification].
...
See the https://demo.vaadin.com/vaadin-charts-api/[API] documentation for details regarding the plot options.
...
https://demo.vaadin.com/vaadin-charts-api/[API]
...
<vaadin-arearange-chart>
    ...
    <subtitle>https://ilmatieteenlaitos.fi/lampotilaennatyksia</subtitle>
    <legend enabled="false"></legend>
    <y-axis>
        <chart-title>Temperature °C</chart-title>
