...
:preview-feature: Message List Attachments
:feature-flag: com.vaadin.experimental.messageListAttachments
...
// Re-enable once https://github.com/vaadin/web-components/pull/11189 is available in a release.
// ifdef::react[]
// [source,tsx]
// ----
