...
// end::description[]
You can configure the text content, information about the sender, and the time of sending for each message. This page explains how to add this component to your project and how to configure it.
