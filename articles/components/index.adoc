...
image::{components-path-prefix}slider/slider.png["", opts=inline, role="banner"]

include::slider/index.adoc[tag=description]

[.sr-only]
<<{components-path-prefix}slider#,See Slider>>
...
image::{components-path-prefix}breadcrumbs/breadcrumbs.png["", role="banner"]

include::breadcrumbs/index.adoc[tag=description]

[.sr-only]
<<{components-path-prefix}breadcrumbs#,See Breadcrumbs>>
