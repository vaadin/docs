...
include::cookie-consent/index.adoc[tag=description]
...
ifdef::flow[]
[.component-card]
=== Flex Layout [badge-flow]#Flow#

image::{components-path-prefix}flex-layout/flex-layout.png["", opts=inline, role="banner"]

include::flex-layout/index.adoc[tag=description]

[.sr-only]
<<{components-path-prefix}flex-layout#,See Flex Layout>>
endif::[]
...
[.sr-only]
<<{articles}/flow/create-ui/creating-components#,Create Components in Java>>
