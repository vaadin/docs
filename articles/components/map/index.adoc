...
Line strings can be used to display routes, paths, or connections between points on the map.
A line string is defined by a sequence of coordinates. Using only two coordinates renders a straight line between those coordinates, while more than two coordinates renders a multi-segment line that connects all coordinates in the sequence.

[.example,themes="lumo,aura"]
--
[source,typescript]
----
include::{root}/frontend/demo/component/map/map-lines.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/map/MapLines.java[render,tags=snippet,indent=0,group=Flow]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/map/GeoJsonRoute.java[indent=0,group=Flow]
----
--
...
The Map component includes a set of built-in controls, either for user interaction or for displaying information.
The following table lists the controls that are available out of the box:
[cols="1,4,2"]
|===
...
[source,typescript]
----
include::{root}/frontend/demo/component/map/map-scale-control.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/map/MapScaleControl.java[render,tags=snippet,indent=0,group=Flow]
----
--
