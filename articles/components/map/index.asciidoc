...
Icons can be configured as either a URL or a https://vaadin.com/docs/advanced/dynamic-content#using-streamresource[StreamResource].
...
See https://vaadin.com/docs/configuration/feature-flags#[Feature Flags] for more information.
