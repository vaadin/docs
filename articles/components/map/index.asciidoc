...
// end::description[]
It supports multiple layers, tiled and full-image sources, adding markers, and interaction through events. This page explains how to add the Map component to your project and how to configure it.
