...
layout: tabbed-page
title: Login
description: How to use the Login component to authenticate users.
page-links:
...
// tag::description[]
Login is a Vaadin component that contains a log-in form. You can use it to authenticate the user with a username and password.
// end::description[]
...
Overlay provides a custom form area for adding fields in addition to username and password. This area is placed above the "Submit" button. Use `name` attribute to ensure custom field `value` is submitted with the form.
