...
// end::description[]
It's compatible with password managers, supports internationalization and works on all device sizes. This page explains how to add the Login component to your project and how to configure it.
