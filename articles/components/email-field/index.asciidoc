...
// end::description[]
If the given address is invalid, the field is highlighted in red and an error message appears underneath the input. This page explains how to add an Email Field to your project and how to configure it.
