...
Tooltips can be configured on menu items to provide additional information. Use the `tooltipPosition` property to control where the tooltip appears relative to its item. When an item is disabled, its tooltip isn't shown.
