...
Individual menu items can be styled by [since:com.vaadin:vaadin@V24.3]#applying custom classnames# to them, and writing CSS style blocks targeting those classnames.
