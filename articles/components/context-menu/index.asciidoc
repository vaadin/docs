...
// end::description[]
The menu appears on right (default) or left click. On a touch device, a long press opens the context menu. This page explains how to add this component to your project and how to configure it.
