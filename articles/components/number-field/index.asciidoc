...
include::{articles}/components/_input-field-common-features.adoc[tags=label;helper;placeholder;tooltip;clear-button;prefix-and-suffix]
...
include::{articles}/components/_input-field-common-features.adoc[tags=text-alignment;small-variant;helper-above-field]
