...
Vaadin Directory is a place to find community-built add-ons for your apps, such as components and themes, and to share your work with others.
...
You can create your own components by combining or extending existing ones, or by constructing new ones using the Element Java API in Flow.
...
Learn how to integrate your own or third-party W3C-standard Web Components into your Vaadin application.
