...
image::{components-path-prefix}multi-select-combo-box/multi-select-combo-box.png["", role="icon screenshot"]
...
[.component-card]
=== Icons
image::{articles}/components/_images/icons-icon.svg["", opts=inline, role="icon screenshot"]
...
=== Lumo Theme
image::{articles}/components/_images/foundation-icon.svg[opts=inline, role=icon]
...
=== Figma Libraries
image::{articles}/components/_images/figma-logo.svg[opts=inline, role=icon]
...
=== Custom Themes
image::{articles}/components/_images/custom-themes-icon.svg[opts=inline, role=icon]
...
=== Theme Editor
image::{articles}/components/_images/theme-editor-icon.png[role=icon,width=224]
...
=== CSS Utility Classes
image::{articles}/components/_images/utility-classes-icon.svg[opts=inline, role=icon]
