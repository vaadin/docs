...
For long item lists, opening the overlay at the top isn't always the most useful place to land. Opt in with [methodname]`setFocusSelectedItem(true)` and the overlay scrolls to and focuses the selected item whenever it opens.
