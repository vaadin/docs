...
// end::description[]
It supports lazy loading and can be configured to accept custom typed values. This page explains how to add this component to your project and how to configure it.
