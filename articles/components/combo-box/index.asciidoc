...
For example, if you only want to show items that start with the user's input:
...
include::{articles}/components/_input-field-common-features.adoc[tags=constraints-intro;required;pattern;allowed-chars]
