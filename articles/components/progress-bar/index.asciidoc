...
// end::description[]
The progress can be determinate or indeterminate. Use Progress Bar to show an ongoing process that takes a noticeable time to finish. This page explains how to add this component to your project and how to configure it.
