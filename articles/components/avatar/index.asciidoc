...
[NOTE]
This component is optimized for use with https://vaadin.com/collaboration[Collaboration Engine] — an easy way to build real-time collaboration into your app — but can also be used standalone as a regular component.
...
See <<{articles}/styling/lumo/design-tokens/size-space#,Size and Space>> for details on how to
