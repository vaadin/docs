...
[source,typescript]
----
include::{root}/frontend/demo/component/notification/notification-static-helper.ts[frame,render,tags=snippet,indent=0,group=Lit]
----
endif::[]
...
[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/notification/NotificationStaticHelper.java[frame,render,tags=snippet,indent=0,group=Flow]
----
endif::[]
...
[source,tsx]
----
include::{root}/frontend/demo/component/notification/react/notification-static-helper.tsx[frame,render,tags=snippet,indent=0,group=React]
----
endif::[]
--
