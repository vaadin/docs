---
title: Notification
page-title: Notification component | Vaadin components
...
meta-description: Use the Vaadin Notification component to to provide feedback to the user about activities, processes, and events in your application.
page-links:
...
++++
<style>
:is(.rich, .position).example iframe {
  height: 400px;
}
</style>
++++
...
[source,typescript]
----
include::{root}/frontend/demo/component/notification/notification-position.ts[frame,render,tags=snippet,indent=0,group=Lit]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/notification/NotificationPosition.java[frame,render,tags=snippet,indent=0,group=Flow]

...

include::{root}/src/main/java/com/vaadin/demo/component/notification/NotificationPosition.java[frame,render,tags=createButton,indent=0,group=Flow]

...

include::{root}/src/main/java/com/vaadin/demo/component/notification/NotificationPosition.java[frame,render,tags=show,indent=0,group=Flow]
----
...
[source,tsx]
----
include::{root}/frontend/demo/component/notification/react/notification-position.tsx[frame,render,tags=snippet,indent=0,group=React]
----
--
...
[source,html]
----
include::{root}/frontend/demo/component/notification/notification-rich.ts[frame,render,tags=snippet,indent=0,group=Lit]
----
endif::[]
...
[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/notification/NotificationRich.java[frame,render,tags=snippet,indent=0,group=Flow]
----
endif::[]
...
[source,tsx]
----
include::{root}/frontend/demo/component/notification/react/notification-rich.tsx[frame,render,tags=snippet,indent=0,group=React]
----
endif::[]
--
