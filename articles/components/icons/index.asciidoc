...
This tool converts a folder of SVG files into `<vaadin-iconset>` and corresponding Java enum files.
You can then download them and place them in your project.
