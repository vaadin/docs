...
This, unfortunately, implies that there is no standard, simple steps to follow that would work for all icon sets.
Sill, as an example, you can consider how projects generated from https://start.vaadin.com[Vaadin Start] use the icons from the https://icons8.com/line-awesome/[Line Awesome] icon set.
