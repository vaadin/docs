...
public enum FontAwesomeIcons {
  HOUSE("fa-house"), HEART("fa-heart"), STAR("fa-star");

  private final String iconClasses;

  private FontAwesomeIcons(String iconClasses) {
    this.iconClasses = iconClasses;
  }

  public FontIcon create() {
    return new FontIcon("fa", iconClasses);
  }
}
----
endif::[]
