...
In a non-Vaadin application, you need to import the <<{articles}/components/ds-resources/foundation/size-space#,sizing>> style sheet to use the sizing properties.
