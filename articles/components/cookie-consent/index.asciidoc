...
// end::description[]
They require users to be informed and explicitly give consent to the usage of cookies. This page explains how to add this component to your project and how to configure it.
