...
The detail area is automatically shown or hidden when content is added or removed from it. There is no explicit visibility state to control the visibility of the detail area.
