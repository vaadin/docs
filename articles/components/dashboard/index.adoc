...
[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/dashboard/DashboardStorage.java[indent=0,group=Flow]
----
endif::[]
...
[source,typescript]
----
include::{root}/frontend/demo/component/dashboard/dashboard-storage.ts[indent=0,group=React]
----
endif::[]
