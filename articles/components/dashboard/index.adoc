...
- Saving: When saving the user's customized dashboard layout, map the current configuration (e.g., colspan, rowspan, type, custom metadata) of your dashboard's widgets back to your data model format.
