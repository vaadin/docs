...
Alternatively, all rows can be pinned to a fixed height. When set, this overrides the minimum row height and prevents rows from expanding to fit their tallest widget.
...
[.example.short,themes="lumo,aura"]
--
ifdef::flow[]
[source,java]
----
...
[source,typescript]
----
include::{root}/frontend/demo/component/dashboard/dashboard-item-removal.ts[tags=snippet,indent=0,group=Lit]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/dashboard/DashboardItemRemoval.java[tags=snippet,indent=0,group=Flow]
----

[source,tsx]
----
include::{root}/frontend/demo/component/dashboard/react/dashboard-item-removal.tsx[tags=snippet,indent=0,group=React]
----
--
