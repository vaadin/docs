...
A non-modal dialog, on the other hand, doesn't block interaction.
...
You can choose whether or not to make the component's content draggable as well, or only the component itself.
