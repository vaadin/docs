...
The Dialog size can be set in two ways:

. By setting width and height on the Dialog itself (__since V24.6 for React and Lit__)
. By setting the size of the Dialog's contents, whereby the Dialog scales to accommodate it

In both cases, the Dialog can also be made resizable.
