...
Characters that you enter into Text Field can be restricted using a regular expression. When enabled, the entry of characters not matching the regular expression is prevented and gives the field a short shake.
