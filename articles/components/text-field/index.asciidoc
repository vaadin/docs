...
Pattern is a regular expression that Text Field's value is matched against during validation. Any value that doesn't match the pattern invalidates the field.

The following examples invalidates any value that doesn't consist exclusively of numbers, parentheses, dashes, and the plus sign:
