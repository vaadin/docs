...
This example allows the input of only numbers, parentheses, dashes, and the plus sign.
...
See <<{articles}/components/ds-resources/foundation/size-space#,Size and Space>> for details on how to change the default text field size.
