...
Characters that you enter into Text Field can be restricted using a regular expression. When enabled, the user can't enter characters that match the regular expression. If they try to enter such characters, the component gives visual feedback that the input was prevented.
