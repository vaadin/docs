...
To use this feature, you need to specify the item you want to view. The scroll position of the grid will then be adjusted to bring that item into view.

If the item has collapsed parents, they will expand before scrolling to the item.
...
To use this feature, you need to specify the path of the item you want to view. The scroll position of the grid will then be adjusted to bring that item into view.

In contrast to scrolling to an item, possible collapsed parents of the item will not expand before scrolling.
