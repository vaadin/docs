...
[NOTE]
--
In Flow, drag-and-drop works best with data providers that use the flattened hierarchy format. It gives more predictable scrolling and allows Tree Grid to maintain its scroll position after hierarchy changes. You can find more details about this and other formats in the <<../tree-grid/data-providers#hierarchy-formats,Hierarchy Formats>> section in the <<../tree-grid/data-providers#,Data Providers>> tab.
--
