---
title: Split Layout
page-title: Split Layout component | Vaadin components
description: Split Layout is a component with two content areas and a draggable split handle between them.
meta-description: Learn to create resizable layouts in your Vaadin application with the Split Layout component.
page-links:
