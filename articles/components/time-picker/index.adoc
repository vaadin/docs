---
title: Time Picker
page-title: Time Picker component | Vaadin components
...
[%collapsible]
====
The valid input range of Time Picker can be restricted by defining `min` and `max` values. Times before the `min` and after the `max` aren't displayed in the overlay. Helper text can be used to inform the user about the accepted range.
====
...
[source,html]
----
include::{root}/frontend/demo/component/timepicker/time-picker-validation.ts[render,tags=snippet,indent=0,group=Lit]
----
endif::[]
...
[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/timepicker/TimePickerValidation.java[render,tags=snippet,indent=0,group=Flow]
----
endif::[]
...
[source,tsx]
----
include::{root}/frontend/demo/component/timepicker/react/time-picker-validation.tsx[render,tags=snippet,indent=0,group=React]
----
endif::[]
--
...
Binder can also be used to organize data binding and validation for multiple fields, creating forms. You can learn more about Binder from the corresponding <<{articles}/flow/binding-data/components-binder-validation#,Flow>> and <<{articles}/hilla/guides/forms/binder-validation#,Hilla>> articles.
