...
formLayout.add(new FormItem(saveButton));
----
...
Alternatively, you can write custom CSS. When labels are rendered next to fields, Form Layout sets the `has-labels-aside` attribute on its host element and the `data-form-layout-has-labels-aside` attribute on fields. You can use these attributes to adapt custom components to labels-aside mode:

[source,css]
----
/* From outside the component */
vaadin-form-layout[has-labels-aside] your-custom-component {
  ...
}

/* From inside the component's shadow DOM */
