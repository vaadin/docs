...
In Vaadin 26, auto-responsive mode becomes the default, and responsive steps mode becomes a deprecated legacy feature. You can prepare for this change already today by enabling the <<{articles}/flow/configuration/feature-flags#,feature flag>> `defaultAutoResponsiveFormLayout`.
====
