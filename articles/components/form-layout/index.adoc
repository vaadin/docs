...
Use [classname]`FormAIController` to let users fill a Form Layout from natural-language input or attached files. See <<ai-powered#, AI-Powered Form [badge-flow]#Flow#>>.
