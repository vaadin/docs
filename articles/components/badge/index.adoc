...
Badges can display a number without a visible label using the `number-only` style variant.
For accessibility, the text label should still be provided — it's only hidden visually but available for screen readers to ensure that all users can identify the meaning of the badge.
...
[source,html]
----
include::{root}/frontend/demo/component/badge/badge-number-only.ts[render,tags=snippet,indent=0,group=Lit]
----
endif::[]
...
[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/badge/BadgeNumberOnly.java[render,tags=snippet,indent=0,group=Flow]
----
endif::[]
...
[source,tsx]
----
include::{root}/frontend/demo/component/badge/react/badge-number-only.tsx[render,tags=snippet,indent=0,group=React]
----
endif::[]
--
