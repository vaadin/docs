...
Icon-only badges should primarily be used for extremely common recurring content with highly standardized, universally understood icons (such as a checkmark for "_yes_"), and for content that's repeated, for example in lists and tables.
