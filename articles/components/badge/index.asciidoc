...
// end::description[]
They're used for labeling content, displaying metadata and/or highlighting information. This page explains how to add this component to your project and how to configure it.
