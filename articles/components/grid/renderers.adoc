...
Although most grid content is typically plain text, renderers can be used to render the contents of specific columns using components and native HTML elements.
...
== Grid Renderers in Flow

The Grid API in Flow supports three types of renderer:
