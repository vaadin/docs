...
[source,typescript]
----
include::{root}/frontend/demo/react/grid/grid-basic.tsx[render,tags=snippet,indent=0,group=React]
----
...
This mode enables virtual scrolling horizontally. It only renders body cells when their corresponding columns are inside the visible viewport.
...
[source,typescript]
----
include::{root}/frontend/demo/react/grid/grid-styling.tsx[render,tags=snippet,indent=0,group=React]
----
