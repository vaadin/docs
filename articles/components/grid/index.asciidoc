...
This disables scrolling and should not be used for large data sets, to avoid performance issues.
...
Using a context menu should not be the only way of accomplishing a task.
