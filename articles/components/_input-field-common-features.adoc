...
Prefix and suffix elements are not announced by screen readers by default. They can be [since:com.vaadin:vaadin@V25.3]#associated with the field as its ARIA description# through the `accessible-description-ref` attribute ([methodname]`setAriaDescribedBy` in Flow):
...
Prefix elements are not announced by screen readers by default. They can be [since:com.vaadin:vaadin@V25.3]#associated with the field as its ARIA description# through the `accessible-description-ref` attribute ([methodname]`setAriaDescribedBy` in Flow):
...
Suffix elements are not announced by screen readers by default. They can be [since:com.vaadin:vaadin@V25.3]#associated with the field as its ARIA description# through the `accessible-description-ref` attribute ([methodname]`setAriaDescribedBy` in Flow):
