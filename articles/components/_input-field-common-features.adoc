...
[%collapsible]
====
The small variant can be used to make individual fields more compact. The default size of fields can be customized with <<{articles}/styling/styling-components/theme-style-properties#,Theme Style Properties>>.
====
// end::small-variant[]
