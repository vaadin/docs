...
*They do not work in the shadow DOM of Vaadin components*, i.e. style sheets in the `components` sub-folder or loaded with the `@CssImport` annotation's `themeFor` property. 
