...
=== Hilla
In Hilla, the root layout is defined in a file called `@layout.tsx` in the `views` directory. An `<Outlet/>` element is used to tell the router where to render the contents of routes/views.
