...
Single Click Edit's a mode that enables the user to begin editing by single-clicking on an editable cell.
...
Single Cell Edit's a mode that makes tabbing from one cell to another exit from edit mode.
