...
- kbd:[Tab] and kbd:[Shift + Tab] save changes and shift focus to the next or previous editable cell, respectively, while remaining in edit mode.
...
By default, when in edit mode, kbd:[Tab] moves the focus to the next cell and kbd:[Shift+Tab] moves the focus to the previous editable cell -- while remaining in edit mode.

Basically, Single Cell Edit is a mode that allows tabbing from one cell to another without exiting from edit mode.
...
Pressing kbd:[Enter] or kbd:[Shift+Enter] saves any changes and exits edit mode, by default. However, kbd:[Enter] can be made to shift focus to the editable cell in the next row, by using the Enter Next Row mode. The same can be done for kbd:[Shift+Enter], but to shift the focus to the editable cell in the previous row.
