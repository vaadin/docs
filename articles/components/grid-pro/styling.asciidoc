...
Row (any):: `vaadin-grid-pro+++<wbr>+++**::part(row)**`
First row:: `vaadin-grid-pro+++<wbr>+++**::part(first-row)**`
Last row:: `vaadin-grid-pro+++<wbr>+++**::part(last-row)**`
Even row:: `vaadin-grid-pro+++<wbr>+++**::part(even-row)**`
Odd row:: `vaadin-grid-pro+++<wbr>+++**::part(odd-row)**`
Selected row:: `vaadin-grid-pro+++<wbr>+++**::part(selected-row)**`
