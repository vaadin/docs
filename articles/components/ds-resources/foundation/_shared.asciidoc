...
----
include::{root}/frontend/demo/foundation/{import-name}-tokens.ts[tags="{module-name}",group=TypeScript]
----

[source,typescript,subs="attributes"]
----
include::{root}/frontend/demo/foundation/{import-name}-tokens.ts[hidden]
----
