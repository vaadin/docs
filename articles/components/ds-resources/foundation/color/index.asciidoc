...
You can use these <<{articles}/components/ds-resources/customization/css-custom-properties#,CSS Custom Properties>> to apply a consistent color palette across your application.
...
include::{root}/articles/components/ds-resources/foundation/_shared.asciidoc[tag=dark-mode]
