...
include::{root}/articles/components/ds-resources/foundation/_shared.asciidoc[tag=importing]
...
The Roboto font is used, if available.
You should either include Roboto locally in your project, or import it from https://fonts.google.com/specimen/Roboto[Google Fonts].
