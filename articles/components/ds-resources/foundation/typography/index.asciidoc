...
You can use these <<{articles}/components/ds-resources/customization/css-custom-properties#,CSS Custom Properties>> to apply consistent typographic styles across your application.
