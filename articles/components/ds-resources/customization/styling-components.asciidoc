...
See <<{articles}/styling/custom-theme/creating-custom-theme#, Creating a Custom Theme>> for instructions how to import the above styles into the local style scope of the Text Field component.
...
As an overlay is considered as a sub-component of the main component, <<{articles}/styling/lumo/variants/component-variants#, sub-component variants>> apply to them as well.
...
Same as <<overlays>>, an Input Container is considered as a sub-component of the main component, <<{articles}/styling/lumo/variants/component-variants#, sub-component variants>> apply to them as well.
...
You can also use the `theme` attribute (see <<{articles}/styling/custom-theme/custom-component-variants#,custom component variants>>) as a scoping selector for your style overrides, as shown in the example below.
