...
You should be familiar with <<style-scopes#,Style Scopes>>, <<css-custom-properties#,CSS Custom Properties>>, and <<{articles}/styling/custom-theme#, Custom Theme>> before you can style Vaadin components effectively.
...
See <<{articles}/styling/custom-theme#, Creating a Custom Theme>> for instructions how to import the above styles into the local style scope of the Text Field component.
...
As an overlay is considered as a sub-component of the main component, <<component-variants#sub-component-variants, sub-component variants>> apply to them as well.
...
Same as <<overlays>>, an Input Container is considered as a sub-component of the main component, <<component-variants#sub-component-variants, sub-component variants>> apply to them as well.
