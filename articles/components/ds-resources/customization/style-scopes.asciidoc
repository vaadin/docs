...
As an example, the <<{articles}/components/ds-resources/foundation/color#,Color>> properties can be defined in the global scope and they affect the styles of all components.
