...
You can also create your own <<{articles}/styling/custom-theme/creating-custom-theme#, custom theme>> that can be packaged for reuse in multiple applications.
...
See <<{articles}/styling/custom-theme/creating-custom-theme#, Custom Theme>>.
