...
Read-only elements can't be edited, but they are part of the tabbing order and can thus receive focus.
...
It's recommended to set the most common option as the default value for Radio Button Groups.
