...
include::{articles}/components/_input-field-common-features.adoc[tags=styles-start;helper-above-field;label-aside]

|`vertical`
|Vertical layout for radio group items
|Lumo

|`horizontal`
|Horizontal layout for radio group items
|Aura
