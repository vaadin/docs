---
title: Radio Button
page-title: Radio Button component | Vaadin components
description: Radio Button Group allows users to select one value among multiple choices.
meta-description: Implement radio button groups in your Vaadin applications for inputs that allow users to select one value among multiple choices.
page-links:
