...
[WARNING]
While it's technically possible to put _any_ UI element in a menu item, this can cause problems in terms of accessibility, as it may not be possible to focus them, and they may not be correctly interpreted by assistive technologies.
