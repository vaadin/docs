...
As only one primary action should be presented in the same part of the UI, this should be used only for <<#dropdown-and-combo-buttons,drop-down button use cases>>.
