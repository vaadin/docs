...
[TIP]
The standard Menu Button styles can be adjusted using <<{articles}/styling/lumo/design-tokens/color#,theme features>>. These variants should be used only to differentiate special instances of the component.
