...
* *Icon-only* menu buttons should provide a *textual alternative for screen readers* using the `aria-label` attribute or [since:react-dom@v23.3]#<</../tooltip,tooltips>>#.
