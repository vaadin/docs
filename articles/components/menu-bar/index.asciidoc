...
[WARNING]
While it's technically possible to put any UI element in a dropdown menu, including interactive components, they will not be accessible by keyboard or assistive technologies.
