...
[TIP]
The standard Menu Button styles can be adjusted using <<{articles}/lumo/lumo-style-properties#,the Lumo style properties>>. These variants should be used only to differentiate special instances of the component.
