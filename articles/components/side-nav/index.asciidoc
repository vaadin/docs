...
In order to use the Side Navigation component, it must be explicitly enabled with a feature flag. There are two methods of doing this: using Vaadin Developer Tools; or by adding a Feature Flags properties file.
