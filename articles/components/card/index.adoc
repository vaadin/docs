...
In order to ensure that the title is the first announced element for screen reader users, it is recommended to keep it ahead of the subtitle in the DOM order. Using flexbox and order can visually place the subtitle before the title without affecting the DOM order.
