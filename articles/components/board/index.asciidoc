...
// end::description[]
It reorders the components inside it on different screen sizes while maximizing the use of available space. This page explains how to add the Board component to your project and how to configure it.
