---
title: Board
page-title: Board | Vaadin components
description: Board is a powerful and easy-to-use layout element for building views that work with various screen sizes.
meta-description: The Vaadin component Board is a powerful and easy-to-use layout element for building views that work with various screen sizes.
page-links:
...
= [deprecated:com.vaadin:vaadin@V25.0]#Board#

:commercial-feature: Board
include::{articles}/_commercial-banner.adoc[opts=optional]

.Board will be removed in Vaadin 26.
[WARNING]
====
Don't start a new project using Board. Existing projects should consider migrating to <<../dashboard#,Dashboard>> in Vaadin 25.
====
