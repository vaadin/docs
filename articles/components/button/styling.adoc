...
[TIP]
The standard Button colors can be adjusted using <<{articles}/styling/themes/lumo/lumo-style-properties/color#,the Lumo color properties>>. Therefore, these variants shouldn't be used to replace standard buttons only to achieve a different color.
