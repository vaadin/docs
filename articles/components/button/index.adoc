...
[source,html]
----
include::{root}/frontend/demo/component/button/button-danger.ts[render,tags=snippet,indent=0,group=Lit]
----
endif::[]
...
[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/button/ButtonDanger.java[render,tags=snippet,indent=0,group=Flow]
----
endif::[]
...
[source,tsx]
----
include::{root}/frontend/demo/component/button/react/button-danger.tsx[render,tags=snippet,indent=0,group=React]
----
endif::[]
--
