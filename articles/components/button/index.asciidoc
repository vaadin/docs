...
* Additionally [since:com.vaadin:vaadin@V23.3]##<<../tooltip#,tooltips>>## can be added to provide a description of the action that the button triggers. See the close button in the demo above for an example.
