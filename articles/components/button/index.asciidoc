...
[TIP]
The standard Button colors can be adjusted using <<{articles}/styling/lumo/design-tokens/color#,theme features>>, so these variants shouldn't be used to replace standard buttons just to achieve a different color.
