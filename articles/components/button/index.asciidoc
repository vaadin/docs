...
Buttons in forms should be placed below the form with which they're associated. They should be aligned left, with primary action first, followed by other actions, in order of importance.
