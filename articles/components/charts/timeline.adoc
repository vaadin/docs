---
title: Timeline
page-title: How to create timeline charts with Vaadin Charts
description: How to add the ability to select different time ranges for charts.
meta-description: Discover how to design and customize timeline charts in Vaadin applications.
order: 8
---
...
<<charttypes/pie#charts.charttypes.pie, `pie`>>,
<<charttypes/gauge#charts.charttypes.gauge, `gauge`>>,
<<charttypes/solid-gauge#charts.charttypes.solidgauge, `solidgauge`>>,
<<charttypes/funnel-and-pyramid#charts.charttypes.funnel, `pyramid`>>, and
<<charttypes/funnel-and-pyramid#charts.charttypes.funnel, `funnel`>>.
