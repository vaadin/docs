...
description: How to style a chart with CSS or with Flow API in your project.
meta-description: Learn how to style Vaadin Charts using CSS or Flow API. Customize colors, fonts, and layouts to align with your application design.
order: 5
---
...
=== Flow Styling Example

In this example Flow API is used to change the color of point markers to yellow, their outline to purple, x-axis labels to blue, and the line color to black.
