...
layout: tabbed-page
meta-description: Learn how to export Vaadin charts as SVG with the SVGGenerator class, or use a remote export service to download charts in various image formats.
order: 10
---
...
[CAUTION]
Use the <<../basic-use#,Chart>> component to render charts.
