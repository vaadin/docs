---
title: Basic Use
page-title: How to use Vaadin Charts for data visualization
description: The basic use of charts in a view.
meta-description: Discover the basics of creating interactive and responsive charts with Vaadin. Learn how to visualize data effectively in your applications.
order: 3
---
