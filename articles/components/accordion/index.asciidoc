...
// end::description[]
It reduces clutter and helps maintain the user's focus by showing only the relevant content at any time. This page explains how to add this component to your project and how to configure it.
