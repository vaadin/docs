...
* The expandable/collapsible nature of accordions can sometimes be difficult for users to discover.
Use the <<filled-panels,filled variant>> and/or apply [since:com.vaadin:vaadin@V23.3]##<<../tooltip#,tooltips>>## on the panels to make this more discoverable.
