...
* The expandable/collapsable nature of accordions can sometimes be difficult for users to discover. Use the <<filled_panels,filled variant>> and/or apply <<../tooltip#,tooltips>> on the panels to make this more discoverable.
