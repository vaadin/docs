...
The expandable and collapsible nature of accordions can sometimes be difficult for users to discover. Use the <<styling#filled-panels,filled variant>> and apply <<../tooltip#,tooltips>> on the panels to make this more discoverable.
