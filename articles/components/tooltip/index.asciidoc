...
Keep in mind that Vaadin components and other UI elements don't, by default, imply the presence of tooltips in any way, making them difficult for users to discover.
