---
title: Tooltip
page-title: Tooltip component | Vaadin components
description: Tooltips are small pop-ups for providing additional information about other UI elements.
meta-description: Use the Vaadin Tooltip component in your application to add small pop-ups for providing additional information about other user interface elements.
page-links:
...
[source,html]
----
include::{root}/frontend/demo/component/tooltip/tooltip-positioning.ts[render,frame,tags=snippet,group=Lit,indent=0]
----
endif::[]
