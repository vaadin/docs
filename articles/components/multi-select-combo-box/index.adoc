...
page-title: Multi-Select Combo Box component | Vaadin components
description: Adding a combo box to a project for users to be able to make multiple selections.
meta-description: Learn how to use multi-select combo boxes in Vaadin for advanced selection options.
page-links:
...
- <<../combo-box#partial-match-selection, Partial Match Selection>>
