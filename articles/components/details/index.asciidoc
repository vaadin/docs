...
The expandable/collapsable nature of Details panels can sometimes be difficult for users to discover. Use the <<filled_panels,filled variant>> and/or apply a [since:react-dom@v23.3]#<</../tooltip,tooltip>># to make this more discoverable.
