...
This can be used, for example, to display the status of the corresponding content.
...
However, avoid putting important information in a Details component unless it's expanded by default.
...
The expandable and collapsible nature of Details can sometimes be difficult for users to discover.
Use the <<filled,filled variant>> and apply a [since:com.vaadin:vaadin@V23.3]##<<../tooltip#,tooltips>>## to make this more discoverable.
