...
The expandable/collapsable nature of Details panels can sometimes be difficult for users to discover. Use the <<filled_panels,filled variant>> and/or apply a <<../tooltip#,tooltip>> to make this more discoverable.
