...
Details has three theme variants: `filled`, `small`, and `reverse`. These variants can be combined with each other. For example, all three themes variants can be applied to the same Details component.
