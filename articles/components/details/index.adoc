...
meta-description: The Vaadin component Details is an expandable panel for showing and hiding content from the user, to make the UI less cluttered.
page-links:
...
The expandable and collapsible nature of Details can sometimes be difficult for users to discover. Use the <<styling#filled,filled variant>> and apply a <<../tooltip#,tooltips>> to make this more discoverable.
