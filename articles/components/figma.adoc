...
// end::description[]
There are separate libraries for the Aura and Lumo styling, but you can adapt either to suit your branding and vision.


[.cards.quiet.large.hide-title]
== Libraries

=== Aura Theme - Vaadin Design System
image::_images/aura-vaadin-ds-library.png["", role="icon"]
Styles and components for designing Aura-based Vaadin apps. Includes all Vaadin Components available in latest Vaadin version.

https://www.figma.com/community/file/1634129379077243697/aura-vaadin-design-system[View in Figma Community]

=== Lumo Theme - Vaadin Design System
image::_images/lumo-vaadin-ds-library.png["", role="icon"]
Lumo styles for typography, color and other visual elements. Configurable components that cover the same components which are available for developers.
