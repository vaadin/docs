...
By default, the drop-down overlaps the field when opened. There is an API for configuring Select to place the overlay below the field (or above it, if there is not enough space at the bottom).
