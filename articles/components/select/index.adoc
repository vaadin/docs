---
title: Select
page-title: Select component | Vaadin components
description: Select allows users to choose a single value from a list of options presented in an overlay.
meta-description: Use Vaadin's Select component to allow users to choose a single value from a list of options presented in an overlay.
page-links:
