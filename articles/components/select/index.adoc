...
Select provides the following API to customize the overlay where the list of options is rendered.

[role="since:com.vaadin:vaadin@V24.5"]
=== Overlay Position

By default, the drop-down overlaps the field when opened. The `noVerticalOverlap` API can be used to move the drop-down below the field instead.
...
The width of the drop-down is, by default, the same width as the input field. The popup width can be overridden to any fixed width in cases where the default width is too narrow.
...
select.setOverlayWidth(350, Unit.PIXELS);
----
[source,tsx]
----
<source-info group="React"></source-info>
<Select style={{ '--vaadin-select-overlay-width': '350px' }} />
----
[source,html]
----
<source-info group="Lit"></source-info>
<vaadin-select style="--vaadin-select-overlay-width: 350px"></vaadin-select>
----
--

=== Overlay Class Name

Use the [methodname]`addOverlayClassName()` API in Flow or the `overlayClass` web component property to set a CSS class name on the overlay for styling.
...
----
<source-info group="Flow"></source-info>
Select<String> select = new Select<>("Locale");
select.addOverlayClassName("locales");
----
[source,tsx]
----
<source-info group="React"></source-info>
<Select overlayClass="locales" label="Locale" />
----
[source,html]
----
<source-info group="Lit"></source-info>
<vaadin-select overlayClass="locales" label="Locale"></vaadin-select>
----
--
