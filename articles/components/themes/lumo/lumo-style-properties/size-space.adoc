...
order: 30
page-links:
  - https://github.com/vaadin/web-components/blob/v{moduleNpmVersion:vaadin-lumo-styles}/packages/vaadin-lumo-styles/src/props/sizing.css[Source (size)]
  - https://github.com/vaadin/web-components/blob/v{moduleNpmVersion:vaadin-lumo-styles}/packages/vaadin-lumo-styles/src/props/spacing.css[Source (space)]
---
...
You can load the built-in <<../lumo-variants#compact-preset, Lumo compact preset>> to reduce the font size and the sizing and spacing of all components, allowing you to place more components on the screen.
...
[discussion-id]`86ADC27D-53E6-4663-AB04-295B04920631`
