...
You can load the built-in <<..#compact-preset, Lumo compact preset>> to reduce the font size and the sizing and spacing of all components, allowing you to place more components on the screen.
