...
You'll find documentation of the CSS custom properties that affect all components (i.e., global properties). See the component documentation pages for component-specific custom property listings (for example, see <<{articles}/components/button/styling#,Button styling>>).
...
Similarly, the base styles support Windows High Contrast Mode out of the box. As long as your custom theme uses the base style custom properties to style components, that feature still works out of the box regardless of any other customizations you do to your theme colors.
