...
By default, it has a 100% width and an undefined height. Its width is constrained by its parent component. Its height is determined by the components it contains.
