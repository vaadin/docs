...
// end::description[]
By default, it has a width of 100% and an undefined height. Its width is constrained by its parent component. Whereas, its height is determined by the components it contains. This page explains how to add this component to your project and how to configure it.
