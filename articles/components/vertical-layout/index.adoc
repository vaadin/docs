...
By default, components in a layout will either shrink or overflow when there isn't enough vertical space. Enable wrapping to make components flow onto the next column when there's insufficient height, preventing overflow.
