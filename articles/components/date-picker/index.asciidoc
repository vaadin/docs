...
Try clicking below on the small gray icon of a calendar. A calendar overlay appears, spanning two months around the current date. Click on a date to see how it reacts.
...
To validate a date entered or selected, there are various ways to do this. For instance, you may want to allow only dates in a certain range, or you might not want to allow certain dates. Below are some of your options for date validation.
