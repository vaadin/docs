...
The behavior is not affected on touch devices.
...
[NOTE]
====
The previous example is only a prototype implementation to demonstrate the idea, and is not ready for production use.
====
