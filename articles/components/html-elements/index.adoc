...
[NOTE]
The Table components -- [classname]`Table`, [classname]`TableRow`, [classname]`TableHeaderCell`, and the rest of the family -- have a page of their own: see <<table#,Table>>. They replace the deprecated [classname]`NativeTable` components, which are scheduled for removal in the next major version.
...
| `NativeTable` | `table` | The https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/table[table element] represents data presented in a two-dimensional table comprised of rows and columns of cells containing data. For most use cases, prefer the more advanced Vaadin <<{articles}/components/grid#,Grid>>, <<{articles}/components/grid-pro#,Grid Pro>> or <<{articles}/components/tree-grid#,Tree Grid>>. Deprecated in favor of [classname]`Table` -- see <<table#,Table>>.
| `NativeTableBody` | `tbody` | The https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/tbody[table body element] encapsulates a set of table rows (`NativeTableRow`). Deprecated in favor of [classname]`TableBody`.
| `NativeTableCaption` | `caption` | The https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/caption[caption element] specifies the caption (or title) of a table, providing the table an accessible description. Deprecated in favor of [classname]`TableCaption`.
| `NativeTableCell` | `td` | The https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/td[table data cell element] defines a cell of a table that contains data and may be used as a child of the `NativeTableRow`. Deprecated in favor of [classname]`TableDataCell`.
| `NativeTableFooter` | `tfoot` | The https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/tfoot[table footer element] encapsulates a set of table rows (`NativeTableRow`), typically used to provide a summary for the columns. Deprecated in favor of [classname]`TableFoot`.
| `NativeTableHeader` | `thead` | The https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/thead[table head element] encapsulates a set of table rows (`NativeTableRow`), indicating that they comprise the head of a table with information about the table's columns. Deprecated in favor of [classname]`TableHead`.
| `NativeTableHeaderCell` | `th` | The https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/th[table header element] defines a header cell, which can be used inside a `NativeTableRow`, typically within a `NativeTableHeader`. Deprecated in favor of [classname]`TableHeaderCell`.
| `NativeTableRow` | `tr` | The https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/tr[table row element] defines a row of cells in a table. The row can contain either `NativeTableHeaderCell` or `NativeTableCell` elements. Deprecated in favor of [classname]`TableRow`.
...
| [since:com.vaadin:vaadin@V25.3]#`Table`# | `table` | The https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/table[table element] represents data presented in a two-dimensional table of rows and columns. See <<table#,Table>> for the whole component family. For data-driven tables, prefer the more advanced Vaadin <<{articles}/components/grid#,Grid>>, <<{articles}/components/grid-pro#,Grid Pro>> or <<{articles}/components/tree-grid#,Tree Grid>>.
| [since:com.vaadin:vaadin@V25.3]#`TableBody`# | `tbody` | The https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/tbody[table body element] groups a set of data rows (`TableRow`). A table may have several.
| [since:com.vaadin:vaadin@V25.3]#`TableCaption`# | `caption` | The https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/caption[caption element] specifies the caption (or title) of a table, giving the table an accessible name.
| [since:com.vaadin:vaadin@V25.3]#`TableColumn`# | `col` | The https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/col[column element] defines a column, or a range of columns, inside a `TableColumnGroup`, so that column-wide styling need not be repeated on every cell.
| [since:com.vaadin:vaadin@V25.3]#`TableColumnGroup`# | `colgroup` | The https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/colgroup[column group element] groups the columns of a table, so that attributes can be applied to several columns at once.
| [since:com.vaadin:vaadin@V25.3]#`TableDataCell`# | `td` | The https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/td[table data cell element] defines a cell containing data, used inside a `TableRow`.
| [since:com.vaadin:vaadin@V25.3]#`TableFoot`# | `tfoot` | The https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/tfoot[table foot element] groups the footer rows (`TableRow`) of a table, typically a summary of the columns.
| [since:com.vaadin:vaadin@V25.3]#`TableHead`# | `thead` | The https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/thead[table head element] groups the header rows (`TableRow`) of a table, which carry the information about its columns.
| [since:com.vaadin:vaadin@V25.3]#`TableHeaderCell`# | `th` | The https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/th[table header element] defines a header cell that labels a row, a column, or a group of either, used inside a `TableRow`.
| [since:com.vaadin:vaadin@V25.3]#`TableRow`# | `tr` | The https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/tr[table row element] defines a row of cells. A row may contain only `TableHeaderCell` and `TableDataCell` components.
