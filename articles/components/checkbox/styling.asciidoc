...
The following style properties can be used in CSS stylesheets to customize the appearance of the Checkbox component.
...
[role="since:com.vaadin:vaadin@V24.3"]
== Checkbox Group Style Properties
The following style properties can be used in CSS stylesheets to customize the appearance of Checkbox Group component.
