...
[source,html]
----
include::{root}/frontend/demo/component/upload/upload-file-format.ts[render,frame,tags=snippet,indent=0,group=Lit]
----
endif::[]
...
[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/upload/UploadFileFormat.java[render,frame,tags=snippet,indent=0,group=Flow]
----
...
[source,tsx]
----
include::{root}/frontend/demo/component/upload/react/upload-file-format.tsx[render,frame,tags=snippet,indent=0,group=React]
----
endif::[]
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/upload/upload-file-count.ts[render,frame,tags=snippet,indent=0,group=Lit]
----
endif::[]
...
[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/upload/UploadFileCount.java[render,frame,tags=snippet,indent=0,group=Flow]
----
...
[source,tsx]
----
include::{root}/frontend/demo/component/upload/react/upload-file-count.tsx[render,frame,tags=snippet,indent=0,group=React]
----
endif::[]
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/upload/upload-file-size.ts[render,frame,tags=snippet,indent=0,group=Lit]
----
endif::[]
...
[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/upload/UploadFileSize.java[render,frame,tags=snippet,indent=0,group=Flow]
----
...
[source,tsx]
----
include::{root}/frontend/demo/component/upload/react/upload-file-size.tsx[render,frame,tags=snippet,indent=0,group=React]
----
endif::[]
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/upload/upload-labelling.ts[render,frame,tags=snippet,indent=0,group=Lit]
----
endif::[]
...
[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/upload/UploadLabelling.java[render,frame,tags=snippet,indent=0,group=Flow]
----
...
[source,tsx]
----
include::{root}/frontend/demo/component/upload/react/upload-labelling.tsx[render,frame,tags=snippet,indent=0,group=React]
----
endif::[]
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/upload/upload-helper.ts[render,frame,tags=snippet,indent=0,group=Lit]
----
endif::[]
...
[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/upload/UploadHelper.java[render,frame,tags=snippet,indent=0,group=Flow]
----
...
[source,tsx]
----
include::{root}/frontend/demo/component/upload/react/upload-helper.tsx[render,frame,tags=snippet,indent=0,group=React]
----
endif::[]
--
