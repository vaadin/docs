...
[NOTE]
====
File format restrictions set with [methodname]`setAcceptedFileType` method are checked only on the client side. They indicate the hints for users of what file types to upload.
