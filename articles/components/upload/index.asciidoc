...
// end::description[]
It shows the upload progress and the status of each file. Files can be uploaded by clicking on the *Upload* button or by dragging them onto the component. This page explains how to add this component to your project and how to configure it.
...
|Handles multiple file uploads at once. For each, it saves a file on the system.
