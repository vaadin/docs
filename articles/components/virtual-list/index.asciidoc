...
To use the component, you need to assign it a set of data items and a _renderer_ that's used to render each individual data item. The height of an item is determined by its content and can change dynamically.
