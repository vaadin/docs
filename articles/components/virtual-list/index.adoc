---
title: Virtual List
page-title: Virtual List component | Vaadin components
...
meta-description: Use the Vaadin Virtual List component to implement virtual lists for handling large datasets efficiently in Vaadin applications.
page-links:
