---
title: Auto Grid
page-title: Auto Grid component | Vaadin components
order: 33
description: Used for displaying tabular data based on a Java backend service.
meta-description: Automate grid layouts in Vaadin with the Auto Grid component for dynamic data presentation.
section-nav: badge-react
---


= [since:dev.hilla:hilla@v2.3]#Auto Grid# [badge-react]#React#
:react:
