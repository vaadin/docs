...
[TIP]
Vaadin also supports using https://www.npmjs.com/package/pnpm[pnpm] (known as _performant npm_). See <<{articles}/configuration/npm-pnpm#,Configuring npm/pnpm>> for details.
