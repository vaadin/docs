...
It isn't necessary to create its instance and use a setter; you can simply call [methodname]`getPerson()` and the model returns an empty proxy object that you can use to set its property directly.
