...
The [classname]`DropTarget` configuration object doesn't itself store any data, as it's just an API extension that facilitates making any component a drop target.
