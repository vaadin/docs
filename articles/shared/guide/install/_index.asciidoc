...
[.card]
=== Windows
image::{root}/articles/shared/guide/installing/_images/windows.svg[32, 32, opts=inline, role=icon]
<<windows#,Install development tools in Windows>>

[.card]
=== macOS
image::{root}/articles/shared/guide/installing/_images/macos.svg[32, 32, opts=inline, role=icon]
<<macos#,Install development tools in macOS>>

[.card]
=== Linux
image::{root}/articles/shared/guide/installing/_images/linux.svg[32, 32, opts=inline, role=icon]
