...
[.card]
=== Windows
image::{articles}/shared/guide/install/images/windows.svg[32, 32, opts=inline, role=icon]
<<windows#,Install development tools in Windows>>

[.card]
=== macOS
image::{articles}/shared/guide/install/images/macos.svg[32, 32, opts=inline, role=icon]
<<macos#,Install development tools in macOS>>

[.card]
=== Linux
image::{articles}/shared/guide/install/images/linux.svg[32, 32, opts=inline, role=icon]
