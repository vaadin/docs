...
+
link:https://corretto.aws/downloads/latest/amazon-corretto-11-x64-windows-jdk.msi[Download Amazon Corretto 11, role="button secondary water"]

. Follow the prompts in the wizard
+
image:{articles}/shared/guide/install/images/win-coretto-installer.png[Corretto Installer]
