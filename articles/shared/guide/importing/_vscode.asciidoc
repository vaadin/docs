...
+
image:{articles}/shared/guide/importing/images/vscode/open-folder.png[Open Folder]
...
+
image:{articles}/shared/guide/importing/images/vscode/import-java-projects.png[Open Folder]
