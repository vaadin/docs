...
image:{articles}/shared/guide/running/images/intellij/run-app.png[Run button locations]
...
+
.Maven projects view
image::{articles}/shared/guide/running/images/intellij/maven-projects-view.png[Maven projects view]
+
...
+
image::{articles}/shared/guide/running/images/intellij/lifecycle.png[Lifecycle phases, 313, 331]
...
+
image:{articles}/shared/guide/running/images/intellij/create-running-config.png[Create running configuration option]

. For simplicity, change the name of the configuration to *Run on Jetty* (or *TomEE* or *Spring Boot*)
+
image:{articles}/shared/guide/running/images/intellij/run-on-jetty.png[Run on Jetty]

. Click [guibutton]#OK#:

You should see the new option on the top right corner of IntelliJ IDEA:

image:{articles}/shared/guide/running/images/intellij/config-created.png[Running configuration created]

Now you can deploy and run the web application by clicking the run (or the debug) icon in the toolbar:

image::{articles}/shared/guide/running/images/intellij/run-icon.png[Run icon]
