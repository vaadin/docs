...
+
.Maven projects view
image::{root}/articles/shared/guide/running/images/intellij/maven-projects-view.png[Maven projects view]
+
...
+
image::{root}/articles/shared/guide/running/images/intellij/lifecycle.png[Lifecycle phases, 313, 331]
...
image::{root}/articles/shared/guide/running/images/intellij/run-icon.png[Run icon]
