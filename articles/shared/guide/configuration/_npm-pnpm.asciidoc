_npm_ is used as the default frontend package manager instead of _pnpm_ (also known as _performant npm_).

It's still possible to use pnpm. To switch to pnpm you can set the `vaadin.pnpm.enable` system property to `true`.
