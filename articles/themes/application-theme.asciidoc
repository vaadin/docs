...
└── my-theme/ <2>
    ...
    ├── document.css <7>
    ├── global.css <8>
    ├── my-theme.generated.js <9>
    └── theme.json <10>
----
<1> Contains all application themes
<2> Contais files for 'my-theme'
...
<7> css always applied to the root of the page
<8> contains theme changes, may be targeted
<9> auto-generated configuration file
<10> configuration for assets etc.
...
A style sheet in the theme can use the assets by adding `theme/my-theme/` to the local URIs defined in `theme.json`.

[source, CSS]	
----	
background-image: url('theme/my-theme/fortawesome/icons/snowflake.svg');
----	
