...
<6> css always applied to the root of the page
<7> contains theme changes, may be targeted
<8> auto-generated configuration file
...
- Create a separate project with the theme folder inside `src/main/resources/META-INF/resources/themes/`
