...
The first thing you need to do is to create a signal that will hold the channels. Furthermore, you should make the virtual list use this channel as its data source. Add the following to your [filename]`src/main/frontend/views/@index.tsx` file:
