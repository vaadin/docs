...
----
<1> This field is used for <</building-apps/forms-data/consistency/optimistic-locking#,optimistic locking>>. You'll use it later when implementing editing.
