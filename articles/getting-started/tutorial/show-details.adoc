...
You'll display the product details in a drawer next to the grid. Start by creating the drawer component - `ProductDetailsDrawer` - in the `com.example.product` package:

.ProductDetailsDrawer.java
[source,java]
----
...
2. Add an instance of the `ProductDetailsDrawer` to the `ProductCatalogView`.
