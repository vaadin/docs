...
Once the build has finished, check the `target` directory. You should find a JAR file called [filename]`unified-chat-tutorial-1.0-SNAPSHOT.jar`. Start the application from the JAR by running the following command:
