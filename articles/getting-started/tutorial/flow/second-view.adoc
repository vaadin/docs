...
The first step is to set up the interface which presents the list of channels to the user. To do this, create a class named [classname]`LobbyView` in the [packagename]`com.example.application.ui.views.lobby` package. That code will look like this:
