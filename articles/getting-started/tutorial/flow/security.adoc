...
// RUSSELL: If there is already a set of <dependency> tags, do these lines go within them -- can they be added within them?  Or is it better or alright to have more than one set of such tags with values?
...
// RUSSELL: Is 'flex' in the next line short for 'flexible'?
