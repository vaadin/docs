...
After you have imported an application into your IDE, you're ready to run it. Applications created with <<{articles}/getting-started/start#, Vaadin Start>> are Spring Boot applications, which you can run like ordinary Java applications. Non-Spring Boot applications can be run with Maven.
