...
Once you've downloaded and unpacked a starter application, you're ready to import it to your IDE. See <<{articles}/getting-started/start#, Starting a Project>> for instructions for creating or downloading a starter project, or creating one from a Maven archetype.
