...
Replace the in-memory H2 database with a production-ready database. Follow the <</building-apps/forms-data/persistence/add-flyway#,Add Flyway>> and <</building-apps/forms-data/replace-h2#,Replace H2>> guides for details.
