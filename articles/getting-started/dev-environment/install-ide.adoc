...
page-title: Install a Java IDE
description: Install a Java IDE for Vaadin development if you don't have one already.
meta-description: Learn about different IDE options for Vaadin development and how to install them.
order: 10
---
