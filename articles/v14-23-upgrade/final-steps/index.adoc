...
Loading stylesheets with the `@JsModule` annotation in Flow is deprecated. JS-wrapped stylesheets should be refactored to regular CSS files and loaded with @CssImport, or, preferably, using <<custom-theme-folder,the new theme folder format>> recommended for styling applications since Vaadin 19.
