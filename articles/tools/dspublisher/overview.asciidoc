...
You can customize it to match your own UI features by plugging in your own <<{articles}/styling/custom-theme#, custom theme>>, and by adding, removing, and editing the documentation and component samples.
