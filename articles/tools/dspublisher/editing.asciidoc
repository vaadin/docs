...
- link:https://docs.asciidoctor.org/asciidoc/latest/syntax-quick-reference/#literals-and-source-code[Literals and source code blocks]. See  for how to embed live UI samples with code snippets to pages.
