...
- link:https://docs.asciidoctor.org/asciidoc/latest/syntax-quick-reference/#literals-and-source-code[Literals and source code blocks]. See *Adding UI Examples* for how to embed live UI samples with code snippets to pages.
