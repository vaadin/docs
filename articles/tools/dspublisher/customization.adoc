...
page-title: How to customize DSPublisher configuration | Vaadin
...
meta-description: Documentation styles can be customized to fit the brand of your organization. Customize the Data Source Publisher to fit your needs using this guide.
order: 50
---
