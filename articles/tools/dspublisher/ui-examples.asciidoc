...
Dependencies for custom components are added to [filename]`pom.xml` the same way as a <<{articles}/styling/advanced/multi-app-themes#,custom theme JAR>>.
...
[NOTE]
The code example displayed below the live component example isn't automatically refreshed.
...
[discussion-id]`04578ED2-2AAB-4BBC-9BB8-ABE3476BA4C6`
