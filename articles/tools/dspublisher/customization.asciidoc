...
See <<{articles}/styling/custom-theme/creating-custom-theme#,Applying a Custom Application Theme>> for instructions how to apply a theme which is used in <<ui-examples#,UI examples>>.
