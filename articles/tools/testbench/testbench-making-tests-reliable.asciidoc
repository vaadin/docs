...
By using page/view objects you can abstract away the low level details about how the view is built and what exact components are used. You can also use <<dummy/../testbench-bdd#,BDD>> to describe your test scenarios using normal English sentences.
...
[discussion-id]`D47AD6C3-C848-4ACC-92CC-8E36D6F20A91`
