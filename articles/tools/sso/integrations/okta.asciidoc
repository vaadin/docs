...
You can access your Okta workspace after signing up to Okta. A workplace includes an Authorization Server and administrator account. The workspace is behind a URL like [interfacename]_dev-12345678.okta.com_
