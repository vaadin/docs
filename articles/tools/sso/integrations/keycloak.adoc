---
title: Keycloak
page-title: How to integrate Keycloak for SSO in Vaadin applications
...
meta-description: Learn how to set up and configure Keycloak Single Sign-On (SSO) integration in your Vaadin applications for secure authentication.
page-links:
...
= [deprecated:com.vaadin:vaadin@V25.3]#Keycloak Integration#
...
Backchannel logout URL:	https://192.168.2.158:8080/logout/connect/back-channel/keycloak
