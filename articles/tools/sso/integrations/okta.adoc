---
title: Okta
page-title: How to integrate Okta for single sign-on in Vaadin
...
meta-description: Learn how to set up Okta SSO for secure authentication in your Vaadin applications. Streamline user access with this step-by-step guide.
page-links:
...
= [deprecated:com.vaadin:vaadin@V25.3]#Okta Integration#
