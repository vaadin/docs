...
page-title: How to integrate Azure AD SSO with Vaadin
description: How to use SSO Kit with Azure Active Directory (Microsoft Entra ID).
meta-description: Learn how to configure Azure AD for secure single sign-on (SSO) in your Vaadin applications.
page-links:
...
= [deprecated:com.vaadin:vaadin@V25.3]#Azure AD Integration#
