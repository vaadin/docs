...
SSO Kit provides the `SingleSignOnConfiguration` auto-configuration class to setup Vaadin and Spring to allow single sign-on against external identity providers.
