...
Below is an example of the properties to set to enable a Keycloak instance to perform authentication:
...
Below is an example how this might be done:
...
The configuration below enables login for the identity providers defined in the application configuration.
