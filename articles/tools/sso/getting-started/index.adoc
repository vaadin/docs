...
meta-description: Get started with Single Sign-On (SSO) integration in your Vaadin Flow applications.
order: 10
...
= [deprecated:com.vaadin:vaadin@V25.3]#Getting Started with SSO Kit (Flow)#
