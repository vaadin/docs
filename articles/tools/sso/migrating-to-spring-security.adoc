...
oidcUserService.setOidcUserConverter(new KeycloakOidcUserMapper()); // <1>
----
<1> [classname]`com.vaadin.flow.spring.security.KeycloakOidcUserMapper`, the replacement for the kit's [classname]`KeycloakUserMapper`. A constructor argument overrides the role prefix.
