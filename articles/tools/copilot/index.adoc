...
|Right
|Make your UI ready for localization by generating translation keys for text elements and converting static strings in UI code to translation API calls. See <<i18n#, Internationalization>>.
