...
|Annotations
|Toolbar Test mode
|Annotate your views with comments including references to components. Great for sharing notes with your team or keeping track of things to fix. Use AI to fix the comments and resolve them.
