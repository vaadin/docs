...
- Vaadin Copilot contains all the functionality found previously in Development Tools.
- It is possible to disable Vaadin Copilot using `vaadin.copilot.enable=false` system property.
- It is not possible to explicitly disable AI features of Vaadin Copilot.
