...
*Wrap with...*:: Wrap the selected components within a new layout. The selected components are placed in the layout in the order you select them. The resulting layout is placed in the same place as the first component you select.
