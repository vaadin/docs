...
Once you're ready, you can share the project with others either by giving them a link or by creating a GitHub repository for it. Click [guilabel]`Share...` to do so. 
