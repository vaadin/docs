...
Before running the Modernization Toolkit Analyzer, make sure your project builds without any errors. The Analyzer requires compiled classes to resolve type dependencies.
...
When execution completes, you'll see the summarized report in Maven output. To better understand the results and what your options are moving forward, contact Vaadin to discuss this.
