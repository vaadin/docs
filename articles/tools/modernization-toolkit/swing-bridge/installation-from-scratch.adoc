...
<dependencies>
  ...
  <!-- The exclusion keeps Spring Boot's default Logback as the SLF4J
       backend. See Logging & User Identification for the trade-offs and
