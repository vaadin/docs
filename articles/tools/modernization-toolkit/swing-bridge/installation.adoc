---
title: Installation
page-title: Install and Configure SwingBridge | Vaadin Tools
...
If you only want a quick try-out, the <<getting-started#, Getting Started>> page uses the skeleton starter and skips most of the manual configuration below.


[[swing-bridge.installation.license]]
...
[[swing-bridge.installation.license.automated]]
...
[[swing-bridge.installation.license.manual]]
...
[[swing-bridge.installation.project-setup]]
== Project Setup
...
[[swing-bridge.installation.next-steps]]
== Next Steps

- Bring in your own Swing JAR: <<adding-your-app#, Adding Your Swing Application>>.
- Tune frame rate, JAR-loading paths, and error reporting: <<configuration#, Configuration>>.
