...
To run the application, use Maven from the command line as described in <<getting-started#, Getting Started>> (skeleton starter) or <<installation#, Installation>> (from-scratch project).
