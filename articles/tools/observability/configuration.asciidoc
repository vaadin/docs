...
The default instrumentation is disabled because logging all requets for a single-page application isn't helpful -- although it does generate plenty of data. It was disabled to have control over which requests generate a trace.
