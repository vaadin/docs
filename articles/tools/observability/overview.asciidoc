...
The core of this add-on is the Observability Kit agent, which is a Java agent that is run together with a Vaadin Flow application to automatically collect telemetry data.
This includes:
