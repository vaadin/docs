---
title: Customization
page-title: How to customize observability in Vaadin applications
order: 30
description: How to add custom instrumentation traces and metrics to an application.
meta-description: Learn how to tailor observability features to monitor and analyze Vaadin applications effectively.
---
