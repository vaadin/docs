...
[CAUTION]
The setup is intended for local testing only. It isn't production ready. See the Grafana documentation on how to https://grafana.com/docs/grafana/latest/setup-grafana/configure-security/[configure and secure a self-hosted setup].
