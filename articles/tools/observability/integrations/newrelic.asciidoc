...
[CAUTION]
To avoid losing data, messages can be truncated automatically using the property `otel.attribute.value.length.limit`. See <<configuration-file>> for instructions.
