...
We provide a preconfigured dashboard for New Relic that shows several metrics such as request throughput, error rate or JVM stats.
...
Copy the dashboard JSON from above, and then open the New Relic UI in the browser.
