...
The agent isn't required for the Observability Kit integration, and can be removed immediately afterwards.
...
Datadog doesn't support the OpenTelemetry APIs directly.
...
Datadog doesn't support collecting logs in the OpenTelemetry format.
...
Therefore, you don't need to configure endpoints.
