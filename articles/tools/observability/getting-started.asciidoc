...
If you don't have an application to use, you can download an app from https://start.vaadin.com[start.vaadin.com], and run a production build using `mvn package -Pproduction`. Then run the packaged Jar file from the `target` folder as described below.
