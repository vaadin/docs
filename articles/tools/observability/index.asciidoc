...
At its core, Observability Kit's a custom Java agent that runs together with a Vaadin Flow application to automatically collect telemetry data, including traces, metric, and logs.
