...
To begin, download the demo application.
This is used throughout this tutorial in order to demonstrate the features of Observability Kit.

Click on the following button to download the demo application (runnable jar file):
