...
See the <<copilot-panel#,Copilot Panel>> page for what it shows, how findings are ranked, and how it announces new ones.
...
* <<client-errors#,Client Error Insights>> -- name the script behind an error that never reached the server.
