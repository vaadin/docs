...
As a result, the experience will be seamless for the end user: they won't notice that anything has happened -- except perhaps for a very slight delay when scaling down, or when a node failure event occurs.
