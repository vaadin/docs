...
| `vaadin.kubernetes.rolling-updates`
| Enables or disables rolling update support, which handles version update notifications and sticky session cookie removal.
| `true`
