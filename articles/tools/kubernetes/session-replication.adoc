...
If you are using Collaboration Kit in your application, you may need to follow some <<{articles}/tools/collaboration/advanced/serialization#,specific serialization instructions>>.
