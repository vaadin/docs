...
description:  Advanced topics related to AppSec Kit.
order: 20
---
...
- `includeNpmDevDependencies` is the boolean value to decide if the _npm_ development dependencies should be included during vulnerability scanning.
...
You can configure if the _npm_ development dependencies should be included during vulnerability scanning. The default value is _true_.
