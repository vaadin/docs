...
To generate the SBOM file from npm dependencies, you'll need to install the _link:https://www.npmjs.com/package/@cyclonedx/cyclonedx-npm[@cyclonedx/cyclonedx-npm]_ plugin as a global tool with npx:
