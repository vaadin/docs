...
The SBOM is generated automatically each time you do a development build -- or can be initiated on-demand. This allows you to have complete visibility of your application's contents.
