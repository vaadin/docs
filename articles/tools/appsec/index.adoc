...
description: Identify and manage vulnerabilities in third-party dependencies. Deprecated, and not available in Vaadin 26.
meta-description: AppSec Kit identifies and manages vulnerabilities in third-party dependencies. It's deprecated and isn't available in Vaadin 26.
section-nav: commercial
order: 40
banner: AppSec Kit is deprecated and isn't available in Vaadin 26.
...
AppSec Kit is deprecated and isn't available in Vaadin 26.
