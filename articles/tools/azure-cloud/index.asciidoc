...
Azure Cloud Kit lets you quickly deploy your Vaadin application to Microsoft's Azure Cloud. Azure Cloud Kit is based on Kubernetes Kit, which means that all the features of Kubernetes Kit are also available in Azure Cloud Kit. This means that both Kits enable the following:
