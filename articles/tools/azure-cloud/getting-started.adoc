...
To connect to the Kubernetes cluster that was created by the Azure Cloud Kit, you need to use the `kubectl` command with the `kubeconfig` file. This `kubeconfig` file was auto-generated when running terraform apply. 
