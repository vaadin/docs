...
To run the script, open a terminal and navigate to the folder where you extracted the Azure Cloud Kit.
...
Next, you need to initialize the directory where you extracted the Azure Cloud Kit as a Terraform working directory.
