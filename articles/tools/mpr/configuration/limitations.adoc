...
page-title: Limitations of Vaadin's Multiplatform Runtime
meta-description: Learn about the limitations of the MPR plugin when integrating legacy components in Vaadin applications.
order: 2
---
...
This means, for example, that TouchKit doesn't work with MPR.
...
== Legacy Components and Modal Dialogs

You need to disable the server side modality of the Dialog in order to enable legacy components with events to work. This can be done after Dialog has been opened.
