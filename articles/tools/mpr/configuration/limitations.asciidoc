...
The Vaadin 14 Spring add-on doesn't have a feature comparable with `@ViewScope`. When using MPR with Spring, that scope isn't supported. Use `@RouteScope` instead.
