---
title: Push pass:[&] MPR
page-title: How to configure push in MPR for Vaadin applications
meta-description: Set up and configure push in MPR for Vaadin applications. Enhance real-time communication capabilities.
order: 3
---
