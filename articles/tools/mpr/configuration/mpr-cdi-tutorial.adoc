...
page-title: How to use V7 & V14+ CDI applications side-by-side | Vaadin
meta-description: Explore how to use V7 & V14+ CDI Applications Side-by-Side effectively in your Vaadin development workflow.
order: 6
---
