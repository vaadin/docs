...
page-title: How to configure production mode in Vaadin MPR
meta-description: Learn how to enable and configure production mode in Vaadin MPR for improved performance and scalability.
order: 3
---
