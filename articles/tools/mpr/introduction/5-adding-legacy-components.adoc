...
page-title: Adding legacy components to Vaadin Flow layouts
meta-description: Understand how to integrate legacy components seamlessly in MPR for Vaadin applications.
order: 11
---
