...
and an `AfterNavigationListener` for the `afterViewChange` to the Flow UI. See https://vaadin.com/docs/v14/flow/routing/tutorial-routing-lifecycle[Routing lifecycle] documentation.
