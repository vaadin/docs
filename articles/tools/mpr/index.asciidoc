...
:commercial-banner-content: Multiplatform Runtime only works with the Extended Maintenance versions of Vaadin 7 and Vaadin 8. :trial-link: https://vaadin.com/vaadin-8-extended-maintenance[Read more]
