...
page-title: How to configure Multiplatform Runtime | Vaadin tools
meta-description: Learn how to configure multiplatform runtime to run applications and components written with Vaadin 7/8 inside a Vaadin Flow application.
...
Issues can be reported on the https://github.com/vaadin/multiplatform-runtime[public Multiplatform Runtime repository].
