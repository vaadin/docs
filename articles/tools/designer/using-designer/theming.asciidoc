...
[NOTE]
When switching the theme under @Theme, all Designer visual editors need to be re-opened to apply the new theme. Also in Preview mode, the browser isn't auto reloaded when styles are changed, you need to refresh the browser manually.
