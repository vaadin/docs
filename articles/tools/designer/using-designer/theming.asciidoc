...
Both themes have "light" and "dark" variants (see <<{articles}/styling/lumo/lumo-variants/#light-and-dark-variants, Dark Mode>>).
...
Vaadin Designer supports theming in the same way as Flow (see <<{articles}/styling/application-theme#, Application Theme>> for more information).
When a design is opened, Vaadin Designer:
