...
<<{articles}/templates/basic#, Flow documentation>>.
...
Take a look at the Flow documentation to learn more about <<{articles}/templates/components#, binding components in Flow>>.
...
You can learn more about binding data to designs in <<{articles}/templates/components#, Flow documentation>>.
