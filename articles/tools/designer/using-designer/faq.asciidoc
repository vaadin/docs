...
Previously it was possible to either buy a Pro subscription, or purchase a single license for a specific major version of a product. Since Vaadin 10, we have decided to discontinue the single licenses. To use Designer after the trial period, a valid Pro subscription is required.
