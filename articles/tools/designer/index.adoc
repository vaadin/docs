...
[NOTE]
Designer as a product has been deprecated for phase out since Vaadin 25.0. It is recommended to use Copilot instead for visual layout re-arrangement and other similar use cases.
