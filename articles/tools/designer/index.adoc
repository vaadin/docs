---
title: Designer (deprecated)
page-title: Web components on a canvas | Vaadin Designer
section-nav: commercial
meta-description: Use the visual tool Vaadin Designer where you can drag and drop - and configure - web components on a canvas.
order: 130
...
[[designer.overview]]
= [deprecated:com.vaadin:vaadin@V25]#Designer#
...
Designer is deprecated and no longer being developed. It still works, but it doesn't support the Aura theme, and no new features are planned. Use <<{articles}/tools/copilot#,Vaadin Copilot>> instead to build and edit views visually in the browser.
