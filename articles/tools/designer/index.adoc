...
[[designer.overview]]
= [deprecated:com.vaadin:vaadin@V25.0]#Designer#
...
Vaadin Designer has been deprecated since V25.0, in favor of <<{articles}/tools/copilot#,Vaadin Copilot>>. Going forward, Copilot is where the design-to-code workflow evolves.
