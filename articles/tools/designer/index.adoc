...
.Designer is Deprecated
[NOTE]
Designer has been deprecated in Vaadin 25.0. We recommend using Vaadin Copilot for drag-and-drop view building instead. Copilot supports converting Vaadin Designer templates to Copilot compatible code.
