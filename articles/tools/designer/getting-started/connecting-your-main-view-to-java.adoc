...
page-title: How to connect your main view to Java in Vaadin Designer
meta-description: Discover how to link your main view created in Vaadin Designer with backend Java logic.
order: 9
...
[#java-connect]
= [deprecated:com.vaadin:vaadin@V25.0]#Connecting Main View to Java#
