...
https://www.google.com/chrome/[Install Google Chrome] if you haven't done so already.
...
* *Paper* is where the UI you are building renders. It shows you what your view looks like.
...
This is the layout which we are building.
...
You can use the search field at the top to find components.
...
Our view doesn't look as planned yet, but it does have the components we need.
...
We don't need a separate label as we have the description as the placeholder value for the field.
...
Our main layout is now looking great, but it's still missing the form.
