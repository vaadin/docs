...
page-title: Setting up Vaadin Designer with IntelliJ IDEA
meta-description: Set up your environment for Vaadin Designer in IntelliJ IDEA with this quick guide.
...
= [deprecated:com.vaadin:vaadin@V25.0]#Installing Designer in IntelliJ IDEA#
:experimental:
