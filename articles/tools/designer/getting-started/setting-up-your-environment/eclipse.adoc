...
page-title: How to set up Vaadin Designer in Eclipse
meta-description: Configure Eclipse for Vaadin Designer to streamline your UI design process.
tab-title: Eclipse
order: 3
...
= [deprecated:com.vaadin:vaadin@V25.0]#Installing Designer in Eclipse#
:experimental:
