...
. Eclipse will start installing the plug-ins in the background.
When it is finished installing it, you will be prompted to restart the IDE. Press [guibutton]#Restart Now#.
...
[discussion-id]`9CC3E150-A27A-4381-B490-B88DEB4467DA`
