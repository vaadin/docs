...
The user may notice a temporarily offline notification or the loading indicator spawn, but then he will be able to continue its work, without losing any data.
