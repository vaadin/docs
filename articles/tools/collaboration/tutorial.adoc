...
page-title: Vaadin collaboration tutorial
meta-description: Follow this step-by-step guide to build collaborative features in your Vaadin applications.
order: 2
...
[[ce.tutorial]]
= [deprecated:com.vaadin:vaadin@V25.3]#Getting Started with Collaboration Kit#
