...
The universal license is free for all Vaadin developers. It allows up to 50 unique users each month in a Vaadin application to use features that rely on Collaboration Kit. Developers aren't require to have a commercial Vaadin subscription -- not Pro, Prime, or Enterprise -- to use the universal license. 
