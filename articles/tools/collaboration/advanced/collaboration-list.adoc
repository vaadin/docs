...
page-title: How to implement collaboration lists in Vaadin
meta-description: Explore how to create and manage collaboration lists for real-time data sharing in Vaadin.
order: 10
...
= [deprecated:com.vaadin:vaadin@V25.3]#Store Ordered Values in Topics#
