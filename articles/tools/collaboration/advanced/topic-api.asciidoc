...
Follow instructions in the application's `README.md` file to start the application. Then open `http://localhost:8080/` in multiple browser tabs to see how a change made in one tab is automatically shown in the other tabs.
