...
page-title: How to use backend APIs for collaboration in Vaadin
meta-description: Learn how to configure and use backend APIs to enable real-time collaboration in Vaadin applications.
order: 20
...
[[ce.backend]]
= [deprecated:com.vaadin:vaadin@V25.3]#Implementing Support for Clustered Environments#
