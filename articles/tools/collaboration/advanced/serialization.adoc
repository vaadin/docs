...
page-title: How to serialize data in collaboration features  | Vaadin
description: Best practices to achieve session replication when using Kubernetes Kit.
meta-description: Learn how to serialize data efficiently for collaboration features in Vaadin.
order: 30
...
= [deprecated:com.vaadin:vaadin@V25.3]#Kubernetes Kit Session Replication#
