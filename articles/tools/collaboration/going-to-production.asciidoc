...
If you need to use Collaboration Kit powered features for more than 20 users / month, please request a commercial license file.
...
NOTE: Collaboration Kit throws an exception in production mode if a configuration has not been defined.
...
Users from 501 through 520 can use the application, but it works as if Collaboration Kit was not in use.
