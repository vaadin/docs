---
title: Form Manager
page-title: How to manage forms with Vaadin collaboration tools
meta-description: Utilize the form manager in Vaadin collaboration tools to enhance form interactions.
order: 3
...
[[ce.form-manager]]
= [deprecated:com.vaadin:vaadin@V25.3]#Form Values & Field Highlighting#
