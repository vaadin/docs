...
page-title: How to use the Message Manager in Vaadin Collaboration Kit
meta-description: Enable real-time messaging in your applications with the Message Manager. Learn how to manage and broadcast messages across users.
order: 2
...
[[ce.message-manager]]
= [deprecated:com.vaadin:vaadin@V25.3]#Send & Receive Messages Programmatically#
