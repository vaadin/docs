...
Hovering the mouse over the avatar displays the full name as a tooltip. The name is also presented in the overflow drop-down. When all the avatars won't fit into the group, the last avatar -- which has text such as "+3" -- can be clicked to show the overflown avatars and their names in a drop-down list.
