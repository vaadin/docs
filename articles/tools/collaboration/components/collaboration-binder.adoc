---
title: Binder
page-title: Collaboration binder in Vaadin applications
meta-description: Learn how to use the Collaboration Binder for real-time data synchronization in Vaadin.
order: 1
...
= [deprecated:com.vaadin:vaadin@V25.3]#Collaborative Form Editing#
