...
page-title: How to manage communication between Vaadin and Swing
description: How to communicate between Vaadin views and Swing applications.
meta-description: Learn how to send events from Vaadin views to a Swing application or call methods in a Vaadin view from Swing.
order: 30
---
