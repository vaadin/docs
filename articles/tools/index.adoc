...
Identify and manage security vulnerabilities in third-party dependencies. AppSec Kit isn't available in Vaadin 26; a replacement online service for Vaadin Enterprise is in progress.
