...
In cases where a JUnit test isn't practicable, an <<flow-integration-testing#,Integration Test>> should be added instead.
...
For more information on setting up the WebDriver, see <<{articles}/testing/browser-based/installing-webdrivers#,Installing WebDrivers>>.


[discussion-id]`760C992B-3AFF-4F13-8C5A-6BF369C22668`
