...
page-title: How to get started with Vaadin Design System Publisher
description: Set up your own design system documentation project using Design System Publisher.
meta-description: Learn how to start using the Vaadin Design System Publisher to set up your own design system documentation project.
order: 20
---
