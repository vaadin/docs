---
title: Site Content
page-title: How to edit content with Design System Publisher | Vaadin
...
meta-description: Learn how to edit and manage documentation content using Vaadin's Design System Publisher tool.
order: 40
---
...
// TODO how versioning badges work, i.e. [since:com.vaadin:vaadin@V25.1]
...
Add dependencies for custom components to the [filename]`pom.xml` file the same way as a <<{articles}/styling/advanced/reusable-theme#,custom theme JAR>>. Components and themes can be included in the same dependency.
