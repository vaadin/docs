...
=== ampersand ("&amp;")
Don't use the ampersand character in place of _and_ in general text. It may be used in page titles, asd well as section and sub-section headings.
...
Instead, _like_ "expects" to be followed by a noun or noun phrase -- a phrase that has the grammatical function of a noun. For example:
