...
https://vale.sh[Vale] is a tool that checks the content you write, as well as reports problems based on a set of rules and guidelines. You should follow them when contributing to the Vaadin or Hilla documentation.
