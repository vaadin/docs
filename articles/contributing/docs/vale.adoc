---
title: Vale
page-title: Vale style guide for contributing to Vaadin docs
...
meta-description: Learn how to use Vale to maintain consistent style in your Vaadin documentation contributions.
order: 10
---
...
The writing style rules are located in the `.github/styles/Vaadin` folder. Each rule is in a separate YAML file. See the https://vale.sh/docs/topics/styles/[Vale Styles] documentation page to learn how to create new rules.
