...
The writing style rules are located in the `.githug/styles/Vaadin` folder, each rule in a separate `.yml` file. See https://vale.sh/docs/topics/styles/[Vale documentation for Styles] to learn how to create new rules.
