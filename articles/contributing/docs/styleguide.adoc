...
We have certain ways of talking to each other, ways which say plenty about who we are and how we see the world. In our documentation, we want to provide information as clearly as possible. We would also like people to have a favorable impression of us and what we stand for as an organization. Therefore, it's important that the documentation maintain a professional and consistent style.



== Writing Style

There are several ways to maintain a professional and consistent voice. One is to write using the same and good voice and tone. Another is to avoid the passive voice and use instead the active voice, as well writing mostly in the present tense. More fundamental is the choice of language variance.  These topics are explained in the sub-sections here.
...
It's important to have a sense of your audience when writing, to know who will read what you write. This includes deciding on the skill levels to assume about the reader. It's also important 
...
Since some readers are disabled in some way, there are certain ways in which you may tend to write that makes the text confusing or the information inaccessible. More than that, documentation that is accessible for all can often benefit all readers.
...
In the documentation, we shouldn't indicated that we're excited, questioning, or pondering. Therefore, the punctuations should not reflect these emotions or states.
...
The use of ellipses (i.e., &vellip;) at the end of a sentence, usually an incomplete sentence, is meant to indicate that the writer is thinking or calling upon the reader to ponder something. Write complete sentences; write what you want to say. Don't require the reader to wonder what you're thinking. Ellipses sometimes can be used in the same way in the middle of sentence. They're also sometimes used in lieu of etc. Again, don't use them.

These three punctuations rules don't apply to using them as part of some code syntax or code example. They apply only to sentences and headings. Ellipses are sometimes used in code or log examples in place of lengthy, unimportant text. This is an accepatable use.
...
There are a few different styling possibilities for the capitalization of certain words and words in certain situations. Although you may have your own preferences, for a better looking documentation and for easier reading and scanning of text, please adhere to the rules on this topic presented in this section.
...
For certain text, there are a few special ways in which they may be formatted. This includes the formatting of warnings and tips, how to mark-up commands, Java classes, and the like. These are explained in this section.
