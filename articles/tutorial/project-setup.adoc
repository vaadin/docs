...
Having downloaded the zip archive file, you'll first have to extract it somewhere. Any directory is fine: just don't extract it to the download folder since you might unintentionally delete your project later when clearing out old downloads.
