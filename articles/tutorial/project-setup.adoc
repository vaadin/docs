...
description: Explains how to open and debug a Vaadin project in IntelliJ and set up IntelliJ for better auto-complete support.
---

= Vaadin Flow Project Setup

This page covers downloading a Vaadin application starter, and importing a Vaadin Maven project in IntelliJ. Plus, it explains how to configure IntelliJ for productive development.
