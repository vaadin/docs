...
If all goes well, the development mode in Vaadin also opens a browser window for you automatically, showing the current UI state: content placeholder and image. Alternatively you can manually open http://localhost:8080/ in your browser.
