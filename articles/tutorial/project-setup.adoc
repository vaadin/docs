...
Download the starter application (zip file) from GitHub below:
...
ifndef::print[]
https://github.com/vaadin/flow-crm-tutorial/archive/refs/heads/v24-native.zip[Download starter,role="button primary water flow-tutorial-download-project"]
endif::[]
