...
title: Project Setup
order: 30
page-title: Import, Run & Debug a Maven Spring Boot Project in IntelliJ
...
Next, from the directory tree that will be displayed, find the folder where you extracted the files. Select the [filename]`pom.xml` file and click the *Open* button.

image::images/setup/open-pom.png[open pom.xml file]

A dialog box like the one shown here will appear, asking how to treat the file to be opened. Select *Open as Project*. This imports the project based on the [filename]`pom.xml` file.

image::images/setup/open-as-project.png[open as project]

IntelliJ will import the project and download all necessary dependencies. This can take several minutes, depending on your internet connection speed.
...
You can now open `localhost:8080` in your browser. When you do, you'll see a content placeholder and image similar to the screenshot here:
