...
description: Learn how to open and debug a Vaadin project in IntelliJ and set up IntelliJ for better auto-complete support.
---
...
This imports the project based on the [filename]`pom.xml` file. IntelliJ then imports the project and downloads all necessary dependencies. This can take several minutes, depending on your internet connection speed.
