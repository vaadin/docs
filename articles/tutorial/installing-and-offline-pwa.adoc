...
description: Learn how to define a custom off-line page and enable installation on supported devices.
---

= Make a Vaadin Flow Application an Installable PWA

In this chapter, you'll turn the completed Customer Relationship Management (CRM) application into a Progressive Web Application (PWA), so that users can install it.
...
In the next chapter, you'll add both unit tests and in-browser tests to the application.
