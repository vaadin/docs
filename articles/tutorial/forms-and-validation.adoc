...
On the <<./creating-a-component#,Create a Component>> part of this tutorial, you created the input fields and buttons that you need for editing contacts. On this part, you will bind those inputs to a `Contact` object to create a fully functional form with validation.
