...
On the previous page of this tutorial, you created a view using Vaadin components and layouts. On this page, you will connect the view to the backend to display and update data.

You can find the back-end code in the `src/main/java` directory.

This tutorial page covers three main aspects of this:
