...
To use Azure Container Apps, you'll need to install Docker (for example using https://www.docker.com/products/docker-desktop/[Docker Desktop]) and https://learn.microsoft.com/en-us/cli/azure/install-azure-cli[Azure CLI]. Also, log into https://azure.microsoft.com[Azure] using a browser to make sure you have an active Azure account. 
