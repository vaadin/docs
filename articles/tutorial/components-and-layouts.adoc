...
Vaadin includes over <<{articles}/components#,40 UI components>> to help you build apps faster.
...
There are only a couple of cases where you need to restart the server; these are highlighted in the instructions.
