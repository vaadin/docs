...
On this part, you will learn core Vaadin concepts and scaffold the first view of the Custom Relationship Management (CRM) application. It covers Vaadin component basics and constructing a view with the Vaadin Flow Java API.
...
You will focus initially only on the list view. You'll add a layout containing the header and sidebar later on the "Navigation & App Layout" part.
...
You should now see the empty view structure in the browser window. On the next part, you will build a component for the form that's used for editing contacts.
