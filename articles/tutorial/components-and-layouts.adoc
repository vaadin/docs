...
In this chapter, you'll learn core Vaadin concepts and how to scaffold the first view of the Custom Relationship Management (CRM) application.

This chapter covers:

* Vaadin component basics; and 
...
Vaadin includes over <<{articles}/components#,forty UI components>> to help you build applications faster. By using ready-made building blocks, you're able to focus more of your time on building end-user functionality.
...
You create a new component by initializing a Java object. For instance, to create a `Button`, you'd write:
...
Initially, focus only on the list view. You'll add the layout containing the header and sidebar later in the “Navigation and parent layouts” chapter.

In this and the next chapter, you'll create the required layouts and components for the view. In the chapter that follows, you'll create a service class for accessing the backend and populating the view with data.
...
You should now see the empty view structure in the browser window. In the next chapter, you'll build a component for the form that's used for editing contacts.
