...
description: Flow uses an event-driven component model for building UIs. This tutorial page covers the basics.
---
...
On this page, you will learn core Vaadin concepts and scaffold the first view of the Custom Relationship Management (CRM) application. It covers Vaadin component basics and constructing a view with the Vaadin Flow Java API.
...
The first view is the Contact list view. You can see how it looks in the screenshot here. It lists all of the contacts. Users can search, add, edit, and delete contacts in this view.

You will focus initially only on the list view. You'll add a layout containing the header and sidebar later on the "Navigation & App Layout" page.

On this page and the next, you'll create the required layouts and components for the view. Then, on the page that follows, you'll create a service class for accessing the backend and populating the view with data.
...
Below are comments about the code above. The numbers reference the circled numbers at the end of various lines of code.
...
You should now see the empty view structure in the browser window. On the next page, you will build a component for the form that's used for editing contacts.
