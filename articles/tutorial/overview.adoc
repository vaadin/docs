...
description: This tutorial series explains how to build, test, and deploy a modern web application using Spring Boot and Vaadin.
---

= Build Web Applications with Spring Boot & Vaadin

This is a practical introduction to web application development with Spring Boot and Vaadin. Spanning several pages, it covers the entire development process, from setup to deployment, following a step-by-step approach. To get the most out of this tutorial, replicate each section as you follow along.

The content is suitable for anyone familiar with Java who wants to build a web application. For a more robust and productive learning experience, you will start with setting up a development environment.
...
This guide teaches you how to build a functional, full-stack web application using modern Java. It focuses on real-world developer needs, without too much detail. However, links to relevant additional reading are provided when you want or need them.
...
This multi-page tutorial typically requires about four hours to complete. It's intended for developers with a basic understanding of Java. You don't need to be an expert, but understanding the syntax and basic concepts of Java makes it easier to follow along.
...
Don't worry if you don't know these terms yet. The tutorial pages that follow covers each of them.
