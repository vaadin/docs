...
description: This tutorial series teaches you how to build, test, and deploy a modern web application using Spring Boot and Vaadin.
---

= Building Web Applications with Spring Boot and Vaadin

This is a practical introduction to web application development with Spring Boot and Vaadin. It covers the entire development process, from setup to deployment, following a step-by-step approach. To get the most out of this tutorial, you can replicate each section as you follow along.

The content is suitable for anyone familiar with Java who wants to build a web application. For a more robust and productive learning experience, you will start right with setting up a development environment.
...
This guide teaches you how to build a functional, full-stack web application using modern Java. It focuses on real-world developer needs, without slowing you down with too much detail. However, links to relevant additional reading are provided when you want or need them.
...
You can see how this application will look in the screenshot here:
...
This tutorial typically requires approximately four hours to complete. It's intended for developers with a basic understanding of Java. You don't need to be an expert, but understanding the syntax and basic concepts makes it easier to follow along.

If you need help or clarification, though, the best place is to ask questions on the https://discord.gg/vaadin[Vaadin Discord] chat server.

Vaadin Flow runs on Java. To use it, you will need the following development tools:
...
It has many features. The main ones you will use are:
...
Don't worry if you don't know these terms yet. The tutorial covers each topic.
...
* <<{articles}/components#,A large library of UI components>>. Each component has a Java API and you can customize the look-and-feel.
...
Vaadin is an alternative to using Spring MVC and Thymeleaf, JSP or FreeMarker when building web applications with Spring Boot. It has many advantages over these alternatives. Here's a list of the main advantages of Vaadin over them:
...
Combining a Spring Boot-based REST backend with a front-end framework like React or Angular is a popular way of building SPAs. However, Vaadin allows you to build similar application experiences with less effort. The advantages of using Vaadin over these other methods are several:
...
You can compare Vaadin, Angular, React, and Vue on our link:https://vaadin.com/comparison[Framework Comparison] page.
