...
Now if you try the UI with a mobile device or make your desktop browser really narrow, you see that the UI is not currently well optimised for small screens.
...
This example uses CSS and utilise the class names previously assigned to the components.
