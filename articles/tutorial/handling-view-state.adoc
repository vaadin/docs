...
On the previous page of this tutorial, you created a reusable form component to edit contacts. Now you'll connect it to the rest of the view and manage the view state.
