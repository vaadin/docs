...
In this tutorial, you'll build a test ensuring that a user can log in. For this test, you need to open the base URL, fill in user name and password, click the login button, and ensure the actual application view opens.
