...
description: This part explains how to do full-stack tests on a Flow application using Vaadin TestBench.
---
...
<2> `ScreenshotOnFailureRule` tells TestBench to grab a screenshot before exiting, if a test fails. This'll help you understand what went wrong when tests don't pass.
