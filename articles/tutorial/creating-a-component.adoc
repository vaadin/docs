...
Vaadin Flow is a component-based framework. On the previous parts of this tutotorial, you worked with several components, like `Grid`, `TextField`, and `VerticalLayout`. However, the real power of the component-based architecture is in the ability to create your own components.
