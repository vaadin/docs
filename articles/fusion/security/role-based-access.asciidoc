...
To use roles for access control in TypeScript views, it is convenient to add a Fusion endpoint that obtains user information, including roles, from Java during authentication.
