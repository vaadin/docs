...
[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/SecurityConfig.java[tags=public-resources]
----
...
[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/SecurityConfig.java[tags=login]
----
