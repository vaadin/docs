...
include::{root}/articles/flow/security/vulnerabilities.asciidoc[tag=sql-injections]
[source,typescript]
----
...
----
include::{root}/articles/flow/security/vulnerabilities.asciidoc[tag=csrf]

include::{root}/articles/flow/security/vulnerabilities.asciidoc[tag=java-serialization]
