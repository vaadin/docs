...
To do so, import `connectionIndicator` and modify one or more of the following properties:
...
|`offlineText`
|`Connection lost`
|The message shown when the connection to the server is lost

|`reconnectingText`
|`Connection lost, trying to reconnect...`
|The message shown when the connection to server is lost and Vaadin is trying to reconnect
