...
See <<{articles}/fusion/guide/install#, Installing Development Tools>> for instructions.
...
== Download a New Vaadin Fusion Project

++++
<p>
<a href="https://start.vaadin.com/?preset=fusion-tutorial&dl" class="button primary water quickstart-download-project" target="_blank" rel="noreferrer noopener">Download</a>
</p>
++++
...
// See the instructions for <<{articles}/fusion/guide/getting-started/intellij#,IntelliJ IDEA>>, <<{articles}/fusion/guide/getting-started/getting-started-eclipse#,Eclipse>>, and <<{articles}/fusion/guide/getting-started/getting-started-netbeans#,NetBeans>> if you prefer to use another IDE.
...
<4> Using `@Nonnull` annotation ensures that the Typescript Generator will not interpret these valuse as possibly `undefined`.
...
Vaadin Fusion uses the https://lit.dev/[Lit] library for client-side views.
