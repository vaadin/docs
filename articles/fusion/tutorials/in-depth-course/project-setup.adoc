...
Follow the instructions for installing development tools in the <<{articles}/fusion/guide/install#, Installing>> documentation if you don't yet have them.
...
This tutorial uses a pre-configured starter from Vaadin Start.
