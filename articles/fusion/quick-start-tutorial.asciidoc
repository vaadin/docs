...
See the instructions for <<../guide/getting-started/getting-started-intellij#,IntelliJ IDEA>>, <<../guide/getting-started/getting-started-eclipse#,Eclipse>>, and https://vaadin.com/docs/v17/flow/getting-started/getting-started-netbeans[NetBeans] if you prefer to use another IDE.
