...
See the instructions for <<{articles}/guide/getting-started/getting-started-intellij#,IntelliJ IDEA>>, <<{articles}/guide/getting-started/getting-started-eclipse#,Eclipse>>, and <<{articles}/guide/getting-started/getting-started-netbeans#,Netbeans>> if you prefer to use another IDE.
