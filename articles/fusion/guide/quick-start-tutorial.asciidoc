...
include::../tutorial/_reactive-intro.adoc[]
...
include::../tutorial/_heroku-steps.adoc[leveloffset=+1]
...
- <<../tutorial#, An in-depth 4-hour course covering navigation, forms, state management, security, and offline use.>>
