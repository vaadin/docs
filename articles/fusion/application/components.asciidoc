...
[source, typescript]
----
include::{root}/frontend/demo/fusion/components/greeting-view.ts[render,group=TypeScript]
----
...
[source,typescript]
----
include::{root}/frontend/demo/fusion/components/color-picker-view.ts[render,group=TypeScript]
----
