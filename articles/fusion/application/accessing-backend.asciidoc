...
[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/fusion/accessingbackend/CounterEndpoint.java[]
----
...
[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/fusion/accessingbackend/City.java[tags=snippet]
----

`CountryEndpoint.java`
[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/fusion/accessingbackend/CountryEndpoint.java[tags=snippet]
----
...
[source,typescript]
----
include::{root}/frontend/demo/fusion/application/accessing-backend/readonly-access.ts[tags=snippet]
----
