...
[NOTE]
If you are upgrading from an earlier version of Vaadin, check the <<{articles}/fusion/guide/upgrading#,Upgrading Guide>>.
...
To add client-side views into the application, follow the <<../guide/quick-start-tutorial#, Quick Start Tutorial>>.
