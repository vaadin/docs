...
The available implementations of [classname]#ConnectionContext# are [classname]#ComponentConnectionContext# and [classname]#SystemConnectionContext#.
