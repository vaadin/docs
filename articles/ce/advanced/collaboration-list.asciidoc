...
Once you have the list instance, you can insert values at the end of the list with the [methodname]#inserLast# method.
...
Since the insertion is asynchronous, the method returns a result object from which you can get a [classname]#CompletableFuture# that you can use to know when the insertion has been done.
