...
The context also handles synchronization of data change events delivered to application code.
...
You can then pass it to the collaboration manager's constructor or to [methodname]#openTopicConnection()# as follows:
