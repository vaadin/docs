...
This tutorial shows how to use the low-level https://vaadin.com/collaboration[Collaboration Engine] APIs, by updating and subscribing to a topic.
...
[discussion-id]`60D1441D-FDF5-4B6E-AF21-D07ABDAF5E5E`
