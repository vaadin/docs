...
[source, Java]
----
include::{root}/src/main/java/com/vaadin/demo/ce/TopicView.java[render,tags=open-topic;registration;!*,indent=0,group=Java]
----
...
[source, Java]
----
include::{root}/src/main/java/com/vaadin/demo/ce/TopicView.java[render,tags=open-topic;subscribe;!*,indent=0,group=Java]
----
