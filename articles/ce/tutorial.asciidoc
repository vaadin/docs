...
https://vaadin.com/collaboration[Collaboration Engine] is a dependency that you add to your Vaadin project.
...
[source, Java]
----
include::{root}/src/main/java/com/vaadin/demo/ce/MainView.java[tags=tutorial-push,indent=0]
----
...
ifdef::articles[]
Read <<{articles}/flow/binding-data/tutorial-flow-components-binder#,Binding Data to Forms>> to learn more about the binder.
endif::articles[]
ifndef::articles[]
...
[discussion-id]`768E6425-1233-42EB-85C5-439E71485AD5`
