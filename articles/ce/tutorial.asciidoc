...
[source, Java]
----
include::{root}/src/main/java/com/vaadin/demo/ce/MainView.java[render,tags=enable-push,indent=0,group=Java]
----
...
[source, Java]
----
include::{root}/src/main/java/com/vaadin/demo/ce/TutorialView.java[render,tags=person-bean,indent=0,group=Java]
----
...
[source, Java]
----
include::{root}/src/main/java/com/vaadin/demo/ce/TutorialView.java[render,tags=tutorial;add-components;!*,indent=0,group=Java]
----
...
[source, Java]
----
include::{root}/src/main/java/com/vaadin/demo/ce/TutorialView.java[render,tags=user-info,indent=0,group=Java]
----
...
[source, Java]
----
include::{root}/src/main/java/com/vaadin/demo/ce/TutorialView.java[render,tags=avatar-group,indent=0,group=Java]
----
...
[source, Java]
----
include::{root}/src/main/java/com/vaadin/demo/ce/TutorialView.java[render,tags=binder,indent=0,group=Java]
----
