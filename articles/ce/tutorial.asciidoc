...
.Vaadin 19 includes Collaboration Engine as a platform feature
[IMPORTANT]
If you are using Vaadin 19, you don’t need to follow these instructions to install the dependencies separately. 
