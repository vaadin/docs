...
Download a new Vaadin project from https://start.vaadin.com/ with a Java UI.
By default, the generated project uses Vaadin 14, which is the latest LTS version.
You can alternatively choose the latest stable Vaadin version.

[[ce.tutorial.install]]
=== Install Collaboration Engine

Starting from Vaadin 19, Collaboration Engine is included in Vaadin and doesn't
need any extra installation.

If you are using Vaadin 14 (which is the default for a new project),
you need to add Collaboration Engine as a dependency to your project.
