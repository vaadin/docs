...
[source, Java]
----
include::{root}/src/main/java/com/vaadin/demo/ce/BinderDocumentation.java[render,tags=binder-new,indent=0,group=Java]
----
...
[source, Java]
----
include::{root}/src/main/java/com/vaadin/demo/ce/BinderDocumentation.java[render,tags=binder-topic,indent=0,group=Java]
----
...
[source, Java]
----
include::{root}/src/main/java/com/vaadin/demo/ce/BinderDocumentation.java[render,tags=binder-bind,indent=0,group=Java]
----
...
[source, Java]
----
include::{root}/src/main/java/com/vaadin/demo/ce/BinderDocumentation.java[render,tags=binder-serializer,indent=0,group=Java]
----
...
[source, Java]
----
include::{root}/src/main/java/com/vaadin/demo/ce/BinderDocumentation.java[render,tags=binder-converter,indent=0,group=Java]
----
