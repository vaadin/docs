...
Enabling production mode for a Vaadin application is described in <<{articles}/flow/production#, Deploying to Production>>.
...
Read <<{articles}/flow/production#, Deploying to Production>> to learn more about building your application for production.
