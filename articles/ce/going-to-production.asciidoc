...
To obtain your license, https://vaadin.com/collaboration/#contact-us[click here to contact our team]. 
You can also request and purchase a larger quota of end users than provided by your commercial Vaadin subscription. 
Additional end users above your bundled quota are billed at 1 USD (or 1 EUR) per month.
