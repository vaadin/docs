...
Each Vaadin subscription offers a bundled quota of users per month, based on the number of development seats.
...
A starting package for 199 EUR / 500 users / month is available without the need for any other Vaadin commercial subscription.
