...
Enabling production mode for a Vaadin application is described in <<{articles}/flow/guide/production#, Deploying to Production>>.
...
Read <<{articles}/flow/guide/production#, Deploying to Production>> to learn more about building your application for production.
...
See <<{articles}/flow/guide/configuration#,Configuration Properties>> for more information.
