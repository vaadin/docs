...
ifdef::articles[]
(read <<{articles}/flow/binding-data/tutorial-flow-components-binder#,Binding Data to Forms>> to learn more).
endif::articles[]
ifndef::articles[]
(read <<../flow/binding-data/tutorial-flow-components-binder#,Binding Data to Forms>> to learn more).
endif::articles[]
...
image::images/collaboration-binder-example.png["A form, where the email field is currently being edited by another user", 387]
...
[discussion-id]`6272DDD1-CF5A-4076-A265-275176ADD560`
