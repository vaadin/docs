...
To solve this issue, you can provide a [classname]#CollaborationMessagePersister# to store the messages in your own backend as described in <<ce.message-manager.persister, the Message Manager documentation>> (this component uses the manager internally).
