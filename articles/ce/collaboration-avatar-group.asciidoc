...
[source, Java]
----
include::{root}/src/main/java/com/vaadin/demo/ce/AvatarGroupDocumentation.java[render,tags=avatar-group-new,indent=0,group=Java]
----
...
[source, Java]
----
include::{root}/src/main/java/com/vaadin/demo/ce/AvatarGroupDocumentation.java[render,tags=avatar-group-images,indent=0,group=Java]
----
...
[source, Java]
----
include::{root}/src/main/java/com/vaadin/demo/ce/AvatarGroupDocumentation.java[render,tags=avatar-group-topic,indent=0,group=Java]
----
...
[source, Java]
----
include::{root}/src/main/java/com/vaadin/demo/ce/AvatarGroupDocumentation.java[render,tags=avatar-group-own,indent=0,group=Java]
----
