...
[source, Java]
----
include::{root}/src/main/java/com/vaadin/demo/ce/AvatarGroupDocumentation.java[render,tags=snippet,indent=0,group=Java,lines=21..26]
----
...
[source, Java]
----
include::{root}/src/main/java/com/vaadin/demo/ce/AvatarGroupDocumentation.java[render,tags=snippet,indent=0,group=Java,lines=40..50]
----
...
[source, Java]
----
include::{root}/src/main/java/com/vaadin/demo/ce/AvatarGroupDocumentation.java[render,tags=snippet,indent=0,group=Java,lines=53..55]
----
...
[source, Java]
----
include::{root}/src/main/java/com/vaadin/demo/ce/AvatarGroupDocumentation.java[render,tags=snippet,indent=0,group=Java,lines=28..36]
----
