...
[Collaboration Engine](https://vaadin.com/collaboration) is a solution for building real-time collaboration features into web apps with a few lines of code.
