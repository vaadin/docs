...
.Adding Collaboration Engine to your project
[NOTE]
Collaboration Engine is part of Vaadin Platform starting from V19, but it is compatible with V14 LTS up-to version 3.2.
