...
End users can submit comments and chat messages in real time.
...
There are three high-level APIs that enable the specific use cases of editing a form together and having real-time discussions.
