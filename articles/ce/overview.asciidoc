...
CollaborationCollaboration Managers provide a mid-level API to handle collaborative data for the most common use cases and lets developers build their own collaborative logic and custom components:
