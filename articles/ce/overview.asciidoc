...
[classname]#CollaborationAvatarGroup# is a component that shows the avatar of every user who is present in a given topic, for example all the users currently looking at or editing the same item.
