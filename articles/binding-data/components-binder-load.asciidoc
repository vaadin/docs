...
Form state is loaded from business objects, and can be saved normally after validation. Once your bindings are set up, you're ready to fill the bound UI components with data from your business objects. Changes can be written to business objects, automatically or manually.
