...
Since the provided value cannot be parsed correctly, a `null` is provided to the binder and, as the field is optional, the binder doesn't complain and the validation status would be `true`.
