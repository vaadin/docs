...
This example uses Spring Data based backend, so we convert Vaadin's QuerySortOrder hints to Spring's Sort.Order objects and finally pass the sort (and paging) details to the backend.
