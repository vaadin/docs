...
This example uses Spring Data based backend, so it is mostly converting Vaadin's QuerySortOrder hints to Spring's Sort.Order objects and finally passing the sort (and paging) details to the backend.
