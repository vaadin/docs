...
Quarkus Bill-of-Materials (BOM) may pin libraries to version that conflicts with Vaadin, resulting in runtime or test failures because of changes in method signatures.
