...
Vaadin Portlet applications need to be instructed to retrieve the `WAR` build's static front-end assets from the `static-vaadin-assets` module. This is done by creating the file, [filename]`./src/main/resources/META-INF/VAADIN/config/flow-build-info.json`.
