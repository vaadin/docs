...
- Vaadin Portlet does not support integration with `OSGi`, which comes with Liferay 7. Vote for https://github.com/vaadin/flow/issues/10939/[OSGi support for Vaadin Portlet] if you need it in your project and leave a comment about your use cases.
