...
For an existing Vaadin project, you can connect to MariaDB there are a few steps. First, add the `mariadb-java-client` dependency to the [filename]`pom.xml` file_
