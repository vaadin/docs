...
MariaDB is a popular fork of the relational database MySQL.
You should https://mariadb.org/download/?t=mariadb&o=true&p=mariadb&r=10.10.0[install MariaDB] separately before you can connect to it from your Vaadin application (you can also install MariaDB as a https://hub.docker.com/_/mariadb[Docker container]).
...
include::{root}/articles/integration/databases/_shared.adoc
