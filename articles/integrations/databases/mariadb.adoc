...
You need to https://mariadb.org/download/?t=mariadb&o=true&p=mariadb&r=10.10.0[install MariaDB] separately before you can connect to it from your Vaadin application (you can also install MariaDB as a https://hub.docker.com/_/mariadb[Docker container]).
