...
Use https://hilla.dev/docs/react/components/side-nav[SideNav] or https://hilla.dev/docs/react/guides/routing#adding-routes[NavLink] components to navigate from a Hilla view to a Flow view:
