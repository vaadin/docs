...
+
Using WebDriverManager is the easiest way to manage Drivers, because you do not have to download and set up the driver manually by yourself.
+
[loweralpha]
...
For a non-Spring Boot project, there are examples at GitHub of the `it` profile for other technology stacks, including for a https://github.com/vaadin/skeleton-starter-flow[plain Java project] and a CDI https://github.com/vaadin/skeleton-starter-flow-cdi[project].
