...
description: End-to-end testing simulates a user of your application, performs the tasks specified using Java code, and verifies that the expected actions take place in the application.
order: 30
page-links:
...
Although it isn't the main purpose of TestBench, you can also use the end-to-end testing approach to automate mundane tasks such as filling out forms.
...
[.discussion-id]
1B4CF5FB-B084-4ABE-960C-C16F8E0C0F56
