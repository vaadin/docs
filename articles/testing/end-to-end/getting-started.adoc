...
To be able to run tests locally, you might need to install a web driver for your browser.
...
To write real tests, use the <<maintainable-tests-using-page-objects#,Page or View Objects>>, which will improve code readability.

[TIP]
Do not place your tests in the root package, as in this example.
