...
TestBench UI unit testing is *browser-less*, so you look up components straight from [methodname]`UI.getCurrent()`, bypassing the browser and the JavaScript -> server bridge.
...
In addition to UI unit testing, TestBench also enables you to write end-to-end tests for your Vaadin applications.
