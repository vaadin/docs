...
TestBench is the only tool that provides helpers for unit testing Vaadin UIs.

TestBench is itself based on Selenium. Playwright is similar to Selenium.
However, TestBench is specifically designed for testing Vaadin applications. 
