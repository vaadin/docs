...
description: How to set up end-to-end testing for a Vaadin application using Selenium.
order: 100
---

= Testing Vaadin Applications with Selenium

Selenium is a popular open source browser automation library that's often used to automate the testing of web applications.
