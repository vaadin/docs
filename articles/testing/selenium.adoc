...
To use Selenium in a Vaadin application, you need to perform a few steps. First, qdd the Selenium library dependency to your project's [filename]`pom.xml` file.
