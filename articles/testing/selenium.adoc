...
https://bonigarcia.dev/selenium-jupiter/[Selenium-Jupiter] is a JUnit5 extension that can be used to initialize, run and manage browser based tests.

Combining TestBench with Selenium-Jupiter is straightforward, like in example:
