...
It is also possible to continue using the bootstraping mode in V10-14 with the `useDeprecatedV14Bootstrapping` flag. See how the use the flag in <<configuration/index#, Configuration Properties>>.
