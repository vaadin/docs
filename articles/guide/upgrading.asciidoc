...
=== TypeScript Code Generation Nullablity Change
...
// Use question mark to deal with undefinable properties in Vaadin 21
person.address?.street
----
...
New Lit 2.0 is used for Lit templates in the latest Vaadin version.
