...
+
NetBeans shows common https://vaadin.com/blog/learning-maven-concepts[Maven goals] inside the *Navigator* view:
+
.Navigator view
...
* How to develop a Java web application without coding JavaScript or HTML, see the https://vaadin.com/docs/latest/getting-started[Vaadin getting started tutorial].
endif::web[]
