...
For Spring applications, there is <<../flow/integrations/spring/tutorial-spring-configuration#, Spring specific instructions available>>.
...
|pushMode |
The permitted values are "disabled" or "manual". Please consult <<../flow/advanced/tutorial-push-configuration#, Server Push Configuration>> documentation.

|pushURL |
It is the url to use for push requests. Some servers require a predefined URL to push.
Please consult <<../flow/advanced/tutorial-push-configuration#, Server Push Configuration>> documentation.
...
Please consult <<../flow/advanced/tutorial-i18n-localization#, I18N localization>> documentation.
...
Uses bytecode scanning which increases application startup time. *This feature is available only in Vaadin 14.1 and newer.*
...
|pnpm.enable |
**Available since Vaadin 14.2**, this flag can be used to enable pnpm
...
<<installing/frontend#switch-between-npm-and-pnpm, switch between pnpm and npm documentation>>.
|===
