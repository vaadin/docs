...
See <<upgrading/v10-13#compatibility-mode, Compatibility mode in Vaadin 14 Migration Guide>> for more information.
...
<<install/frontend#switch-between-npm-and-pnpm, switch between pnpm and npm documentation>>.
|===
