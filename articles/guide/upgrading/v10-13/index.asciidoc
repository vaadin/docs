...
npm instead of pnpm, you may disable pnpm (see <<{articles}/guide/configuration#configuration-properties,Configuration Properties>>
or <<{articles}/guide/install/frontend#pnpm,pnpm>> sections).
...
`vaadin.compatibilityMode` to `true`. Read more about setting <<{articles}/guide/configuration#,Configuration Properties>>.
...
<properties>
    ...
    <vaadin.version>14.7.0.alpha3</vaadin.version>
</properties>
----
