...
* <<v8-upgrade/overview#, Vaadin 7–8 to Vaadin 14 LTS>>
* <<v10-upgrade/overview#, Vaadin 10–13 to Vaadin 14 LTS>>
* <<v14-upgrade/overview#, Vaadin 14 LTS to Vaadin {vaadin-major-version}>>
* <<v15-upgrade/overview#, Vaadin 15+ to Vaadin {vaadin-major-version}>>
...
For instructions, see <<mpr/overview#, Vaadin Multiplatform Runtime>>.
