...
There are two paths to upgrade; either use the <<{articles}/guide/upgrading/mpr/mpr-overview#, Multiplatform Runtime>> (available through Prime or Enterprise subscription) to run a Vaadin 8 application inside a Vaadin 14 application,
