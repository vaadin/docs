...
annotations with `@JsModule` annotations, see <<upgrade-tool#,Upgrade Tool>> tutorial.
...
There is a upgrade tool available which does this conversation. See <<upgrade-tool#,Upgrade Tool>> tutorial.
...
The upgrade tool is able to do this step for you automatically, see <<upgrade-tool#,Upgrade Tool>> tutorial.
