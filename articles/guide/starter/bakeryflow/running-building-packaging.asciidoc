...
To run tests on multiple browser Selenium hub follow the <<{articles}/testbench/running-test-on-multiple-browsers#, Running Tests on Multiple Browsers in a Grid>>.
