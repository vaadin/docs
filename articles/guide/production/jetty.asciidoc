...
For more information about Spring configuration, please consult the <<{articles}/flow/integrations/spring/tutorial-spring-configuration#, Vaadin Spring configuration guide>>.
