...
http://vaadin.com/start[Vaadin Start] gives you options to start creating an application with Vaadin 14 LTS (Long Term Support) or the latest stable release.
