...
The following starter repositories are currently available. These repositories default to the V14 branch when you clone them. If you plan to use them with the latest version of Vaadin, you can either clone the master branch, or change to it after you've cloned either of the starter projects.
