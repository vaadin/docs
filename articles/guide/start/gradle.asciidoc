...
`productionMode = false`::
  ...
  For production, the front-end is transpiled for older browsers and optimized, as described in <<{articles}/guide/production/mode#,Building in Production Mode>>.
...
When making a production-ready build, the Vaadin Gradle Plugin transpiles the client-side dependencies to legacy browsers, as described in <<{articles}/guide/production/mode#,Building in Production Mode>>.
