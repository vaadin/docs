...
`link:https://github.com/vaadin/base-starter-gradle[https://github.com/vaadin/base-starter-gradle]`::
  A simple web application project to be deployed as a WAR package. This example can also be used for Java EE, by changing the servlet dependency into `javax:javaee-api`and potentionally adding `com.vaadin:vaadin-cdi` dependency for CDI integration.
+
[subs="normal"]
----
