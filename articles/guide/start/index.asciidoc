...
You can also choose between H2 and PostgreSQL databases; if PostgreSQL is selected, the necessary configuration will be automatically added to the `application.properties` file of the generated project.
