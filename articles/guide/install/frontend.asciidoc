...
See <<{articles}/guide/install/frontend#switch-between-npm-and-pnpm#,Switch between NPM and PNPM>> for instructions how to configure a Vaadin project to use pnpm.
