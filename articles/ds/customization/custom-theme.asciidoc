---
title: Creating a Custom Theme I
order: 25
layout: page
---
...
It can be packaged as a dependency for reuse in multiple applications, as described in <<custom-theme-advanced#reuse-packaging, Packaging a Theme for Reuse>>.
