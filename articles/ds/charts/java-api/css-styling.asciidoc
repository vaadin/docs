...
Starting from Vaadin 14, applications running on the default mode can use `@CssImport` annotation that allows theme creation with plain CSS files. See the <<{articles}/guide/upgrading/v10-13/v14-theming-migration#,"Migrating Theming Files from Polymer 2 to Polymer 3">> page for more details.
