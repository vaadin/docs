...
By default, the date picker displays and parses dates using the user's locale (https://vaadin.com/docs/latest/flow/advanced/i18n-localization/#locale-selection-for-new-session[reference]).
...
[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/datepicker/DatePickerLocale.java[render,tags=snippet,indent=0,group=Java]
----
--
...
[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/datepicker/DatePickerCustomFormat.java[render,tags=snippet,indent=0,group=Java]
----
--
...
[NOTE]
====
The example above uses the 3rd-party library https://date-fns.org/[date-fns] to implement the custom formatting and parsing functions.
====
