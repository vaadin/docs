...
|===
| Component | Property | Text | Description
...
Size variants should only be used in special cases. See <<{articles}/ds/foundation/size-space,Size and Space>> for details on how to change the default Avatar size.
