...
title: Avatar
page-links:
  - 'API: https://cdn.vaadin.com/vaadin-avatar/{moduleNpmVersion:vaadin-avatar}/#/elements/vaadin-avatar[Web Component] / https://vaadin.com/api/platform/{moduleMavenVersion:com.vaadin:vaadin}/com/vaadin/flow/component/avatar/Avatar.html[Java]'
  - 'Source: https://github.com/vaadin/vaadin-avatar[Web Component] / https://github.com/vaadin/flow-components/tree/{moduleMavenVersion:com.vaadin:vaadin}/vaadin-avatar-flow-parent[Java]'
---
...
[source,typescript]
----
include::{root}/frontend/demo/component/avatar/avatar-basic.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/avatar/AvatarBasic.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/avatar/avatar-name.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/avatar/AvatarName.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/avatar/avatar-abbreviation.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/avatar/AvatarAbbreviation.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/avatar/avatar-image.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/avatar/AvatarImage.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/avatar/avatar-group-basic.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/avatar/AvatarGroupBasic.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/avatar/avatar-group-max-items.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/avatar/AvatarGroupMaxItems.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/avatar/avatar-group-bg-color.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/avatar/AvatarGroupBgColor.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/avatar/avatar-group-internationalisation.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/avatar/AvatarGroupInternationalisation.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/avatar/avatar-sizes.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/avatar/AvatarSizes.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/avatar/avatar-menu-bar.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/avatar/AvatarMenuBar.java[render,tags=snippet,indent=0]
----
--


[discussion-id]`1127C712-B001-4CBA-B4DB-026187A8037C`
