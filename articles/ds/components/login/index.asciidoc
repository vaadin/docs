...
[source,css]
----
include::{root}/frontend/themes/docs/login-rich-content.css[render,indent=0,group=TypeScript]
----
...
[source,css]
----
include::{root}/frontend/themes/docs/login-rich-content.css[render,indent=0,group=Java]
----
--
