...
This token is submitted as `_csrf=71dac59f-34ee-4b31-b478-2891cbd0c55d` i.e. using the `_csrf_parameter` content as the variable name and the `_csrf` content as the value.
