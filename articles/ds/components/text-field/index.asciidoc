...
[NOTE]
Prefix and suffix are ignored by screen readers and therefore any information relevant for assistive technologies needs to be provided as a label and possibly helper text.
