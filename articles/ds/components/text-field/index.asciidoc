...
title: Text Field
page-links:
  - 'API: https://cdn.vaadin.com/vaadin-text-field/{moduleNpmVersion:vaadin-text-field}/#/elements/vaadin-text-field[Web Component] / https://vaadin.com/api/platform/{moduleMavenVersion:com.vaadin:vaadin}/com/vaadin/flow/component/textfield/TextField.html[Java]'
...
[source,typescript]
----
include::{root}/frontend/demo/component/textfield/text-field-basic.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/textfield/TextFieldBasic.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/textfield/text-field-placeholder.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/textfield/TextFieldPlaceholder.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/textfield/text-field-clear-button.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/textfield/TextFieldClearButton.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/textfield/text-field-text-alignment.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/textfield/TextFieldTextAlignment.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/textfield/text-field-prefix-suffix.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/textfield/TextFieldPrefixSuffix.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/textfield/text-field-min-max-input-length.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/textfield/TextFieldMinMaxInputLength.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/textfield/text-field-pattern.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/textfield/TextFieldPattern.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/textfield/text-field-small-variant.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/textfield/TextFieldSmallVariant.java[render,tags=snippet,indent=0]
----
--
...
[discussion-id]`1C2680EF-D133-4B64-BFBC-FA790221D3FA`
