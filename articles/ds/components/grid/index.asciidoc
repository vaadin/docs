...
Components such as <<../input-fields#,input fields>> and <<../button#,Buttons>> are also supported.
...
[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridComponentRenderer.java[tags=snippet,indent=0]
----
--
...
[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridTemplateRenderer.java[tags=snippet,indent=0]
----
--
...
[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridFiltering.java[render,tags=snippet,indent=0,group=Java]
----
--
