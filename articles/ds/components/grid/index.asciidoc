...
title: Grid
page-links:
  - 'API: https://cdn.vaadin.com/vaadin-grid/{moduleNpmVersion:vaadin-grid}/#/elements/vaadin-grid[Web Component] / https://vaadin.com/api/platform/{moduleMavenVersion:com.vaadin:vaadin}/com/vaadin/flow/component/grid/Grid.html[Java]'
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-basic.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridBasic.java[render,tags=snippet,indent=0]
----
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-content.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridContent.java[render,tags=snippet1,indent=0]

...

include::{root}/src/main/java/com/vaadin/demo/component/grid/GridContent.java[render,tags=snippet2,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-dynamic-height.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridDynamicHeight.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-single-selection-mode.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridSingleSelectionMode.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-multi-select-mode.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridMultiSelectionMode.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-column-alignment.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridColumnAlignment.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-column-freezing.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridColumnFreezing.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-column-grouping.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridColumnGrouping.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-column-header-footer.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridColumnHeaderFooter.java[render,tags=snippet1,indent=0]

...

include::{root}/src/main/java/com/vaadin/demo/component/grid/GridColumnHeaderFooter.java[render,tags=snippet2,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-column-visibility.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridColumnVisibility.java[render,tags=snippet1,indent=0]

...

include::{root}/src/main/java/com/vaadin/demo/component/grid/GridColumnVisibility.java[render,tags=snippet2,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-column-reordering-resizing.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridColumnReorderingResizing.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-column-width.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridColumnWidth.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-sorting.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridSorting.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-rich-content-sorting.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridRichContentSorting.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-column-filtering.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridColumnFiltering.java[render,tags=snippet1,indent=0]

...

include::{root}/src/main/java/com/vaadin/demo/component/grid/GridColumnFiltering.java[render,tags=snippet2,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-external-filtering.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridExternalFiltering.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-item-details.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridItemDetails.java[render,tags=snippet1,indent=0]

...

include::{root}/src/main/java/com/vaadin/demo/component/grid/GridItemDetails.java[render,tags=snippet2,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-item-details-toggle.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridItemDetailsToggle.java[render,tags=snippet1,indent=0]

...

include::{root}/src/main/java/com/vaadin/demo/component/grid/GridItemDetailsToggle.java[render,tags=snippet2,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-context-menu.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridContextMenuExample.java[render,tags=snippet1,indent=0]

...

include::{root}/src/main/java/com/vaadin/demo/component/grid/GridContextMenuExample.java[render,tags=snippet2,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-row-reordering.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridRowReordering.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-drag-rows-between-grids.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridDragRowsBetweenGrids.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-drag-drop-filters.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridDragDropFilters.java[render,tags=snippet,indent=0]
----
--
...
[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridBufferedInlineEditor.java[render,tags=snippet,indent=0]
----
...
[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridUnbufferedInlineEditor.java[render,tags=snippet,indent=0]
----
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-styling.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridStyling.java[render,tags=snippet,indent=0]
----
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-compact.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridCompact.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-no-border.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridNoBorder.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-no-row-border.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridNoRowBorder.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-column-borders.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridColumnBorders.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-row-stripes.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridRowStripes.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-wrap-cell-content.ts[preimport,hidden]
----
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-cell-focus.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridCellFocus.java[render,tags=snippet,indent=0]
----
...
[discussion-id]`DCDFD246-69FE-41E3-A286-A09B4EAE2E6F`
