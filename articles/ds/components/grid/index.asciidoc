...
It is possible to freeze columns to the right separately.
This is especially useful for rightmost columns.
...
[source,typescript]
----
include::{root}/frontend/demo/component/grid/grid-column-freezing-to-end.ts[render,tags=snippet,indent=0,group=TypeScript]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/grid/GridColumnFreezingToEnd.java[render,tags=snippet,indent=0,group=Java]
----
--
