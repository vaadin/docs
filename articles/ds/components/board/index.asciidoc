...
[source,typescript]
----
include::{root}/frontend/demo/component/board/utils/board-chart.ts[group=TypeScript]
----

[source,typescript]
----
include::{root}/frontend/demo/component/board/utils/board-card.ts[group=TypeScript]
----

[source,typescript]
----
include::{root}/frontend/demo/component/board/shared-styles/board-default-breakpoints.ts[group=TypeScript]
----

[source,typescript]
----
include::{root}/frontend/demo/component/board/shared-styles/board-border.ts[group=TypeScript]
----
...
[source,typescript]
----
include::{root}/frontend/demo/component/board/utils/board-statistics.ts[group=TypeScript]
----
...
[source,typescript]
----
include::{root}/frontend/demo/component/board/utils/board-resize-info.ts[group=TypeScript]
----
...
[source,typescript]
----
include::{root}/frontend/demo/component/board/shared-styles/board-cell-default.ts[group=TypeScript]
----

[source,typescript]
----
include::{root}/frontend/demo/component/board/shared-styles/board-cell-color.ts[group=TypeScript]
----
