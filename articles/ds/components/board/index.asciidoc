...
title: Board
page-links:
  - 'API: https://cdn.vaadin.com/vaadin-board/{moduleNpmVersion:vaadin-board}/#/elements/vaadin-board[Web Component] / https://vaadin.com/api/platform/{moduleMavenVersion:com.vaadin:vaadin}/com/vaadin/flow/component/board/Board.html[Java]'
  - 'Source: https://github.com/vaadin/vaadin-board[Web Component] / https://github.com/vaadin/flow-components/tree/{moduleMavenVersion:com.vaadin:vaadin}/vaadin-board-flow-parent[Java]'
...
[source,typescript]
----
include::{root}/frontend/demo/component/board/board-basic.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/board/BoardBasic.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/board/board-nested.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/board/BoardNested.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/board/board-column-wrapping.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/board/BoardColumnWrapping.java[render,tags=snippet,indent=0]
----
...
[source,typescript]
----
include::{root}/frontend/demo/component/board/board-column-span.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/board/BoardColumnSpan.java[render,tags=snippet,indent=0]

...

include::{root}/src/main/java/com/vaadin/demo/component/board/BoardColumnSpan.java[render,tags=createBoard,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/board/board-breakpoints.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/board/BoardBreakpoints.java[render,tags=snippet,indent=0]
----

[source,css]
----
include::{root}/frontend/themes/docs/board.css[tags=breakpoint,indent=0]
----
--


[discussion-id]`45A8A464-023A-4ED8-B10D-326C852350DD`
