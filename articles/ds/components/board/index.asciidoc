...
[source,typescript]
----
include::{root}/frontend/demo/component/board/example-default-breakpoints.css.ts[group=TypeScript]
----
...
[source,typescript]
----
include::{root}/frontend/demo/component/board/example-cell-color.css.ts[group=TypeScript]
----
