...
// This example setup only renders the Typescript example as preview,
// and then merges with another example that only shows the code for both
// Java and Typescript without rendering them
// The preview initializes the upload component with some data which should not
// be visible in the code snippet, and would be difficult to reproduce in Java
[.example.render-only.merge]
--
[source,typescript]
----
include::{root}/frontend/demo/component/upload/upload-basic.ts[render]
----
--
...
[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/upload/UploadBasic.java[tags=snippet,indent=0,group=Java]
----
--
...
We provide the following default implementations of `Receiver`:
...
[NOTE]
====
This section is only relevant when using the web component through Fusion, or standalone.
...
[source,typescript]
----
include::{root}/frontend/demo/component/upload/upload-auto-upload-disabled.ts[render]
----
--
...
[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/upload/UploadAutoUploadDisabled.java[tags=snippet,indent=0,group=Java]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/upload/DefaultUploadI18N.java[group=Java]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/upload/upload-all-files.ts[render]
----
--
...
[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/upload/UploadAllFiles.java[tags=snippet,indent=0,group=Java]
----
--
