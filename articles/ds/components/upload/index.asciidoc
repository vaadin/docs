...
[source,html]
----
include::{root}/frontend/demo/component/upload/upload-clear-button.ts[render,tags=snippet,indent=0,group=TypeScript]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/upload/UploadClearButton.java[render,tags=snippet,indent=0,group=Java]
----
--
...
[source,html]
----
include::{root}/frontend/demo/component/upload/upload-retry-button.ts[render,tags=snippet,indent=0,group=TypeScript]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/upload/UploadRetryButton.java[render,tags=snippet,indent=0,group=Java]
----
--
...
[source,html]
----
include::{root}/frontend/demo/component/upload/upload-start-button.ts[render,tags=snippet,indent=0,group=TypeScript]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/upload/UploadStartButton.java[render,tags=snippet,indent=0,group=Java]
----
--
...
For a complete list please refer to the https://cdn.vaadin.com/vaadin-upload/4.4.1/#/elements/vaadin-upload#property-i18n[API documentation].
...
[NOTE]
====
When customising the Upload component make sure not to make the drop target too small.
...
|_File Rejected_
|Sent when the file(s) selected for upload doesn't meet the constraints, for example, file size
