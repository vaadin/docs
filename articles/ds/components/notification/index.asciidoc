...
[WARNING]
====
At the moment, Flow renders notifications with rich content via
intermediate `<flow-component-renderer />` which may break the CSS cascade
and prevent the content from taking full width.

To work around this issue, add the following CSS snippet globally:
```css
...
[source,html]
----
include::{root}/frontend/demo/component/notification/notification-keyboard-a11y.ts[render,tags=snippet,indent=0,group=TypeScript]
----
--
...
[source,css]
----
include::{root}/frontend/themes/docs/notification-rich-example.css[]
----
--
