...
title: Radio Button
page-links:
  - 'API: https://cdn.vaadin.com/vaadin-radio-button/{moduleNpmVersion:vaadin-radio-button}/#/elements/vaadin-radio-group[Web Component] / https://vaadin.com/api/platform/{moduleMavenVersion:com.vaadin:vaadin}/com/vaadin/flow/component/radiobutton/RadioButtonGroup.html[Java]'
  - 'Source: https://github.com/vaadin/vaadin-radio-button[Web Component] / https://github.com/vaadin/flow-components/tree/{moduleMavenVersion:com.vaadin:vaadin}/vaadin-radio-button-flow-parent[Java]'
---
...
[source,typescript]
----
include::{root}/frontend/demo/component/radiobutton/radio-button-basic.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/radiobutton/RadioButtonBasic.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/radiobutton/radio-button-readonly.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/radiobutton/RadioButtonReadonly.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/radiobutton/radio-button-disabled.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/radiobutton/RadioButtonDisabled.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/radiobutton/radio-button-vertical.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/radiobutton/RadioButtonVertical.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/radiobutton/radio-button-horizontal.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/radiobutton/RadioButtonHorizontal.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/radiobutton/radio-button-presentation.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/radiobutton/RadioButtonPresentation.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/radiobutton/radio-button-group-labels.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/radiobutton/RadioButtonGroupLabels.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/radiobutton/radio-button-custom-option.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/radiobutton/RadioButtonCustomOption.java[render,tags=snippet,indent=0]
----
--
...
----
include::{root}/frontend/demo/component/radiobutton/radio-button-default-value.ts[render]
----
...
[source,typescript,role=render-only]
----
include::{root}/frontend/demo/component/radiobutton/radio-button-checkbox-alternative.ts[render]
----
...
[discussion-id]`F93D1439-482C-4767-9E51-D0A1E61B9EC6`
