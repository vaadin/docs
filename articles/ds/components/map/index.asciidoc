...
This makes it easy to get started with development.
However, for production use we encourage you to use a commercial map service, or a self-hosted solution.
The OpenStreetMap tile servers are not intended to be used as map services for applications in production.
