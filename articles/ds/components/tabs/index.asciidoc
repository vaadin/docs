...
Vertical tabs work best for a big number of links.
...
A common approach in mobile navigation is to place the navigation at the bottom of the screen, as this is more accessible, for example with one-handed use.
