...
Previously merged cells can be unmerged with `removeMergedRegion()`.
...
You can create popup buttons for a row of cells in a cell range by defining a table, as described in https://vaadin.com/docs/v8/spreadsheet/spreadsheet-overview[Tables Within Spreadsheets].
