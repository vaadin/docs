...
// tag::description[]
Custom Field is a component for wrapping multiple components as a single field. It has the same features as <<../input-fields,Input Fields>>, such as its own label, helper, validation and data binding. Use it to create custom input components.
// end::description[]
