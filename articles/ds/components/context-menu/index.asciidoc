...
include::{root}/frontend/demo/component/contextmenu/context-menu-dividers.ts[render,tag=snippethtml,indent=0,group=TypeScript]
----
...
[source, typescript]
----
include::{root}/frontend/demo/component/contextmenu/context-menu-keyboard-shortcuts.ts[render,tag=snippet,indent=0,group=TypeScript]

...

include::{root}/frontend/demo/component/contextmenu/context-menu-keyboard-shortcuts.ts[render,tag=snippethtml,indent=0,group=TypeScript]
----
