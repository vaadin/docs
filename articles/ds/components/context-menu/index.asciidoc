...
[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/contextmenu/ContextMenuPresentation.java[render,tags=snippet,indent=0,group=Java]
----
--
...
[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/contextmenu/ContextMenuDisabled.java[render,tags=snippet,indent=0,group=Java]
----
--
