...
[source,typescript]
----
include::{root}/frontend/demo/component/app-layout/app-layout-basic.ts[render, frame, tags=snippet1, indent=0, group=TypeScript]
...
include::{root}/frontend/demo/component/app-layout/app-layout-basic.ts[render, frame, tags=snippet2, indent=1, group=TypeScript]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/applayout/AppLayoutBasic.java[render,frame,tags=snippet1,indent=0,group=Java]
...
include::{root}/src/main/java/com/vaadin/demo/component/applayout/AppLayoutBasic.java[render,frame,tags=snippet2,indent=1,group=Java]
...
include::{root}/src/main/java/com/vaadin/demo/component/applayout/AppLayoutBasic.java[render,frame,tags=snippet3,indent=1,group=Java]
----
--
