...
Here is an example of an initialized `items` array with two messages, in Java and TypeScript:
...
MessageListItem message2 = new MessageListItem(
    ...
    fiftyMinsAgo, "Linsey Listy", userImageUrl);
List<MessageListItem> items = Arrays.asList(message1, message2);
----
[source,typescript]
----
this.items = [
