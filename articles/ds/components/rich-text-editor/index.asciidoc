...
page-links:
  - 'API: https://cdn.vaadin.com/vaadin-rich-text-editor/{moduleNpmVersion:vaadin-rich-text-editor}/#/elements/vaadin-rich-text-editor[Web Component] / https://vaadin.com/api/platform/{moduleMavenVersion:com.vaadin:vaadin}/com/vaadin/flow/component/richtexteditor/RichTextEditor.html[Java]'
  - 'Source: https://github.com/vaadin/vaadin-rich-text-editor[Web Component] / https://github.com/vaadin/flow-components/tree/{moduleMavenVersion:com.vaadin:vaadin}/vaadin-rich-text-editor-flow-parent[Java]'
...
[source,typescript]
----
include::{root}/frontend/demo/component/richtexteditor/rich-text-editor-basic.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/richtexteditor/RichTextEditorBasic.java[render,tags=snippet,indent=0]
----
...
[source,typescript]
----
include::{root}/frontend/demo/component/richtexteditor/rich-text-editor-readonly.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/richtexteditor/RichTextEditorReadonly.java[render,tags=snippet,indent=0]
----
...
[source,typescript]
----
include::{root}/frontend/demo/component/richtexteditor/rich-text-editor-min-max-height.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/richtexteditor/RichTextEditorMinMaxHeight.java[render,tags=snippet,indent=0]
----
...
[source,typescript]
----
include::{root}/frontend/demo/component/richtexteditor/rich-text-editor-theme-compact.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/richtexteditor/RichTextEditorThemeCompact.java[render,tags=snippet,indent=0]
----
...
[source,typescript]
----
include::{root}/frontend/demo/component/richtexteditor/rich-text-editor-theme-no-border.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/richtexteditor/RichTextEditorThemeNoBorder.java[render,tags=snippet,indent=0]
----
...
[source,typescript]
----
include::{root}/frontend/demo/component/richtexteditor/rich-text-editor-set-get-value.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/richtexteditor/RichTextEditorSetGetValue.java[render,tags=snippet,indent=0]
----
...
[discussion-id]`3401C535-1DAF-4DD4-8606-AEE67E7431CA`
