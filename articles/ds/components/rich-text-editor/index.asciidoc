...
<style>
  ...
  .icon > .content {
    padding-bottom: calc(var(--lumo-space-xs) * 2.3) !important;
  ...
  .rte-button {
    display: block;
    width: calc(var(--lumo-size-xs) * 2);
    margin: var(--lumo-space-xs);
    color: var(--lumo-contrast-60pct);
    background: var(--lumo-contrast-5pct);
    border-radius: var(--docs-border-radius-m);
    line-height: calc(var(--lumo-line-height-m) * 2);
    font-weight: 600;
  }
  ...
  .h1 {
    line-height: calc(var(--lumo-line-height-s) * 2.1);
  ...
  .h3 {
    line-height: calc(var(--lumo-line-height-m) * 2.3);
  ...
  .superscript::after {
    ...
    left: 65%;
    line-height: normal;
    font-size: calc(var(--lumo-font-size-xxs) / 1.3);
    font-weight: 700;
  }
  ...
  .block-quote,
  .code-block {
    padding: 0 calc(var(--lumo-space-s) * 2);
  }

  .block-quote {
    display: block;
    padding-top: var(--lumo-space-m);
    line-height: calc(var(--lumo-line-height-s) / 1.1);
