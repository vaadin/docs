...
Showing the helper before the field can sometimes be a better choice, as it is presented to the user before the field.
For example, screen reader users will get the instructions before entering field.

You can choose to show the helper before the field.
If you do, make sure to apply it to all fields in a form for consistency.
