...
However, when all of the content is relevant to the user to make a decision, Accordions should be avoided.
...
However, Accordions can feel “jumpy” as panels are toggled -- especially if there are several panels or the panel content is long.
