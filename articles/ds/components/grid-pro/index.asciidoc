...
// tag::description[]
Grid Pro is a commercial extension of the <<../grid#,Grid>> component that provides  inline editing with full keyboard navigation.
// end::description[]
...
[NOTE]
====
Grid Pro is an extension of the <<../grid#,Grid>> component and thus all of Grid’s features
