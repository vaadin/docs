...
title: Number Field
page-links:
  - 'API: https://cdn.vaadin.com/vaadin-text-field/{moduleNpmVersion:vaadin-text-field}/#/elements/vaadin-number-field[Web Component] / https://vaadin.com/api/platform/{moduleMavenVersion:com.vaadin:vaadin}/com/vaadin/flow/component/textfield/NumberField.html[Java]'
...
[source,typescript]
----
include::{root}/frontend/demo/component/numberfield/number-field-basic.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/numberfield/NumberFieldBasic.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/numberfield/number-field-stepper-controls.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/numberfield/NumberFieldStepperControls.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/numberfield/number-field-min-max.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/numberfield/NumberFieldMinMax.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/numberfield/number-field-step.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/numberfield/NumberFieldStep.java[render,tags=snippet,indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/numberfield/number-field-integer.ts[preimport,hidden]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/numberfield/NumberFieldInteger.java[render,tags=snippet,indent=0]
----
--
...
[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/numberfield/NumberFieldBigDecimal.java[render,tags=snippet,indent=0]
----
--
...
[discussion-id]`5CF5DB80-A237-424D-9276-C7B79614997B`
