...
[IMPORTANT]
See <<Technical>> section for details on the behavior of modal dialogs in Vaadin Flow.
...
By default, opening multiple Dialogs simultaneously in Flow adds each subsequent Dialog as a child of the previous one.
