...
[source,typescript]
----
include::{root}/frontend/demo/component/basiclayouts/basic-layouts-vertical-layout-vertical-alignment.ts[render,tags=snippet;snippethtml,indent=0,group=TypeScript]
----
...
There is no space before the first item, or after the last.
...
[source,typescript]
----
include::{root}/frontend/demo/component/basiclayouts/basic-layouts-vertical-layout-horizontal-alignment.ts[render,tags=snippet;snippethtml,indent=0,group=TypeScript]
----
...
[source,typescript]
----
include::{root}/frontend/demo/component/basiclayouts/basic-layouts-vertical-layout-individual-alignment.ts[render,tags=snippet;snippethtml,indent=0,group=TypeScript]
----
...
[source,typescript]
----
include::{root}/frontend/demo/component/basiclayouts/basic-layouts-horizontal-layout-vertical-alignment.ts[render,tags=snippet;snippethtml,indent=0,group=TypeScript]
----
...
[source,typescript]
----
include::{root}/frontend/demo/component/basiclayouts/basic-layouts-horizontal-layout-individual-alignment.ts[render,tags=snippet;snippethtml,indent=0,group=TypeScript]
----
...
[source,typescript]
----
include::{root}/frontend/demo/component/basiclayouts/basic-layouts-horizontal-layout-horizontal-alignment.ts[render,tags=snippet;snippethtml,indent=0,group=TypeScript]
----
...
|`BETWEEN`
|Available space is distributed evenly between items. There is no space before the first item, or after the last.
...
[source,typescript]
----
include::{root}/frontend/demo/component/basiclayouts/basic-layouts-spacing.ts[render,tags=snippet;snippethtml,indent=0,group=TypeScript]
----
...
[source,typescript]
----
include::{root}/frontend/demo/component/basiclayouts/basic-layouts-spacing-variants.ts[render,tags=snippet;snippethtml,indent=0,group=TypeScript]
----
...
[source,typescript]
----
include::{root}/frontend/demo/component/basiclayouts/basic-layouts-padding.ts[render,tags=snippet;snippethtml,indent=0,group=TypeScript]
----
...
[source,typescript]
----
include::{root}/frontend/demo/component/basiclayouts/basic-layouts-margin.ts[render,tags=snippet;snippethtml,indent=0,group=TypeScript]
----
...
[source,typescript]
----
include::{root}/frontend/demo/component/basiclayouts/basic-layouts-expanding-items.ts[render,tags=snippet;snippethtml,indent=0,group=TypeScript]
----
