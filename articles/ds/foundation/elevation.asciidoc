...
// Use these <<../customization/css-custom-properties#,CSS Custom Properties>> to create visually consistent elevation styles.
...
[discussion-id]`67A445FA-D374-4209-BEDB-ABAECCA5A916`
