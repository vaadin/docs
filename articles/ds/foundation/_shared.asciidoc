...
:attribute-missing: drop
You can also add the `theme="dark"` attribute on any HTML element which is in the <<../../customization/style-scopes#global-style-scope,global style scope>>, to apply the dark color palette to a part of the application.
