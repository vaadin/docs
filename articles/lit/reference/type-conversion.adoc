...
Type Conversion can be customized by using annotations on the object to serialize, as described in <<{articles}/lit/application/custom-type-conversion#,Customizing Type Conversion>>.
