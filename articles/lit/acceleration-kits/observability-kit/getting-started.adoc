...
To use Observability Kit, you'll have to create a Hilla application, as well as download and configure the Kit. Then you'll have to setup an infrastructure and a frontend package. Once you've done all of that, you can run the application. The sections that follow explain each of these steps. 
