...
They are a part of the <<{articles}/lit/reference/form-binding#binder-node,`BinderNode`>> interface.
...
They are a part of the <<{articles}/lit/reference/form-binding#binder,`Binder`>> interface.
