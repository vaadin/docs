...
----
include::{root}/frontend/demo/fusion/application/events/click-view.ts[tags=snippet,indent=0]
----
...
[source,typescript, role=show-code]
----
include::{root}/frontend/demo/fusion/application/events/value-changed-view.ts[tags=snippet,indent=0]
----
