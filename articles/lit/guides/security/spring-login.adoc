...
The data should go to endpoints, and the endpoints should be protected instead. Read <<./configuring#, Configuring Security>> on how to protect endpoints to learn more about this.
