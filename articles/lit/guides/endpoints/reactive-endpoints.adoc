...
= [role="since:com.vaadin:vaadin@V1.2"]#Reactive endpoints#
:experimental:
...
To use Reactive Endpoints, they must be explicitly enabled with a feature flag.
...
https://projectreactor.io/[Project Reactor] is one of these.
