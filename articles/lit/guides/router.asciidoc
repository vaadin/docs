...
// TODO hidden for now, as I'm not sure what additional value this document brings. Whatever it is, it would be good to add that to the routing.adoc page instead
...
It's included in https://www.npmjs.com/package/@vaadin/vaadin-core[`@vaadin/vaadin-core`^], and is automatically included in any Hilla application.
