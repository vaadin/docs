...
export default function ProfileView() {
  ...
  const passwordBinderNode = useFormPart(model.password);
...
export default function ProfileView() {
  ...
  const nameBinderNode = useFormPart(model.password);
  const usernameBinderNode = useFormPart(model.username);
  const ageBinderNode = useFormPart(model.age);
  const emailBinderNode = useFormPart(model.email);
