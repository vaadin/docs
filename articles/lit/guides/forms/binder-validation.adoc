...
export default function EmployeeView() {
  const { model, field } = useBinder(EmployeeModel);
...
export default function ProfileView() {
  const { model, submit, field } = useBinder(EmployeeModel, {
      onSubmit: async (e) => {
...
export default function ProfileView() {
  ...
  const { model, field, addValidator } = useBinder(EmployeeModel);
...
export default function ProfileView() {
  ...
  const { model, field, addValidator } = useBinder(PersonModel);
