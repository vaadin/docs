...
If form submission could take a long time, it's good to give users a visual indication that something is happening. You may also want to prevent more form submissions until the first one is completed (e.g., in a payment form).
