...
In such cases, you use the `useEffect` Hook to react to changes in the value of the first field, and update the value of the second field accordingly. The following simplified example shows how to do this.
