...
export default function PersonView() {
  const { model, field: originalField, read } = useBinder(PersonModel);
...
export default function PersonView() {
  const { model, field: originalField, reset } = useBinder(PersonModel);
...
export default function PersonView() {
  const { model, field: originalField, clear } = useBinder(PersonModel);
...
export default function PersonView() {
  const { model, submit, field: originalField } = useBinder(PersonModel, {
