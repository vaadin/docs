...
This method receives as arguments the element which is mapped to the component and the model, which can in turn affect the binding strategy. For example, the `Combo Box` component has specialized support for objects and arrays.
