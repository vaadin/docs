...
[source,typescript]
----
include::{root}/frontend/demo/fusion/application/basic/my-view.ts[tags=snippet, indent=0]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/fusion/application/basic/reactive-view.ts[tags=snippet, indent=0]
----
--
