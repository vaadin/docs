...
To access business data and logic, an application can have _browser-callable services_ written in Java.
...
You define your browser-callable services here, using Java packages and classes. <<endpoints,Browser-callable Services>> allow your client-side views access to the back-end data.
+
...
See <<endpoints#, Browser-callable Services>> for more information.
