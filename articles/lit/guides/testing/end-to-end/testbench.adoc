...
If you prefer writing end-to-end tests in Java, we recommend a couple of tools: For running tests in the browser, there's https://vaadin.com/testbench[Vaadin TestBench]. For writing and asserting, use https://junit.org/junit5[JUnit v5].
