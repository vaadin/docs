...
For writing unit tests in TypeScript, the following tools are recommended:
...
To add the first test, create a file in the `test` directory.
...
Now you can add some tests for the `Foo` component.
