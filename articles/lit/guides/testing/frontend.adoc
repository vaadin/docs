...
[NOTE]
For converting from TypeScript to JavaScript, Karma uses `ts-node` internally -- it doesn't allow you to change this. Since it could cause various issues, we recommend not using it.
