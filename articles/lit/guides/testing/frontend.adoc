...
----
ifdef::lit[]
For Lit, install Open WC library with testing helpers. It provides useful tools for testing web components. To install it, run the following:
...
ifdef::react[]
For React, install the React Testing Library. It contains useful tools for testing react components. To install it, run the following:
