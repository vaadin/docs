...
The middleware has access to the call context information, including the browser-callable service and the method names, the supplied parameters, and other client call options.
