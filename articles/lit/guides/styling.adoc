...
You can import CSS files directly, either plain files or CSS modules, by adding them into your [filename]`styles.css` file and importing them with the [methodname]`import()` method.
