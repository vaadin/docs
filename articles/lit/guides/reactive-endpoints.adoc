---
title: Reactive Browser-callable Service
description: Reactive browser-callable service allow you to stream data to the client without the traditional HTTP request-response pattern.
order: 35
---
:lit:
// tag::content[]

= [since:dev.hilla:hilla@v1.2]#Reactive Browser-callable Service#
...
=== Server-Side Browser-callable Service

Next you'll need to create a server-side browser-callable service. To do this, open your application in your favorite IDE or editor.
...
[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/fusion/reactive/ReactiveService.java[tags=snippet,indent=0]
----
