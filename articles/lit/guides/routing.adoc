...
// TODO redesign this image
image::images/nested-views.svg["An illustration showing a wireframe of an application with a menu, where navigating to one of the views defined in the menu causes the content area of the application to show that view"]
...
----
<1> Adding the `<vaadin-drawer-toggle>` element shows a toggle for hiding and showing the navigation drawer.
