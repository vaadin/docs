...
Hilla has a component model that's similar to React, using the https://lit.dev/[Lit] library. However, you can also use https://hilla.dev/docs/react[React instead of Lit] together with Hilla.
