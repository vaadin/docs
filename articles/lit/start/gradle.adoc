...
The other documentation articles here assume that you're using Maven, and that Hilla CLI generates Maven-based projects. However, this tutorial describes instead how to compile, build, and run a Hilla application using the Hilla Gradle plugin.
