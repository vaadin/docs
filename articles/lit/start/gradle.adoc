...
It's a simpler-to-use and more powerful alternative to Maven.
...
`hillaGenerate`::
  ...
  `hillaGenerate` can be executed independent of the startup process as a standard Gradle task:
