...
This tutorial will take from ten to twenty minutes, depending on whether you decide to do each part step-by-step. As for software, you need the following:
