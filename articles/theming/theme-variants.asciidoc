...
NOTE: <<applicatioin-theme#global-styles, global styles>> in an application theme can override the global variants.
...
NOTE: <<applicatioin-theme#components-styles, Component styles>> in an application theme can override the component variants.
