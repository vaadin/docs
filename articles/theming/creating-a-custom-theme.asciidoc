...
.Sample [filename]#theme.json# for importCss
[source, JSON]
----
{
  "importCss": [
...
.Sample [filename]#theme.json# for declaring assets
[source, JSON]
----
{
  "assets": {
...
.Sample [filename]#theme.json# importing font awesome SVG assets
[source, JSON]
----
{
  "assets": {
...
.Sample [filename]#theme.json# for importing multiple assets
[source, JSON]
----
{
  "assets": {
...
.Sample [filename]#theme.json# for parent theme declaration
[source, JSON]
----
{
  "parent": "acme-base"
...
.Sample [filename]#theme.json# for documentCss
[source, JSON]
----
{
