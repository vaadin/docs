...
The <<application-theme#extending-an-existing-application-theme, Parent Theme>> is an existing theme, which styles and variables are inherited in the Current theme.

The Current Theme is a theme used in your application.
