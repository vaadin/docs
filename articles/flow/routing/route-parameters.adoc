...
page-title: How to use route parameters in Vaadin Flow
description: How to pass extra information to a route using route parameters.
meta-description: Learn how to use route parameters in Vaadin to create dynamic and user-friendly URLs.
order: 20
---
