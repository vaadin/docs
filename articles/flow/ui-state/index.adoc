...
For custom logic, you can create effects directly. In this example, the effect is a lambda callback passed into [methodname]`ComponentEffect.effect` that prints a message to the console whenever `firstName` or `lastName` changes:
