...
The Vaadin documentation is maintained in https://github.com/vaadin/docs[GitHub], written using https://docs.adoctor.org/asciidoc/latest/[AsciiDoc], and built using <<{articles}/flow/tools/dspublisher#,Design System Publisher>>.
...
For a nicer writing experience, install https://docs.adoctor.org/asciidoctor/latest/install/[AsciiDoctor] and <<vale#,Vale>> together with the https://github.com/ChrisChinchilla/vale-vscode[Vale extension]. Vale helps you to conform to the documentation writing guidelines, making the PR review process faster.
...
{
    // ...
    "asciidoc.preview.adoctorAttributes": {
        "doctype": "book"
    },
    // ...
}
