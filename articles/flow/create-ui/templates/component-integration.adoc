...
page-title: How to integrate components in Vaadin templates
description: How to detect whether a component is part of a template.
meta-description: Learn how to seamlessly integrate components in Vaadin templates for enhanced functionality.
order: 8
---
