...
page-title: How to use model encoders in Vaadin Polymer templates
description: Polymer support is deprecated; use Lit templates instead.
meta-description: Learn how to use model encoders in Polymer templates for better data handling in Vaadin applications.
order: 17
