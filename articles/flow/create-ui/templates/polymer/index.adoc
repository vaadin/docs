...
page-title: How to use polymer templates in Vaadin
description: Polymer support is deprecated; use Lit templates instead.
meta-description: Explore how to use Polymer templates for building custom reusable components in Vaadin applications.
