...
page-title: How to create basic Polymer templates in Vaadin
description: Polymer support is deprecated; use Lit templates instead.
meta-description: Learn the basics of creating Polymer templates for custom UI components in Vaadin applications.
order: 10
