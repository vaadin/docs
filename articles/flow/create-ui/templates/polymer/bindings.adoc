...
page-title: Using bindings in Polymer templates | Vaadin
description: How to bind text content, property values, and attribute values.
meta-description: Learn how to implement and manage data bindings in Polymer templates within Vaadin applications.
order: 15
