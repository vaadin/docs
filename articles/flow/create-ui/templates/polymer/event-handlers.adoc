...
page-title: How to handle events in Vaadin Polymer templates
description: How to use component API and DOM events via the Element API.
meta-description: Learn how to use event handlers effectively in Polymer templates within Vaadin.
order: 14
