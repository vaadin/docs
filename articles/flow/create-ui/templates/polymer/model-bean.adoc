...
page-title: How to integrate model beans in Vaadin templates
description: Polymer support is deprecated; use Lit templates instead.
meta-description: Learn how to use model beans in Vaadin Polymer templates for effective data binding.
order: 16
