...
page-title: How to use list bindings in Vaadin polymer templates
description: Polymer support is deprecated; use Lit templates instead.
meta-description: Bind dynamic data to your polymer templates in your Vaadin applications.
order: 18
