---
title: Combining Templates pass:[&] Binders
...
= [deprecated:com.vaadin:vaadin@V18]#Combining Templates & Binders#
...
First, create the [classname]`MainView` Polymer template component. This component displays a grid of users and the new `UserForm` component. For the grid, use the Vaadin <<{articles}/flow/components/grid#,`Grid` component>>.
