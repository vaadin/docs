...
page-title: How to use Polymer templates and binders in Vaadin
description: Polymer support is deprecated; use Lit templates instead.
meta-description: Combine Polymer templates with binders in Vaadin to create responsive and dynamic UIs.
order: 11
