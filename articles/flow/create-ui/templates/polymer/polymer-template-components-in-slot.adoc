...
page-title: How to use Polymer template components in Vaadin slots
description: Polymer support is deprecated; use Lit templates instead.
meta-description: Learn how to integrate Polymer template components into Vaadin slots for dynamic UI creation and management.
order: 12
