...
page-title: How to create components with multiple elements in Vaadin
description: Creating a component using multiple HTML elements.
meta-description: Learn how to create components with multiple elements in Vaadin for flexible UIs.
order: 3
---
