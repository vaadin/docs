...
[NOTE]
Some browsers, like IE11 and Safari 9, do not support ES modules. To ensure that your component works in these browsers, you can configure this in the `vaadin-maven-plugin` in your `pom.xml`. See  <<{articles}/flow/production/#,Taking your Application into Production>> for more.


[discussion-id]`8952DD53-11BC-47D8-855E-41B502009DD0`
