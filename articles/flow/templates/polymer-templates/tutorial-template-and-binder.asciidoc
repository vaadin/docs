...
See <<{articles}/flow/binding-data/tutorial-flow-components-binder#,Binding Data to Forms>> for more.
...
--
See <<{articles}/flow/binding-data/tutorial-flow-components-binder-load#,Loading From and Saving To Business Objects>> for more.
...
First, we create the `MainView` Polymer template component. This component displays a grid of users and our new `UserForm` component. For the grid, we use the Vaadin <<{articles}/flow/components/tutorial-flow-grid#,`Grid` component>>
...
[discussion-id]`7CCA754E-A323-423C-A898-AD670BE77F6C`
