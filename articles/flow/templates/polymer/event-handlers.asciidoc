...
See <<../../element-api/client-server-rpc#clientcallable-annotation,@ClientCallable Annotation>> for more.

pass:[<!-- vale Vale.Spelling = YES -->]

* You can also define [classname]#PropertyChangeListeners# when working with templates.
See  <<../../components/enabled-state#enabling-property-changes,Enabling Property Changes>> for more.
