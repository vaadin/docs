...
First, we create the `MainView` Polymer template component. This component displays a grid of users and our new `UserForm` component. For the grid, we use the Vaadin <<{articles}/ds/components/grid#,`Grid` component>>
