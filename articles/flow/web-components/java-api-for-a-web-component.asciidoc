...
<<../creating-components/tutorial-basic#,Creating A Simple Component Using the Element API>> on how you can use the `@Synchronize` annotation to synchronize property values without automatically firing a value-change event.
