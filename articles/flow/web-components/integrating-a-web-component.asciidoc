...
(see <<{articles}/guide/configuration#,Configuration Properties>> or <<{articles}/guide/production#plugin-goals-and-goal-parameters,Production Mode Plugin Goals and Parameters>>).
