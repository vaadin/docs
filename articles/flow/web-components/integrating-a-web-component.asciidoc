...
You can see that paper-slider 2.0.4 is already available by opening https://central.maven.org/maven2/org/webjars/bowergithub/polymerelements/paper-slider/2.0.4/
