...
Provider settings such as the streaming mode and <<background-execution#,background execution>> live on the provider and are not serialized; apply them to the new provider instance before passing it to [methodname]`reconnect()`.
