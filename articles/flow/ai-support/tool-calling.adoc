...
A third source of tools sits outside the orchestrator: an <<mcp-servers#,MCP server>>, whose tools the AI framework's own MCP client contributes to each request. The LLM invokes them the same way.
