...
Highlights stay visible until the application removes them. Call [methodname]`hideHighlight()` to clear a field's highlight -- for example from a [interfacename]`ValueChangeListener` when the user starts editing the field.
