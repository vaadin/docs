...
In a Spring-Boot project, it is suffient to register this listener by adding the `@Component` annotation on the class.
In plain Java projects, the listener should be registered as a provider via Java SPI loading facility. To do this you should create
