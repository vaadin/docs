...
Using Classic Components in combination with <<{articles}/flow/tools/mpr/overview#,Multiplatform Runtime (MPR)>> isn't recommended for this version since it can lead to styling conflicts between the two.
