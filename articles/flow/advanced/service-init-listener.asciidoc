...
<<../typescript/starting-the-app#,IndexHtmlRequestListener>> and <<dependency-filter#,DependencyFilters>>.
You can also use it to <<../routing/dynamic#application.startup,dynamically register routes during the
application startup>>.
