...
[example]
====
This example demonstrates a reactive counter:
...
public class SharedText extends FormLayout {
    ...
    public SharedText() {
        ...
        // Two-way binding: field changes update signal, signal changes update field
...
public class PersonList extends VerticalLayout {
    ...
    public PersonList() {
        ...
        ComponentEffect.bindChildren(list, persons, personSignal -> {
            ListItem li = new ListItem();
            li.bindText(personSignal);
            return li;
        });
