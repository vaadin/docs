...
[since:com.vaadin:vaadin@V25]
[NOTE]
The [classname]`ScrollOptions` parameter variant of [methodname]`scrollIntoView()` is deprecated. Use the [classname]`ScrollIntoViewOption` varargs variant instead.
