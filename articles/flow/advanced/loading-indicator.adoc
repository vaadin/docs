...
page-title: How to customize the loading indicator in Vaadin
description: Using a loading indicator to notify the user of progress in loading the page.
meta-description: Learn how to modify and enhance the Vaadin Loading Indicator for better user experience in your application.
order: 50
---
