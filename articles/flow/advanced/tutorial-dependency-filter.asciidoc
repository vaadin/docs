...
The DependencyFilters are called in two particular situations: when a <<{articles}/flow/templates/polymer-templates/tutorial-template-basic#,PolymerTemplate>> is parsed for the first time, and when a set of dependencies are about to be sent to the client.
...
[discussion-id]`62B8D3A8-9624-4234-A4EC-F2C1DCB6F906`
