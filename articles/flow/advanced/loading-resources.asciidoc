...
If you use relative URLs, it is irrelevant whether your application is deployed in the root context (for example  `\https://mysite.com/`) or in a sub context (for example `\https://mysite.com/myapp/`).
