...
when the request is coming from older browsers, not supporting https://www.w3schools.com/js/js_es6.asp[es6], default web components' development language version.
