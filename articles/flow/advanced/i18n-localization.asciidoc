...
. If your element extends Vaadin's `ElementMixin`, no changes are needed.
Otherwise, you can make the element extends it or `DirMixin` only (`DirMixin`
is part of the `@vaadin/component-base` package).
