...
The <<.#, main migration guide>> describes all the main
...
* If missing, install Node.js on your system (<<.#install.npm,
...
<<.#add-vaadin-maven-plugin, here>> for the demo & integration test
...
<<.#p2.p3.migration, main migration guide>>, but you don't
