...
However, almost all of the styling related Java API has been replaced with an ability to https://vaadin.com/docs/v14/ds/components/charts/css-styling[style charts using CSS].
