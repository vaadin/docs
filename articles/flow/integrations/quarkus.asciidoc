...
If you use a project not based on the starter, it needs the configuration described in <<{articles}/flow/production/overview#enabling-the-production-mode, Enabling the Production Mode>>.
