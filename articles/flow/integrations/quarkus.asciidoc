...
https://github.com/vaadin/base-starter-flow-quarkus/[Quarkus base starter] has all the needed dependencies to start developing your application.
...
After making <<quarkus.dependencies>> steps, the Quarkus application can be started in development mode using the `quarkus:dev` goal in Maven.
...
If you want to run your application locally in production mode, add the following `production` profile to your project:
