...
[NOTE]
Compatibility Mode is no longer supported from Vaadin 14.12 onwards. Due to this, neither is OSGi supported from Vaadin 14.12 onwards.
...
them automatically available as `ServletContext` resources.

The resulting frontend resources should also be available as web resources.
See <<osgi.resources>> section how static resources may be registered via `OsgiVaadinStaticResource`/`OsgiVaadinContributor`.
...
[discussion-id]`BC69C7CE-DA4F-41DF-8806-4F1C593A56F3`
