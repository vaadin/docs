...
Routing works the same way with Spring as it does in plain Vaadin applications. See <<../../routing/annotation#,Routing and Navigation>> for more.
...
<<../../routing/annotation#,Defining Routes with @Route>> for more about using the `Router` class.
