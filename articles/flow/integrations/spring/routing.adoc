---
title: Routing
page-title: How to handle routing in Vaadin Spring applications
description: How to route with Spring - much like with Vaadin applications.
meta-description: Learn how to configure routing in Spring applications integrated with Vaadin.
order: 40
---
