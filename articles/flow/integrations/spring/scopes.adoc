...
[NOTE]
The `BeanStore` is stored in the session. This means in case you persist sessions, e.g. when using Control Center or Kubernetes Kit, the beans needs to be serializable.
