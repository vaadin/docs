...
To use your Spring web application, you need to declare dependencies on `vaadin-bom`, `spring-web`, and `spring-webmvc` in your [filename]`pom.xml` file, as follows:
