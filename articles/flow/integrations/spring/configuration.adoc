...
[IMPORTANT]
The previous `vaadin.whitelisted-packages` and `vaaind.blacklisted-packages` properties has been deprecated since Vaadin 24.4, and will be removed in the future.
