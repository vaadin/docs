...
If you are not using Spring Boot in your Vaadin Flow application, you may need extra configurations to enable the authorization mechanism.
// TODO ??? the last sentence needs further discussions
