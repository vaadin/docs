...
[NOTE]
See <<spring-boot#,Using Vaadin with Spring Boot>> to use Vaadin with https://spring.io/projects/spring-boot[Spring Boot].
...
To use <<scopes#,Vaadin Spring scopes>> you need to register the `VaadinScopesConfig` configuration class. As an alternative, you can add the `@EnableVaadin` annotation to your configuration class to import `VaadinScopesConfig`.
