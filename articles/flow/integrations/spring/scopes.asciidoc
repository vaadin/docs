...
But, when the bean implementation can be resolved unambiguously by Spring (like it could be in the example above), the `@RouteScopeOwner` annotation can be omitted in the injection point.
