...
.Overview of Vaadin Spring scopes annotations for bean classes
image::images/spring-scopes.png[Overview of Vaadin Spring scopes annotations for bean classes (including navigation targets) and their binding to app, session, page and url]
