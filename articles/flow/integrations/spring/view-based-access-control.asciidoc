...
_As this documentation is based Spring Boot, we recommend adding the following dependency_:
...
@EnableWebSecurity // <1>
@Configuration
public class SecurityConfiguration extends VaadinWebSecurityConfigurerAdapter { // <2>
