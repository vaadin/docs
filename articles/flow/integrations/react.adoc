...
https://reactjs.org/[React] is a popular JS-based frontend UI library with a wide adoption and a lot of components available. This documentation page explains how to integrate existing React components with Flow by using an intermediate adapter Web Component, and then using it in Java applications.
