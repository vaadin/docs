...
page-title: How to configure embedding properties in Vaadin
description: How to set properties of embedded applications.
meta-description: Configure and use embedding properties for seamless integration in Vaadin applications.
order: 20
---
