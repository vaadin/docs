...
page-title: How to preserve state on refresh with Vaadin embedding
description: How to preserve content when an embedded application is refreshed.
meta-description: Learn how to maintain application state when refreshing embedded Vaadin applications.
order: 70
---
