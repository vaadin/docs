---
title: Security
page-title: How to secure embedded Vaadin components
description: How to use an embedded application's properties to secure it.
meta-description: Explore security measures for embedding Vaadin components in other frameworks or applications.
order: 50
---
