...
Start by adding the Hilla Spring Boot starter to the project, as described in <<{articles}/hilla/guides/endpoints#enabling, Enabling Endpoints in a Vaadin Project>>. No other build configuration is needed.
