...
Use <<{articles}/flow/components/side-nav#,SideNav>> or <<{articles}/flow/routing/retrieving-routes#standard-navigation-targets,Anchor>> components to navigate from a Flow view to a Hilla view:
