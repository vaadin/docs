...
Start by adding the Hilla Spring Boot starter to the project, as described in <<{articles}/hilla/guides/browser-callable-services#enabling, Enabling Browser-Callable Services in a Vaadin Project>>. No other build configuration is needed.
...
[[flow-to-hilla]]
== Add Flow Views to Hilla Applications

If your application already has Hilla views, you can add Vaadin Flow views to it. For example, starting from the Hilla https://github.com/vaadin/skeleton-starter-hilla-react[project starter]), you can add Flow views to the project using the steps in the sub-sections that follow.
