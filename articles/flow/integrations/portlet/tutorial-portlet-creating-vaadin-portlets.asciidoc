...
<<tutorial-portlet-handling-portlet-phases.asciidoc#,the next chapter>>
...
* Pass the value `/vaadin-static-resources/` (for *Liferay Portal*, it shall be `/o/vaadin-portlet-resources/`) via the application property to the Vaadin application, i.e. on TomCat web server you would:
