...
. <<creating-vaadin-portlets.asciidoc#,Creating Vaadin Portlets>>
+
Instructs the reader on how to build their own Vaadin Portlets and how to run it.

. <<handling-portlet-phases.asciidoc#,Handling Portlet Phases>>
+
Introduces the API the reader can use to interact with the Portlet phases and Portlet requests.

. <<inter-portlet-communication.asciidoc#,Inter-portlet Communication>>
+
...
. <<creating-multi-module-portlet-project.asciidoc#,Creating Multi-Module Portlet Project>>
+
...
. <<adding-portlet-module.asciidoc#,Adding a Vaadin Portlet Module to an Existing Multi-Module Project>>
+
Shows how to add a new Vaadin Portlet Module to an existing Vaadin or non-Vaadin multi-module project.

. <<cdi-support.asciidoc#,Appendix A - Vaadin Portlet CDI Support>>
+
...
. <<demo-address-book.asciidoc#,Appendix B - Demonstration: Address Book Example Project>>
+
