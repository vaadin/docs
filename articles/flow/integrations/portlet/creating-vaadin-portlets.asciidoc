...
* Pass the value `/vaadin-static-resources/` (for *Liferay Portal*, it shall be `/o/vaadin-portlet-resources/`) via the application property to the Vaadin application, that is, on TomCat web server you would:
