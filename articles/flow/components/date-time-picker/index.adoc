...
include::{articles}/flow/components/_input-field-common-features.adoc[tags=basic-intro;label;helper;placeholder;tooltip;]
...
[source,html]
----
include::{articles}/flow/components/_shared-code-snippets.adoc[tags=aria-label-dtp-typescript,indent=0,group=TypeScript]
----
endif::[]
...
[source,java]
----
include::{articles}/flow/components/_shared-code-snippets.adoc[tags=aria-label-dtp-java,indent=0,group=Java]
----
endif::[]
--
====
