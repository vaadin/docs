...
To learn how to customize the styles inside a component's shadow DOM, see <<../styling/styling-components#,Styling Components>>.


[discussion-id]`E1F88141-96C9-49F0-B095-CFCD62158B42`
