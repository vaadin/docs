...
If you are unfamiliar with Figma libraries, you can start by reading https://help.figma.com/hc/en-us/articles/flow/360041051154-Guide-to-libraries-in-Figma[Figma's official guide to libraries].
