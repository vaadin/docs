...
image::{articles}/flow/components/_images/cat-dataentry.svg[opts=inline, role=banner]
...
image::{articles}/flow/components/_images/cat-vizandix.svg[opts=inline, role=banner]
...
image::{articles}/flow/components/_images/cat-layouts.svg[opts=inline, role=banner]
...
image::{articles}/flow/components/_images/theme-editor-icon.png[role=banner,width=224]

The styling of Vaadin components can be customized using style tokens, utility classes and custom CSS.

[.sr-only]
<<{articles}/flow/styling#, Read about how to style Vaadin components>>
endif::[]

[.res-figma]
=== Figma Libraries

image::{articles}/flow/components/_images/figma-logo.svg[opts=inline, role=banner]
...
image::{articles}/flow/components/_images/accessibility-symbol.svg[opts=inline, role=banner]
