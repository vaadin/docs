...
The platform also includes themes for the components that you can customize to ensure the styling suits your needs. See <<../../themes/theming-overview#,Theming>> for more information.
