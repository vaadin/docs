...
(see <<{articles}/flow/configuration/properties#,Configuration Properties>> or <<{articles}/flow/production#plugin-goals-and-goal-parameters,Production Mode Plugin Goals and Parameters>>).
