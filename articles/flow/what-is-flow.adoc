...
See <<{articles}/flow/component-internals/events#,Component Events>> for more information.
...
For more information about client-server communication, see <</flow/component-internals/element-api#,Element API>>.
