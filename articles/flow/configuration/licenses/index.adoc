...
[IMPORTANT]
====
The `download-offline-license` goal is only available in the Vaadin 25 Maven plugin and always generates a `mid2` machine ID. This key does not work with Vaadin 24.9 or earlier.
