...
page-title: How to use live reload with CDI in Vaadin
description: How to enable hotswap when developing Vaadin applications using CDI.
meta-description: Learn to enable and utilize live reload functionality when developing Vaadin applications using CDI.
tab-title: TomEE
order: 50
---
