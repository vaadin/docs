...
A change-set that mixes Java with a stylesheet prints **both** lines, `hmr:` then `hot-reload:`, in the order the legs ran. Only the `hmr:` line answers for the stylesheet.
