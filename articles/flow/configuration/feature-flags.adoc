...
Enables the experimental typing indicator API of <<{articles}/components/message-list#, Message List>>.

`ssePushTransport`::
Enables server-sent events as a <<{articles}/flow/advanced/server-push#, server push>> transport.
