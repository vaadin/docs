...
`badgeComponent`::
Enables the <<{articles}/components/badge#, Badge>> component.
...
`modularUpload`::
Enables <<{articles}/components/upload/modular-upload#, modular upload components>> (UploadManager, UploadButton, UploadFileList, and UploadDropZone).

`messageListAttachments`::
Enables <<{articles}/components/message-list#attachments, attachments>> in MessageList items.
