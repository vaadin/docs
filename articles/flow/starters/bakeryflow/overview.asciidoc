...
A personalized project can be link:https://vaadin.com/start/v14/full-stack-spring[downloaded from the product page^] by picking `Full Stack App with Spring` and providing Group Id and App Name, it's needed to be logged in to be able to download.
...
[discussion-id]`3EDB7F78-88FC-4AB8-AD5B-CF416D2C25F7`
