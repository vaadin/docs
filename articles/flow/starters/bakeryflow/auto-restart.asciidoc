...
To setup HotswapAgent follow the link:https://hotswapagent.org/mydoc_quickstart.html[tutorial].
...
* Create Run/Debug configuration which will run the HotswapAgent for link:https://hotswapagent.org/mydoc_setup_intellij_idea.html#other-way-its-explicit-agent-configuration-without-plugin[IntellijIDEA] or link:https://hotswapagent.org/mydoc_setup_eclipse.html[Eclipse].
