...
description: Learn how to open and debug a Vaadin project in IntelliJ. Setup IntelliJ for better autocomplete support.
---
...
https://start.vaadin.com/?preset=flow-crm-tutorial&dl[Download starter^,role="button primary"]
...
[NOTE]
====
After starting the application for the first time, IntelliJ will index all the added dependencies. This can take anywhere from a few seconds to several minutes depending on your computer. This only happens once.
====
