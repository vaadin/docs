...
You can learn more about the underlying technologies and features in the <<{articles}/flow/guide/configuration/pwa#,PWA configuration>> documentation.
...
You can use your own icon, or save the image below. Click the image to open view the original and then right-click it and select *Save Image*.

[link=images/pwa/icon.png]
...
Add the following image (or use one of your own) to the `META-INF/resources/images` folder and name it `offline.png`. Click the image to open view the original and then right-click it and select *Save Image*.

[link=images/pwa/offline.png]
