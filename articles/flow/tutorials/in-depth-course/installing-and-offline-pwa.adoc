...
You can use your own icon, or save the image below. Click the image to view the original and then right-click it and select *Save Image*.
...
Add the following image (or use one of your own) to the `META-INF/resources/images` folder and name it `offline.png`. Click the image to view the original and then right-click it and select *Save Image*.
