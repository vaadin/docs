...
order: 60
page-title: "Using Vaadin Grid: populating, defining columns, and widths"
description: Learn to populate a Vaadin Grid with data from the database and configure the shown columns.
---
