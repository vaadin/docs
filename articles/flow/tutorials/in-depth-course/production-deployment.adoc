...
order: 160
page-title: Deploying a Vaadin Application on AWS Elastic Beanstalk
description: Learn how to prepare a Vaadin app for deployment and how to deploy it on AWS
---
