---
title: Testing
page-title: How to Test Vaadin Applications Using TestBench
description: TestBench allows you to create UI unit and end-to-end tests for your Vaadin applications.
meta-description: Learn more about how TestBench allows you to create UI unit and end-to-end tests for your Vaadin applications.
order: 170
---
