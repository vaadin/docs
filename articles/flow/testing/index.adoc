...
These tests are impossible with the browserless testing approach because browserless tests run on the server side without initializing the browser.
...
TestBench is the only tool that also provides helpers for browserless testing of Vaadin UIs.
