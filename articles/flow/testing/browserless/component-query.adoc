...
Custom testers provide a testing API tailored to a specific component type or its subclasses. Testers are annotated using the [annotationname]`@Tests` annotation, which specifies which components the tester is for.
