...
- [methodname]`window.$(Class)` and [methodname]`window.$view(Class)` -- locate components in this window. Returns a [classname]`ComponentQuery`; see <<component-query#, Querying Components>>.
