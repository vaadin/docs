...
| Enables the given feature flags. [methodname]`withFeatureFlag(String, boolean)` enables or disables a single flag. Both methods also have a [classname]`Feature` overload.
