...
[TIP]
====
The [methodname]`selectItem()` method on [classname]`SelectTester` and [classname]`ComboBoxTester` takes the *display label as a String*, not the typed item value. When using enums or other objects, pass the label that the user would see in the drop-down:
