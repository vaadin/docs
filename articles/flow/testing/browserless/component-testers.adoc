...
[[building-custom-testers]][[defining-a-custom-tester]][[registering-custom-testers]][[testing-a-component-without-a-view]]For a worked example, see <<{articles}/building-apps/testing/browserless/test-custom-components#,Test a Custom Component>>.
