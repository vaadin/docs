...
page-title: How to perform browserless testing in Vaadin with Spring
description: Describes and provides examples of how to perform browserless tests.
meta-description: Perform browserless testing in Vaadin applications integrated with Spring.
order: 40
---


= Browserless Testing in Spring-based Projects

In Spring-based projects, views may use dependency injection to get references to service and other software components. To instantiate such views and handle navigation correctly, Vaadin needs special implementations of internal components, such as [classname]`SpringInstantiator`. Browserless testing provides a specialized base test class that integrates with the Spring Testing Framework: [classname]`SpringBrowserlessTest`.
...
In addition to <<getting-started#,the browserless testing dependency>>, make sure you add the Spring Boot test starter dependency to your project. Add the following to your [filename]`pom.xml` file:
