...
[since:com.vaadin:vaadin@V25.3]#A location string may also carry a query string and a fragment, which are parsed into the [classname]`QueryParameters` of the resulting location, so that a view reading them sees what it sees in the browser:#
