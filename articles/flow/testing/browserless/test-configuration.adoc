...
A custom environment initialization, such as the <<cdi#,CDI initialization>> in this documentation, applies these settings only if it passes `testConfiguration()` to `MockVaadin.setup()`.
...
class ResponsiveFormLayoutTest extends AbstractViewTest {
