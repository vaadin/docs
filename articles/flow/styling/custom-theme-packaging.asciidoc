...
[IMPORTANT]
Do not include the automatically generated `<theme-name>.generated.js` file inside the packaged theme artifact.
Including it can create errors for the project that tries to reuse the theme.
The file is automatically created in the application project that uses the theme.
