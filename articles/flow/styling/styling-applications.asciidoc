...
The instructions in <<{articles}/flow/templates/polymer-templates/styling-polymer-templates#,Styling Polymer Templates>> apply to client-side views.
...
In addition, Vaadin offers a large https://vaadin.com/docs/v14/ds/foundation/icons/vaadin[collection of icons] for you to use (with both SVG and font formats).
...
[discussion-id]`72C8E65B-493A-4607-8793-3811BCB2EDCE`
