...
For other components, use the <<../element-api/tutorial-properties-attributes#,Element API>> and the [methodname]`setAttribute` method.
...
[discussion-id]`89685B3D-DB88-461E-B3F1-D3C3B266C9C3`
