---
title: Creating a Custom Theme Class
order: 80
layout: page
---
...
Creating custom theme classes is not recommended after 14.6 after which the recommendation is to use the new <<custom-theme#, Custom Theme>> feature.
...
[discussion-id]`7A3CBD80-7324-4519-92B4-A47BC94DBABA`
