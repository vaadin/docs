...
The annotation must be set for the <<../routing/tutorial-routing-annotation#,root navigation>> class or the <<../routing/tutorial-router-layout#,router layout>> defined in the [classname]`@Route` annotation.
...
See <<styling-components#,Styling Components>>, <<./lumo/overview#,Lumo>>, and <<./material/overview#,Material>> for more information.
...
See <<creating-a-custom-theme-class#, Creating a Custom Theme Class>> for more information.
...
[discussion-id]`850D43C2-AFC0-4888-B063-AAF21AE3B047`
