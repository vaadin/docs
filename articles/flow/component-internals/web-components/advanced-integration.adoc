...
[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/internals/AcmeWidget.java[tags=annotations,indent=0]
@NpmPackage(value = "@acme/widget", version = "2.0.0")
include::{root}/src/main/java/com/vaadin/demo/component/internals/AcmeWidget.java[tags=body,indent=0]
----
