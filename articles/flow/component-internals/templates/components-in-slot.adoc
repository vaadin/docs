...
page-title: How to work with components in slots in Vaadin templates
description: How to add server-side components to templates.
meta-description: Learn how to configure and manage components in slots within Vaadin templates.
order: 6
---
