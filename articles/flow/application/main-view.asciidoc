...
The starter applications created with the https://vaadin.com/start[Vaadin project builder] by default use the [classname]#AppLayout# to create the main view.
