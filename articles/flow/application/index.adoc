...
page-title: Basics of creating an application using Vaadin Flow
description: Basics of creating an application using Flow.
meta-description: Vaadin Flow lets a server-side Java application build an UI from components in Java. Learn the basics of how to create an application with Vaadin Flow.
order: 20
---
