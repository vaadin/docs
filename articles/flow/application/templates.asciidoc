...
[NOTE]
You can detect whether a component is used in a `PolymerTemplate` using the `isTemplateMapped` method. See the <<../templates/component-integration#,Detecting PolymerTemplate Mappings in Components>> for more.
