...
page-title: How to create a main view in Vaadin Flow
description: How to create main views with a header, a menu, and a content area.
meta-description: Learn to set up a main view as the central component of your Vaadin Flow application.
order: 18
---
