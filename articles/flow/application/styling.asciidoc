...
Bundled style sheets are included to the application bundle during a <<{articles}/flow/production#,production build>>, together with other client-side resources.
