...
A web application typically consists of one or more views. Each view is a hierarchical composition of components. At the bottom of the hierarchy, you have a root layout component, which contains other components. Vaadin comes with a <<{articles}/flow/components#, large library of UI components>> that you can use.
...
See <<{articles}/flow/create-ui/templates#, Templates>> to learn more.
