...
By default, starter applications created with https://start.vaadin.com[Vaadin Start] use [classname]#AppLayout# to handle the main view.
...
See <<../templates/overview#, Using Templates>> to learn more.
