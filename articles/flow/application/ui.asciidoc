...
For such cases, you can use the App Layout component, as described in <<main-view#, Creating a Main View>>.
...
The starter applications created with the https://start.vaadin.com[Vaadin Start] by default use the [classname]#AppLayout# to handle the main view.
