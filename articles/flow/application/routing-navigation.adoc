...
page-title: Routing and navigation in Vaadin Flow applications
description: Understanding the basics of the routes of views, URLs and navigation.
meta-description: Explore routing and navigation techniques for building smooth Vaadin applications.
order: 20
---
