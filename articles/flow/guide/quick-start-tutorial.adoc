...
Follow the <<{articles}/flow/guide/install#,development environment installation instructions>> if you do not have Java installed yet.
...
You can find instructions for popular IDEs in the <<{articles}/flow/guide/start#,Starting a Project>> section.
...
- <<../tutorial#, In-depth course: learn Vaadin Flow development in 4 hours>>
