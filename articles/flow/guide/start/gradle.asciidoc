...
`productionMode = false`::
  ...
  For production, the front-end is transpiled for older browsers and optimized, as described in https://vaadin.com/docs/v14/flow/production/overview[Taking your Application into Production].
...
They are available at least through `mavenCentral`.
...
[discussion-id]`330094D2-0538-49A7-BA29-DC83CB5CB6DB`
