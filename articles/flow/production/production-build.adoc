...
The frontend files in a production bundle are minified, which makes client-side stack traces difficult to read. See <<source-maps#, Source Maps in Production>> for how to generate source maps for them.
