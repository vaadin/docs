...
Transpilation in Vaadin means converting all TypeScript files to JavaScript. The JavaScript and CSS are compiled for the browsers that Vaadin supports -- see <<{articles}/compatibility#browser-compatibility, Browser Compatibility>>.
