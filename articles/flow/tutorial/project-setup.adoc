...
ifdef::print[]
https://github.com/vaadin/flow-crm-tutorial/archive/v14-initial.zip
endif::[]

ifndef::print[]
https://github.com/vaadin/flow-crm-tutorial/archive/v14-initial.zip[Download starter,role="button primary water"]
endif::[]
...
[discussion-id]`A1575C78-4679-4A39-82F1-15B82921E79D`
