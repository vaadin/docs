...
Vaadin includes over forty <<{articles}/flow/components#,UI components>> to help you build applications faster. By using ready-made building blocks, you're able to focus primarily on building end-user functionality.
