...
You can find the full source code for this guide on https://github.com/vaadin/flow-crm-tutorial/tree/v14/[GitHub].

== How to Get Help

The best place to get help if you have questions is the https://vaadin.com/forum[Vaadin Forum].
...
[discussion-id]`D6995670-CD19-4E6E-AB95-72267D5E3CD8`
