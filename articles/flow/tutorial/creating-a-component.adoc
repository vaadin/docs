...
<5> Makes the buttons visually distinct from each other using built-in https://vaadin.com/docs/v14/ds/components/button[styles or other variants].
...
[discussion-id]`B98DC3B6-7AE0-40A1-976F-64DA02B2F1C4`
