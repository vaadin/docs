...
page-title: How to Create Reusable Components in Vaadin
description: Shows how to compose reusable components with a basic layout and components.
meta-description: Learn how to create reusable components in Vaadin Flow. Follow this step-by-step tutorial to enhance your application with reusable and unique components.
order: 50
section-nav: hidden
---
