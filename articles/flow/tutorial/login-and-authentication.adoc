...
<2> Extend from [classname]`VaadinWebSecurityConfigurerAdapter` to configure Spring Security for Vaadin.
...
Verify that you cannot access http://localhost/dashboard without being logged in.
You can log in with:
