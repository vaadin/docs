...
order: 90
page-title: How to master navigation and layouts in Vaadin
description: Setting up a parent layout and navigate among child views.
meta-description: Master navigation and layouts in Vaadin applications with this step-by-step guide.
section-nav: hidden
---
