...
Vaadin starter projects use https://spring.io/projects/spring-boot[Spring Boot^] on the server, although you can use Vaadin also without it.
...
<4> Service classes often include validation and other business rules before making the data persistent.
...
[discussion-id]`F3BD5809-B540-42FA-B202-2E89EB3DF9C7`
