...
order: 70
page-title: How to validate forms in Vaadin applications
description: How to use Binder to bind a data object to input fields and validate input.
meta-description: Learn how to use Binder to bind a data object to input fields and validate input. See form validation techniques and best practices for Vaadin applications.
section-nav: hidden
---
