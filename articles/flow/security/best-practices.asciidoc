...
A Security Realm is a mechanism for storing and mapping the users with their passwords and roles.
Configuring of the Security Realm depends on the Application Server you are using to run Vaadin application.
