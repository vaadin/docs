...
See https://vaadin.com/docs/v10/flow/advanced/tutorial-dynamic-content.html#using-custom-servlet-and-request-parameters[Flow documentation on Dynamic content]
for details.
