---
title: Vaadin Version Comparison
...
This comparison highlights the concrete technical and platform-level differences between Vaadin major versions over time to help you inderstand the impact effort and risk. 
