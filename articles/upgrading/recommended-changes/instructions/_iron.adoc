...
If you want to keep using a custom property to control the icon size and do not want to modify the value of `--lumo-icon-size-m`, you can, for example, define custom properties for the `<vaadin-icon>` element in your <<{articles}/styling/custom-theme#, theme>>.
