...
To enable this access-control mechanism, see the <<{articles}/flow/security/enabling-security#, instructions for a Spring project>> or the <<{articles}/flow/security/advanced-topics/securing-plain-java-app#, instructions for a plain-Java project>>.
