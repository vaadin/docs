...
If you are upgrading from an earlier version, follow the link:https://vaadin.com/docs/v14/flow/upgrading/[upgrading instructions here] to bring your application to version 14 first, before continuing with this guide.
