The internal structure of many Vaadin components has been modified to improve accessibility and enable the new, simplified styling approach in Vaadin 24.
