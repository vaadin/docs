...
If you are looking for a fast and effective way to become productive with Vaadin, start with the *How-to Guides*.
...
Reading the Deep Dives is not essential for getting started with Vaadin. If you are an experienced software developer, you may even disagree with some viewpoints -- and that is perfectly fine. However, if you want to master Vaadin and make the most of its capabilities, these articles are well worth exploring.
