...
In this mini-tutorial, you'll add logout functionality to a real Vaadin application.


.Set Up the Project
[%collapsible]
====
Use the project from the <<../add-login/react#try-it,Add Login>> guide. If you haven't completed that tutorial yet, do it now before proceeding.
====
