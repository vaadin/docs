...
In this mini-tutorial, you'll learn how to add declarative view security to a real Vaadin application. You'll also learn how to control access programmatically inside a view.


.Set Up the Project
[%collapsible]
====
Use the project from the <<../add-logout/flow#try-it,Add Logout>> guide. If you haven't completed that tutorial yet, do it now before proceeding.
====
...
@Menu(order = 0, icon = "vaadin:wrench", title = "Task Admin")
@RolesAllowed(Roles.ADMIN)
public class AdminView extends Main {
