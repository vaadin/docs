...
[NOTE]
====
Gemini CLI automatically invokes Vaadin tools when you ask questions about Vaadin development (e.g., "What is a Vaadin browserless test?").
====
...
If the directory does not exist, create it before adding the configuration file.
