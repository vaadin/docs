...
[TIP]
====
The `.vscode/mcp.json` file is project-specific. If you want to use the Vaadin MCP server across multiple projects, you need to add this configuration to each project.
====
...
. Contact your GitHub organization administrator if you do not see this option
