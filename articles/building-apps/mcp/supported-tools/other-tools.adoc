...
* https://modelcontextprotocol.io/specification/latest[MCP Specification]
* https://mcp.vaadin.com/docs[Vaadin MCP Server Endpoint]

== Contributing

If you've successfully configured a tool not listed in this documentation, consider contributing your configuration:

. Open an issue in the https://github.com/vaadin/docs/issues[Vaadin documentation repository]
