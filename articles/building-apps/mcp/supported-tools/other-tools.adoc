...
[IMPORTANT]
====
The stdio adapter requires Node.js 18 or later. Install it if you have not already:
...
If you have successfully configured a tool not listed in this documentation, consider contributing your configuration:
