...
Some background jobs may use `CompletableFuture` to inform the user interface of results and errors. This is covered in the <</building-apps/architecture/background-jobs/interaction/futures#,Returning Futures>> documentation page. 
