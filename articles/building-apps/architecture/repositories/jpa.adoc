...
If you have <</building-apps/architecture/domain-primitives#,domain primitives>> in your entities, you can handle them in different ways.
...
For more information about managing transactions in Vaadin applications, see the <</building-apps/architecture/consistency/transactions#,Transactions>> documentation page.


== Optimistic & Pessimistic Locking

Hibernate supports both <</building-apps/architecture/consistency/optimistic-locking#,optimistic locking>> and <</building-apps/architecture/consistency/pessimistic-locking#,pessimistic locking>>.
