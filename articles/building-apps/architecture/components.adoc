...
In the <<{articles}/building-apps/architecture/design#,Designing the Architecture>> page of the documentation, you learned about _system components_ and _UI components_. On this page, you are going to learn more about system components and how to turn them into Java code.
