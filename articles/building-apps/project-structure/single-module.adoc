...
The code structure of your Vaadin application should resemble its <<{articles}/building-apps/architecture/components#,architecture>>. This is illustrated here by a fictional, _data driven_, Vaadin Flow application. This application has a _Views_ component, a _Services_ component, and an _Entities_ component.
...
// Petter's note: I think this should be a list and not comma-separated. It is very hard to see the symmetry of the package names when they are comma-separated.
