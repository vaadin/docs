...
[%collapsible]
====
You'll want to use the dashboard view as the main view of the application. To do this, you have to delete the old main view. Find the class [classname]`MainView` inside the package [packagename]`[application package].base.ui.view` and delete it.
====
