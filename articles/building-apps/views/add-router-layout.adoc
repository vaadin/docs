...
* [methodname]`removeRouterLayoutContent(HasElement)` -- removes the given view from the router layout.
...
[NOTE]
The path specified in `@Layout` needs a leading slash (`/`), unlike the path in [annotationname]`@Route`.
