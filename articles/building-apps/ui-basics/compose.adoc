...
The most basic components correspond to plain HTML elements — `Div`, `Span`, `H1`, and `Paragraph`. On top of these, Vaadin provides a rich set of ready-made components for common needs like buttons, text fields, grids, and dialogs. See the <</components#,Components documentation>> for details.
