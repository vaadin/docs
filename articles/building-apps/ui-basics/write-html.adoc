...
Use the HTML element classes for structure and text — page layout, headings, paragraphs, lists, and links. Use Vaadin components (Button, TextField, Grid, Dialog, and others from the <</components#,component library>>) for interactive features like form inputs, data display, and user actions.
