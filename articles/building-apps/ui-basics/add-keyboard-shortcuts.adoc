...
Pass modifiers as additional arguments:
...
- Adding shortcuts that conflict with browser defaults (e.g., kbd:[Ctrl+T], kbd:[Ctrl+W], kbd:[F5])
- Assigning shortcuts to rarely used actions — they add complexity without benefit
- Using shortcuts as the _only_ way to trigger an action — always provide a clickable alternative for discoverability
