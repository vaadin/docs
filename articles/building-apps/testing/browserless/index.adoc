...
page-title: Write Your First Browserless Test | Vaadin
...
= Write Your First Browserless Test
...
.Non-Spring Projects
[TIP]
This guide assumes a Spring Boot project. If you aren't using Spring, see <<{articles}/building-apps/testing/browserless/setup-without-spring#, Non-Spring Projects>> for a simpler setup.
