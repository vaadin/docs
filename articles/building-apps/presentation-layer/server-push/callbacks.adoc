...
If you are building the user interface with Flow, you can use <<{articles}/building-apps/application-layer/background-jobs/interaction/callbacks#,callbacks>> to allow a background thread to update the user interface.
