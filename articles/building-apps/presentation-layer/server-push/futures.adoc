...
If you are building the user interface with Flow, a background thread can use the standard Java <<{articles}/building-apps/application-layer/background-jobs/interaction#completablefuture-flow,`CompletableFuture`>> to inform the user interface of results and errors. 
