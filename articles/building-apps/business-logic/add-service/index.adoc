...
If you want to read more about application service design the Vaadin Way, see the <</building-apps/deep-dives/building-blocks/application-services#,Application Services Deep Dive>>.
