...
----
<1> Writes the form data to a new `Proposal` Form Data Object (FDO). See the <<../bind-form#,Bind a Form>> guide for details (the example uses a JavaBean FDO and buffered mode).
