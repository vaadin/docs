...
This guide only covers the client-side validation. For server-side validation, see the <</building-apps/architecture/consistency/validation#,Validation Deep Dive>>.
