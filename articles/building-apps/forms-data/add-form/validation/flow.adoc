...
[NOTE]
If you are using Jakarta Bean Validation, Flow can delegate to it for validation. For details, see the <<{articles}/flow/binding-data/components-binder-beans#using-jsr-303-bean-validation,Flow Reference Guide>>.
