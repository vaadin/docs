...
Next we want to make sure that the entered hours are not more than a week. Depending on our use case, we might be more interested in calculating the minutes, but lets keep this simple.
