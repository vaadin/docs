...
// TODO Duration custom field

Step 3 - Setup Basics
====

```java
package com.vaadin.cf.components;
...
public class DurationField extends CustomField<Duration> {
    ...
    private NativeLabel createHoursLabel(String id) {
        var label = new NativeLabel(i18n.getHours());
        label.setId(id);
    ...
    private NativeLabel createMinutesLabel(String id) {
        var label = new NativeLabel(i18n.getMinutes());
        label.setId(id);
        label.addClassName(LumoUtility.Padding.Left.SMALL);
        return label;
    }
    ...
    private Span createAndSpan() {
        var andSpan = new Span(i18n.getAnd());
        andSpan.addClassName(LumoUtility.Padding.Left.SMALL);
        andSpan.addClassName(LumoUtility.Padding.Right.SMALL);
        return andSpan;
    }
    ...
    protected Duration generateModelValue() {
        return Duration.ofMinutes(60
                * (hours.getValue() != null ? hours.getValue() : 0)
