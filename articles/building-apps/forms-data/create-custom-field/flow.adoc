...
// TODO Im not sure whether component extending abstract field counts as custom field?
<<{articles}/flow/binding-data/field,Creating a Component that Has a Value>>
