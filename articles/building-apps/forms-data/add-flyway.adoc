...
[%collapsible]
====
The walking skeleton uses Testcontainers for the integration tests. Make sure you have Docker installed and running on your machine. Then run the `TaskServiceIT` integration test in your IDE. The test should pass, and in the log, you should see messages like the following:
