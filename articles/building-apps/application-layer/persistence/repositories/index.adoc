...
To address this issue, you should move all query methods that don't return entities to their own query classes. After moving the query method from the example above to its own class, you end up with something like this:
