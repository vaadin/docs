...
page-title: Implementing repositories with JPA and Spring Data | Vaadin
description: How to implement repositories with JPA and Spring Data in Vaadin applications.
order: 20
---
