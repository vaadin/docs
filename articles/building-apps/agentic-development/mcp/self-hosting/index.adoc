...
:commercial-banner-content: Running your own Vaadin MCP server requires a commercial Vaadin subscription, with a license key entitled to the MCP server. The hosted server at mcp.vaadin.com needs no subscription.
