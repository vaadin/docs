...
:commercial-banner-content: Running your own Vaadin MCP server requires a commercial Vaadin subscription with a license key entitled to the MCP server. It is a new product, so contact Vaadin to arrange the entitlement -- it cannot be added from your account page yet. The hosted server at mcp.vaadin.com needs no subscription.
