...
:commercial-banner-content: The self-hosted MCP server is part of the Vaadin Enterprise Edition. It needs a license key entitled to the MCP server, which Vaadin adds to your subscription on request -- it cannot be added from your account page yet. The hosted server at mcp.vaadin.com needs no subscription.
