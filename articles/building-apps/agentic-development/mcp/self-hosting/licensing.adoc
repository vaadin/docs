...
This takes two steps, because the MCP server is a separate product from the rest of a Vaadin subscription -- and new enough that you can't add it yourself yet.

. *Ask Vaadin to add the entitlement.* https://pages.vaadin.com/contact[Contact Vaadin] and ask for the MCP server to be added to your subscription. Don't skip this on the strength of an existing key: a Vaadin Pro or Flow key is perfectly valid and still gets refused, because it doesn't cover this product.
