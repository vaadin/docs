...
The self-hosted MCP server is part of the https://vaadin.com/enterprise[Vaadin Enterprise Edition]. Getting a key takes two steps, and the first can't be done from your account page yet.
