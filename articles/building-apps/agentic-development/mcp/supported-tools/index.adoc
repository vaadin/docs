...
[TIP]
====
If you use Claude Code or Codex, you can skip manual configuration. The <<{articles}/building-apps/agentic-development/agent-skills#,Vaadin Skills>> plugin, installed from the https://github.com/vaadin/agent-marketplace[Vaadin Agent Marketplace], sets up the Vaadin MCP server and Vaadin development skills together. See the <<claude-code# ,Claude Code>> and <<codex# ,Codex>> setup guides for the install commands.
====
...
* https://github.com/vaadin/agent-marketplace[Vaadin Agent Marketplace] — the marketplace for Vaadin's Claude Code and Codex plugins, including Vaadin Skills, which bundles the MCP server and skills
