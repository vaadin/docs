...
description: Describes how to configure authentication with Spring Security.
order: 90
layout: page
---
...
Update the `SecurityConfig` to use the [methodname]#setLogin()# helper, which sets up everything needed for a Hilla based login view:
[source,java]
----
