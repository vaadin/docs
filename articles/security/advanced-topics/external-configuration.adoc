...
It is often bad practice to put sensitive information, such as database URI, username, or password, in your [filename]#application.properties# file.
...
And note that in no case should you ever `git commit` passwords or other secrets into the repository.
