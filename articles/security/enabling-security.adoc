...
To access authenticated user details and to simplify logout handling Vaadin provides an injectable [classname]`AuthenticationContext` component,
strictly integrated with Spring Security.
