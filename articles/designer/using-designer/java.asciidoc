...
You may have already created the companion file at the time you <<{guide}/designer/getting-started/designer-build-your-main-view#, created the design>>
...
<<{articles}/flow/templates/polymer-template-basic#, Flow documentation>>.
...
Take a look at the Flow documentation to learn more about <<{articles}/flow/templates/template-components, binding components in Flow>>.
...
You can learn more about binding data to designs in <<{guide}/flow/templates/template-bindings, Flow documentation>>.
