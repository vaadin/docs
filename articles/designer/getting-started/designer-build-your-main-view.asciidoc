...
Our main layout is now looking great, but it is still missing the form. Proceed to the next chapter to add one: link:https://vaadin.com/docs/v14/designer/getting-started/designer-build-your-contact-form.html[Build your contact form]
