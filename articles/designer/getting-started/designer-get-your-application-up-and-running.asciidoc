...
Proceed to the next chapter to connect your views to Java: link:https://vaadin.com/docs/v14/designer/getting-started/designer-connecting-your-main-view-to-java.html[Connecting your Main View to Java]