...
image::images/designer-3-getting-started-vaadin.png[width=60%, scaledwidth=80%]
...
image::images/designer-3-getting-started-vaadin-next.png[width=60%, scaledwidth=80%]
...
image::images/designer-3-install-components-eclipse.png[width=60%]
...
.Layout templates
image::images/designer-3-layout-templates.png[width=50%, scaledwidth=50%]
...
image::images/designer-3-palette-dependency-missing.png[width=50%]
...
.The Outline
image::images/designer-3-outline.png[width=30%]
