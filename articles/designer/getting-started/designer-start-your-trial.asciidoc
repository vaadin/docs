...
Proceed to the next chapter to set-up a development environment: link:https://vaadin.com/docs/v14/designer/getting-started/designer-setting-up-your-environment.html[Setting up your environment]