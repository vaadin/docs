...
Routes to server-side Flow views are generated automatically, so that you just need to import them.
...
Although we use the library here to enable routing for TypeScript views, you can use it in any JavaScript application.


[.discussion-id]
99AFCB95-B7F9-4C8A-898F-7FFF7BDA0743
