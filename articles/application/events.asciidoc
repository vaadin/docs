...
To be able to access the component from the anonymous listener class, you can have a reference to the component that is declared before the constructor is executed.
