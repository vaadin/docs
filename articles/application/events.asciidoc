...
description: Handling events in a Hilla application.
order: 30
layout: page
---
...
When creating forms in Hilla applications, consider using the <<../data-binding/binder#,Form Binder>>.
...
See the <<lit#,LitElement Basics>> article for the binding syntax.
