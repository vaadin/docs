...
Views in Hilla are custom HTML elements that extend [classname]#LitElement#, [classname]#View#, or [classname]#Layout#, which handle rendering the component state reactively.
...
This requires the following changes in the `routes.ts` file:
