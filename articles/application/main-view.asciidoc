...
The stylesheets should be placed inside the `frontend` folder in the project.
...
Notice that the main view itself doesn't have a route, as it's only a frame for the actual content views.
