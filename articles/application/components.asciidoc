...
For information on setting up a Hilla project and defining a basic view, see the <<{articles}/guide/quick-start#, Quick Start Guide>>.
...
When bootstrapping a Hilla project from an https://start.vaadin.com/?preset=fusion[official starter], all Vaadin components frontend packages are automatically installed.
