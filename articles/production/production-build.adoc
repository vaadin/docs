...
The bundle can be optimized to use <<#_lazy_loading_javascript,lazy loading>> of components by forcing a build of the production bundle. To force creation of an optimized production bundle, execute the following from the command-line:
