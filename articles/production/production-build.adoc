...
It also creates or updates the [filename]#package.json#, [filename]#vite.config.json# and [filename]#vite.generated.json# files.
...
- create [filename]#vite.config.js# if not found, or update it if some project parameters have changed.
