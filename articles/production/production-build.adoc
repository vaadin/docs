...
The pre-compiled production bundle can be used not to have to run frontend tools like npm and Vite if no add-ons or front-end files are used in the application.
