...
Since Vaadin 24.1 there is a default production bundle that can be used to not have to run frontend tools like npm and vite if no add-ons or frontend files are used in the application.
