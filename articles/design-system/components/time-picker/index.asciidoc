...
Time Picker will try to interpret the input and convert it to a valid time.

For example, if you are using the English (US) locale, _"5.30"_, _"5-30"_, and _"5 30"_ will correctly map to _"5:30 AM"_.

It is recommended to provide the expected format with a <<{articles}/design-system/components/input-fields#helper,Helper>>.

[.example]
--
[source,html]
----
include::{root}/frontend/demo/component/timepicker/time-picker-parsing.ts[render,tags=snippet,indent=0,group=TypeScript]
----

[source, java]
----
include::{root}/src/main/java/com/vaadin/demo/component/timepicker/TimePickerParsing.java[render,tags=snippet,indent=0,group=Java]
----
--
...
[source,html]
----
include::{root}/frontend/demo/component/timepicker/time-picker-custom-parser.ts[render,tags=snippet,indent=0,group=TypeScript]
----

[source, java]
----
include::{root}/src/main/java/com/vaadin/demo/component/timepicker/TimePickerCustomParser.java[render,tags=snippet,indent=0,group=Java]
----
--
