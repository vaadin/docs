...
Longer free-form inputs are often capped at a certain character limit. The current character count and upper limit should be indicated to the user, e.g. by using the Helper feature:
