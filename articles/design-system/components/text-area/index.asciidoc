...
The current character count and upper limit should be indicated to the user, for example, by using the <<{articles}/design-system/components/input-fields#helper,Helper>> feature:
