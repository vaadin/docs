...
tab-title: Usage
page-links: \
https://github.com/vaadin/vaadin-date-time-picker-flow/releases/tag/{moduleMavenVersion:com.vaadin:vaadin-date-time-picker-flow}[{moduleMavenVersion:com.vaadin:vaadin-date-time-picker-flow}], \
https://github.com/vaadin/vaadin-date-time-picker/releases/tag/v{moduleNpmVersion:vaadin-date-time-picker}[{moduleNpmVersion:vaadin-date-time-picker}]
---
= Date Time Picker
...
Date Time Picker’s date field follows, by default, a strict input format defined by the locale.
The time field, on the other hand, tries to convert any input to a valid time.
For example, if you are using the English (US) locale, “5.30”, “5-30”, and “5 30” will correctly map to “5:30 AM”.

[.example]
--
[source,html]
----
include::{root}/frontend/demo/component/datetimepicker/date-time-picker-parsing.ts[render,tags=snippet,indent=0,group=TypeScript]
----

[source, java]
----
include::{root}/src/main/java/com/vaadin/demo/component/datetimepicker/DateTimePickerParsing.java[render,tags=snippet,indent=0,group=Java]
----
--

You can also apply a custom parser and formatter:

[.example]
--
[source,html]
----
include::{root}/frontend/demo/component/datetimepicker/date-time-picker-custom-parser.ts[render,tags=snippet,indent=0,group=TypeScript]
----

[source, java]
----
include::{root}/src/main/java/com/vaadin/demo/component/datetimepicker/DateTimePickerCustomParser.java[render,tags=snippet,indent=0,group=Java]
----
--
...
See <<helper,parsing & formatting>> for more details on how to parse user input.
