...
tab-title: Usage
page-links: \
https://github.com/vaadin/vaadin-flow-components/releases/tag/{moduleMavenVersion:com.vaadin:vaadin-checkbox-flow}[{moduleMavenVersion:com.vaadin:vaadin-checkbox-flow}], \
