...
[source, typescript]
----
include::{root}/frontend/demo/domain/Country.ts[group=TypeScript]
----
...
[source, html]
----
include::{root}/frontend/demo/component/combobox/combo-box-presentation.ts[render,tags=*,indent=0,group=TypeScript]
----

[source, typescript]
----
include::{root}/frontend/demo/domain/Person.ts[group=TypeScript]
----

[source, java]
----
include::{root}/src/main/java/com/vaadin/demo/component/combobox/ComboBoxPresentation.java[render,tags=*,indent=0,group=Java]
----
