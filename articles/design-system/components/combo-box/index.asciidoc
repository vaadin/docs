...
[source,typescript]
----
include::{root}/frontend/demo/component/combobox/combo-box-presentation.ts[render,tags=snippet,indent=0,group=TypeScript]
----

[source, java]
----
include::{root}/src/main/java/com/vaadin/demo/component/combobox/ComboBoxPresentation.java[render,tags=snippet,indent=0,group=Java]
----
--
...
[source,typescript]
----
include::{root}/frontend/demo/component/combobox/combo-box-filtering-1.ts[render,tags=snippet,indent=0,group=TypeScript]
----

[source, java]
----
include::{root}/src/main/java/com/vaadin/demo/component/combobox/ComboBoxFiltering1.java[render,tags=snippet,indent=0,group=Java]
----
--
