...
tab-title: Usage
page-links: \
https://github.com/vaadin/vaadin-flow-components/releases/tag/{moduleMavenVersion:com.vaadin:vaadin-dialog-flow}[{moduleMavenVersion:com.vaadin:vaadin-dialog-flow}], \
