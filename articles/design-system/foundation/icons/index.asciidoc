...
The icons are drawn on a 24&times;24 pixel canvas. There’s a safe area of approximately 4 pixels around the icon – giving a 16&times;16 pixel active area for the icon itself – allowing for optimizing each icon for visual/optical balance.
