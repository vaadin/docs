...
Windows and Mac users should download it from https://www.oracle.com/java/technologies/javase/javase8u211-later-archive-downloads.html[Oracle's Java 8 SE site].
...
[guilabel]#Version#::
 You can find the latest Vaadin version number from https://vaadin.com/download/[vaadin.com/download].
