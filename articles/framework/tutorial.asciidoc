...
TIP: The free training videos are an accessible way to get familiar with Vaadin 8. https://vaadin.com/learn/training[See all courses here!]
...
If you do not want to do the exercise at all, you can also just https://github.com/vaadin/tutorial/tree/master/[download the final application] and play around with it.
...
Windows and Mac users should download it from https://www.oracle.com/technetwork/java/javase/downloads/index.html[Oracle's Java
SE site].

Also make sure you have the latest version of your IDE.
Eclipse is available in various packages; be sure to download the *Eclipse IDE for Java EE Developers* from https://www.eclipse.org/downloads/[eclipse.org].
...
Many Java developers use a commercial tool called https://zeroturnaround.com/software/jrebel/[JRebel] to make code replacement work better.
...
can use
https://vaadin.com/api/framework/current/com/vaadin/annotations/PropertyId.html[PropertyId]
...
system to completely decouple the components. We'll leave that out of this tutorial for
simplicity.
...
https://spring.io/guides/gs/crud-with-vaadin/[Creating CRUD UI with Vaadin] guide
 ...
 * https://vaadin.com/docs/v8/framework/introduction/intro-overview[Vaadin online documentation]
 * https://vaadin.com/docs/v8/bakeryfw8/overview[Bakery App Starter for Vaadin Framework 8 and Spring] - A fully functional and tested full stack application for you to use as a starting point and a reference implementation on how business grade Vaadin applications should be made.
 * https://spring.io/guides/gs/crud-with-vaadin/[Creating CRUD UI with Vaadin] - the tutorial for your first Vaadin application using a Spring based backend.
 ...
 * https://vaadin.com/directory[Directory] - a vast source of awesome Vaadin add-ons
