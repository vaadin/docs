...
(GWT) code. I will mention the https://demo.vaadin.com/parking/[Parking
...
https://demo.vaadin.com/javadoc/com.vaadin.addon/vaadin-touchkit-agpl/4.0.0/com/vaadin/addon/touchkit/gwt/client/offlinemode/OfflineMode.html[com.vaadin.addon.touchkit.gwt.client.offlinemode.OfflineMode]
interface has nothing to do with server-side extension
https://demo.vaadin.com/javadoc/com.vaadin.addon/vaadin-touchkit-agpl/4.0.0/com/vaadin/addon/touchkit/extensions/OfflineMode.html[com.vaadin.addon.touchkit.extensions.OfflineMode]
...
offline mode, the
https://en.wikipedia.org/wiki/Cache_manifest_in_HTML5[HTML5 cache
...
https://demo.vaadin.com/javadoc/com.vaadin.addon/vaadin-touchkit-agpl/4.0.0/index.html?com/vaadin/addon/touchkit/extensions/LocalStorage.html[LocalStorage]
(TouchKit provides easy access to
https://www.w3schools.com/html/html5_webstorage.asp[HTML5 LocalStorage]
...
https://web.archive.org/web/20150403005605/http://dev.vaadin.com/ticket/13250[An issue with offline mode on
...
[source,java]
....
window.vaadinAppUrl = 'https://youraddress.com/path/'; // <--- slash is compulsory!
....
