...
https://ant.apache.org[Apache Ant 1.7]. You also need to download the
https://github.com/eriklumme/doc-attachments/raw/refs/heads/master/attachments/addressbook.tar.gz[source code]. *Note, that you have to edit the
