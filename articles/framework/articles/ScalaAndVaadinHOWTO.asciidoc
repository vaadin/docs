...
* Download and install https://eclipse.org/[Eclipse] Helios or Indigo by
...
Eclipse Plug-in] and https://www.scala-ide.org[Scala IDE Eclipse Plug-in]
...
* Download and install https://tomcat.apache.org/[Tomcat] by unpacking it
...
distribution from https://www.scala-lang.org/downloads.
...
https://www.scala-sbt.org/[SBT]-project that has Vaadin, Scala
...
https://github.com/henrikerola/scaladin/wiki[GitHub wiki] and the
