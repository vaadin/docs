...
trial and error on https://web.archive.org/web/20150403005605/http://dev.vaadin.com/ticket/13250[Vaadin ticket
13250].
...
<html>
  ...
  <body style='margin: 0px'>
    ...
    <iframe id='app' style='width: 0px; height: 0px; position: absolute; border: none' src='https://www.example.com/touch/'></iframe>
  </body>
</html>
....
