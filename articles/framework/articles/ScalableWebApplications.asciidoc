...
chapter
https://vaadin.com/docs/v8/framework/application/application-lifecycle[Application
...
public static void main(final String[] args) {
  try {
    LoadBalancingProxyClient loadBalancer = new LoadBalancingProxyClient()
      .addHost(new URI("https://192.168.2.86:8081"),"node1")
      .addHost(new URI("https://192.168.2.216:8082"),"node2")
