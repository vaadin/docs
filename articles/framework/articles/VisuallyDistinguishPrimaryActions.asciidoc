...
image:img/sign_in_no_distinction.png[Sign in - no distinction]
...
image:img/sign_in_primary_distinguished.png[Sign in - distinguished]
...
image:img/google_drive.png[Google drive]
...
image:img/sign_in_all_different.png[Sign in - all different]
