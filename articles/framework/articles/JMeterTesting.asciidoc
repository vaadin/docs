...
application with https://jakarta.apache.org/jmeter/[JMeter].
...
see the Vaadin ticket https://github.com/vaadin/framework/issues/4937[#4937].
...
https://jmeter.lazerycode.com/[plugin].
