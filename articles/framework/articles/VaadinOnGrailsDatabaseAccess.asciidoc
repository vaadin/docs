...
image:https://vaadinongrails.com/img/idea-new-domain.png[IDEA create domain class]
...
project.
image:https://vaadinongrails.com/img/idea-domain-name.png[IDEA domain name]
...
image:https://vaadinongrails.com/img/idea-service-new.png[IDEA new Grails Service]
...
image:https://vaadinongrails.com/img/data-from-service.png[Data from service]
...
image:https://vaadinongrails.com/img/idea-datasource.png[IDEA data source]
