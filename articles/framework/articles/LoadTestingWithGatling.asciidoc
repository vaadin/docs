...
https://gatling.io[Gatling] is a powerful tool for load testing. Compared
...
builds to make. Gatling has https://docs.gatling.io/reference/integrations/build-tools/maven-plugin/[a
