...
image:img/master_detail_wireframe.jpg[Master detail UI wireframe]
...
image:img/table_and_form.png[Address form]
...
image:img/buttons_added.png[Address form with add, delete, save and discard buttons]
...
image:img/database_connected.png[Form with database connected]
