...
* Eclipse IDE for Java EE developers from https://www.eclipse.org (Indigo
...
https://repo1.maven.org/maven2/archetype-catalog.xml as remote catalog
and select it.
...
https://127.0.0.1:8080/mylist/?gwt.codesvr=127.0.0.1:9997&restartApplication.
