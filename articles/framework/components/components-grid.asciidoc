...
ifdef::web[]
[.sampler]
link:https://demo.vaadin.com/sampler/#ui/grids-and-trees/grid[Demo]
endif::web[]
...
TIP: Watch the https://vaadin.com/learn/training/view/data-providers-and-grid[Vaadin 8: Data Providers and Grid] free training video to learn more about the DataProvider API, Grid, sorting and filtering.
