...
area.setValue("A row\n"+
              ...
              "Yet another row");
----
See the https://demo.vaadin.com/book-examples-vaadin7/book#component.textarea.basic[on-line example, window="_blank"].
...
----
See the https://demo.vaadin.com/book-examples-vaadin7/book#component.textarea.wordwrap[on-line example, window="_blank"].
