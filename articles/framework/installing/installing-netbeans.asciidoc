...
The Vaadin Plug-in for NetBeans IDE can also be downloaded from the plug-in page at https://plugins.netbeans.org/plugin/50531/vaadin-plug-in-for-netbeans[plugins.netbeans.org/plugin/50531/vaadin-plug-in-for-netbeans].
