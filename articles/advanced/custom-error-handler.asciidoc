...
[classname]`ErrorEvent` has method [methodname]`getComponent()` to get the handled [classname]`Component` and [methodname]`getElement()` method to get the handled [classname]`Element` when the error was thrown if available.
