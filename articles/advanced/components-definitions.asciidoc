...
See also the https://vaadin.com/docs/ds/components/grid#content[Grid content] example that demonstrates how to define `renderer` functions on the Grid columns to provide rich content based on the column.
