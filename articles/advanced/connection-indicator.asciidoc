...
description: The connection indicator informs the user of the server connection status, and indicates loading progress if network requests take some time.
Its duration and style are configurable.
order: 180
---
