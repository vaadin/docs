...
The [filename]#custom-css.js# uses the technique for wrapping CSS into JavaScript presented in <<{articles}/styling/advanced/importing-stylesheets#importing, Importing Style Sheets>>.
