...
Notice that the load mode does not affect files that are bundled by Vite.
...
This section covers static resource locations for resources that should not be bundled by Vite.
