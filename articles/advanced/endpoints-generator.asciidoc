...
[NOTE]
====
Hilla uses https://github.com/OAI/OpenAPI-Specification[OpenAPI Specification] as a middle layer between Java endpoints and TypeScript endpoint clients.
...
[NOTE]
====
All the other content types of request body object are not ignored by the Hilla Generator.
...
<1> As mentioned in https://github.com/OAI/OpenAPI-Specification/blob/master/versions/3.0.2.md#operationObject[operation object] specification, in Hilla Generator, `_tags_` are used to classify operations into TypeScript files.
