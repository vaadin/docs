...
[NOTE]
[classname]`DefaultI18NProvider` is available since Vaadin 24.3. For earlier version you need to implement your own [interfacename]`I18NProvider`, as documented in <<#defining-i18n-provider-property,Defining I18n Provider Property>> section.
