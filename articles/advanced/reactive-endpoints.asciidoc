...
Then click on the `Dev Tools` icon in the bottom-right corner and then on `Experimental features`.
Double-check that `Push support in Hilla` is enabled, or enable it if necessary.
