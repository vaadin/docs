...
Hilla relies on the https://github.com/FasterXML/jackson[Jackson] JSON library to do serialization, thus, it is possible
...
This is a corner case, and should not be necessary in Hilla since TypeScript generated API should take care on not passing unknown properties.
