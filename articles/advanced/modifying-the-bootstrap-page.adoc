...
Starting with Vaadin 15, the developer has full control of the contents of [filename]`index.html`. You can modify it in various ways.
...
There are a few methods to customize an application shell at runtime. They're described in the following sub-sections.
