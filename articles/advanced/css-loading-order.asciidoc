...
See <<{articles}/styling/application-theme#, Application Theme>> and <<{articles}/advanced/multi-app-themes#, Using a Theme in Multiple Applications>> for more information.
