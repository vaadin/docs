...
You can try it out at https://demo.vaadin.com/spreadsheet.
...
* link:https://poi.apache.org/spreadsheet/limitations.html[Limitations of Apache POI]
...
from the link:https://vaadin.com/docs/v8/spreadsheet/spreadsheet-overview[Vaadin Spreadsheet product page],
