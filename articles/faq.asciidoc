...
Currently neither Jakarta EE nor Quarkus support is on the roadmap, but we're aware that some people would be interested in those technologies as well. Let us know if you'd be interested in using either - if we know there's enough demand, that provides us guidance to adjust the priorities.
