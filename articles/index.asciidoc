...
banner: "New Acceleration Kits: link:/docs/latest/tools/observability[Observability Kit], link:/docs/latest/tools/sso[SSO Kit], and link:/docs/latest/tools/swing[Swing Kit]. Read the https://vaadin.com/blog/speed-up-your-development-with-the-vaadin-acceleration-kits[blog post]."
banner-style: tip
---
...
<<{articles}/components#, See all components>>
...
<<{articles}/tools/ce#,Collaboration Engine Overview>>
...
<<{articles}/tools/dspublisher#,Publisher Overview>>
...
[.card]
=== Azure Kit
image::_images/azure-kit.svg["", opts=inline, role=icon, width=48]
Deploy your Vaadin apps to the cloud.

<<{articles}/tools/azure-kit#,Azure Kit Overview>>
