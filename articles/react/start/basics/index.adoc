...
page-title: Spring Boot and React Full-Stack Development Tutorial
...
* `main/resources/data.sql` is a SQL script that populates the database with demo data on each start
