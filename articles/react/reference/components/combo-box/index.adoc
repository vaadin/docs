---
title: ComboBox
description: ComboBox allows the user to choose a value from a filterable list of options presented in an overlay.
---

= ComboBox

ComboBox allows the user to choose a value from a filterable list of options presented in an overlay. It supports lazy loading and can be configured to accept custom typed values.
