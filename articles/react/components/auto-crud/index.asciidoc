...
[source,tsx]
----
include::{root}/frontend/demo/component/auto-crud/react/auto-crud-visible-columns.tsx[tags=snippet,indent=0]
----

This results in rendering only those columns appeared in the `visibleColumns` props and according to order of appearing in the array:
