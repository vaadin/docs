...
You might use Message List for displaying a chat log. You can configure the text content, information about the sender, and the time of sending for each message.
