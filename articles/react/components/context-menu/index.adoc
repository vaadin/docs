...
The menu appears by default on right-click, or it can appear on left-click. On a touch device, a long press opens the context menu. Below is an example of this:
