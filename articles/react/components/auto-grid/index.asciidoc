...
=== Additional Column Filter Options

You can customize the filter options by using additional `columnOptions` properties like: `filterPlaceholder`, `filterDebounceTime` or `filterMinLength`:
