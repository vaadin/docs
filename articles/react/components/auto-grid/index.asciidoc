...
Auto Grid requires a Java service that implements the `dev.hilla.CrudService<T, ID>` interface. In this example, the `ProductService` class implements the interface based on a Spring Data JPA repository.
