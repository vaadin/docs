...
Upload shows the upload progress and status of each file. Files can be uploaded by clicking on the *Upload* button -- or by dragging them onto the component.
