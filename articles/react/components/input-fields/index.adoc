...
These features are described here, along with recommendations of how to best use them.

== Label

An input field should have a label to identify it. Labels should be clear, concise, and written in sentence case. Avoid unclear and verbose language. Use <<helper,helper texts>> to give more guidance, or tooltips in case helper text can't be accommodated.
