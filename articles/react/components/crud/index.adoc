...
The default Grid in CRUD is replaceable. This is useful when you wish to customize the Grid. An example might be if you want to place the edit Button in the first column, or to apply <<../grid#tooltips,tooltips>>. See <<../grid#,Grid documentation>> for details on configuring grids.
