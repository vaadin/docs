...
The editor can be positioned in an overlay, on the side, or at the bottom. The sub-sections below explain each position.
...
* [guibutton]*Delete* is used to delete the item, permanently. After the user clicks this button, they're asked to confirm this action.
...
* [guibutton]*Save* saves any changes and closes the editor. This is disabled until there is a change.
...
Sometimes the toolbar isn't needed. When this is so, you can hide it.
