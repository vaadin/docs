...
The component's default orientation is horizontal, but vertical orientation is recommended whenever possible. It's typically easier for the user to scan a vertical list of options:
