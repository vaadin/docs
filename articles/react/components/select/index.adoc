...
Items can be disabled. Doing this prevents users from selecting them, while still showing that they're potentially available for selection, but under different circumstances.
