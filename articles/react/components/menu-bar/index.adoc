...
Menu items can trigger an action, open a menu, or function as a toggle.
...
Items that don't fit into the width of the menu bar collapse automatically into an overflow menu at the end:
