...
[CAUTION]
The behavior of the [methodname]`scrollToIndex()` method in Tree Grid isn't deterministic due to lazy-loading hierarchical data. It isn't recommended to use this method.
