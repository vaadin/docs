...
If a back-end process takes longer than 1 second, use a Progress Bar to show the user that something is happening. This is important when it blocks the user's workflow.
