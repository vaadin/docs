...
Switch from indeterminate to determinate if the progress becomes computable. Similarly, switch from determinate to indeterminate if it becomes uncomputable.
