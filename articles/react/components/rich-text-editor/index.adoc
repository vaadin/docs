...
Unless set to a fixed height, Rich Text Area automatically adjusts its height based on its content.

=== Minimum & Maximum Height

The automatic resizing can be restricted to a minimum and maximum height, as you can see in the example here:
