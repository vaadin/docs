...
Auto Form uses the same validation mechanism as <<{articles}/react/guides/forms/binder-validation#,default Hilla Forms>>. That means you can add Bean validation annotations to your entity classes and the form automatically validates the input values on both client and server.
