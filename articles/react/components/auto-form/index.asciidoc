...
==== Customizing field client-side validation

You can use the `validators` property of the `fieldOptions` to add new client-side validation of the field. The following example shows how to validate the `firstName` field to be longer than 3 characters:

[.example.desktop]
--
[source,tsx]
----
include::{root}/frontend/demo/component/auto-form/react/auto-form-field-custom-validator.tsx[render,frame,tags=snippet,indent=0]
----
--
