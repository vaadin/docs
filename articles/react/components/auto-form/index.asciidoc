...
[NOTE]
When the Auto Form component is rendered based on its default settings similar to the example above, it uses the <<../form-layout#,Form Layout component>>'s  default responsive breakpoints.
