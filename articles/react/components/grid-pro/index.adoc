...
[NOTE]
====
Grid Pro is an extension of the <<../grid#,Grid>> component, so all Grid features are also applicable to Grid Pro.
====
...
- kbd:[Tab] saves any changes and shifts focus to the next editable cell. kbd:[Shift + Tab] does the but shifts the focus to the previous editable cell. The user remains in edit mode for either one.
