...
By using the Enter Next Row mode, kbd:[Enter] and kbd:[Shift+Enter] will focus the editable cell in the next and previous row, respectively. 
...
Inline editing is recommended when the user typically needs to make a lot of small changes to different items, and quick editing is important.
