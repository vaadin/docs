...
image::{articles}/react/components/_images/cat-dataentry.svg[opts=inline, role=banner]
...
image::{articles}/react/components/_images/cat-vizandix.svg[opts=inline, role=banner]
...
image::{articles}/react/components/_images/cat-layouts.svg[opts=inline, role=banner]
...
image::{articles}/react/components/_images/theme-editor-icon.png[role=banner,width=224]
...
image::{articles}/react/components/_images/figma-logo.svg[opts=inline, role=banner]
...
image::{articles}/react/components/_images/accessibility-symbol.svg[opts=inline, role=banner]
