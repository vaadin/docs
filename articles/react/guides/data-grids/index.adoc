...
href="https://cdn.githubraw.com/vaadin/docs/hilla/articles/react/guides/data-grids/data.sql"
style="color:#FFFFFF"
...
For more information about the Auto Grid feature, see the <<{articles}/react/components/auto-grid#,Auto Grid>> documentation.
