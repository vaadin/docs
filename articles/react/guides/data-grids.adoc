...
First, create a JPA entity class in the backend. For this tutorial, you are using a simple entity that represents a product. Create a [filename]`Product.java` file next to `Application.java` with the following contents:
