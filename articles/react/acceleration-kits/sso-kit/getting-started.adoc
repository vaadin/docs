...
include::{articles}/lit/acceleration-kits/sso-kit/getting-started.adoc[tag=serverside]
...
include::{articles}/lit/acceleration-kits/sso-kit/getting-started.adoc[tag=singlesignoff]
