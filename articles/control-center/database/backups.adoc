...
You can refer to the xref:../../flow/configuration/licenses/index.adoc[licenses section] to know more about Vaadin commercial licenses.
...
[source,shell]
----
kubectl -n <control_center_namespace> create secret vaadin-license --from-file=license-key=/path/to/keyFile
----

Once the secret is created, you must refer to it during installation by setting the `licenseKeySecret` value to the name of the secret.

[source,shell]
----
helm install control-center [...] --set licenseKeySecret=vaadin-license
----
...
kubectl create secret generic aws-creds \
  ...
  --from-file=ACCESS_SECRET_KEY=/path/to/access_secret_key_file.txt
----
...
kubectl create secret generic azure-creds \
  ...
  --from-file=AZURE_STORAGE_CONNECTION_STRING=/path/to/connection_string.txt
----
