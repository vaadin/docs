...
Since backups are a commercial feature, you must provide a valid Vaadin pro license key to enable the feature.
...
[source,shell]
----
kubectl -n <control_center_namespace> create secret vaadin-license --from-file=license-key=/path/to/proKey
----
