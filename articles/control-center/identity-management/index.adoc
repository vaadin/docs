...
After you created an identity provider you can find it in the *Identity Providers* list. You can select one to check its details, update some of the fields, or delete it:
...
After you created the providers you can see them on the login form. If you want to remove any of the providers, you can disable or delete the provider in the provider settings. This login form shows the previously created identity providers:
