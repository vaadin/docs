...
To create a new user, first select the relevant application from the [guilabel]*Application Selector*, as shown in the screenshot here. It will display the application's dashboard.
...
Next, you may want to define specific roles to make controling access easier within your application. Roles can be used to limit access for a set of users to certain views or features.
