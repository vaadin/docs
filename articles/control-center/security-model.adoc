...
The full list of permissions granted to Control Center is defined in the https://github.com/vaadin/control-center/blob/gradle/charts/control-center/templates/rbac.yaml[RBAC template,window=read-later] included in the Helm chart.
