...
Control Center is installed and managed using link:https://helm.sh/[Helm,window=read-later]. By default, installing or upgrading without specifying a version will use the latest available stable release.
