...
To access Control Center from your local machine, you'll need to add a couple of entries to your [filename]`hosts` file.
...
To deploy Control Center, enter the following from the command-line:
