...
[IMPORTANT]
Granting cluster-wide administrative privileges enables automated installation of the required dependencies. If you choose not to grant these privileges, you'll need to install the necessary resources manually. This is highly recommended for production environments. See <<production-installation#,Production Installation>> for details on how to do this.
