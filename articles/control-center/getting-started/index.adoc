...
To deploy Control Center to a Kubernetes cluster, the process is different depending on whether you're using it in a development or production environment. The following sections explain how to deploy Control Center in each case.
