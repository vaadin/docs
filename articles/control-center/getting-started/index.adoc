...
For example, a node with 4 Virtual CPUs and 8 GB of memory should be sufficient for Control Center and an application created with https://start.vaadin.com[Vaadin Start].
====
