...
If you don't have a certificate yet, or you are not deploying to the production environment, you can create one with a tool like https://mkcert.org/[mkcert], using the following command:
...
This command creates the `cert.pem` and `key.pem` files.
