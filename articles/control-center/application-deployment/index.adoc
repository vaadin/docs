...
Another common tag is `latest` to mark the most recent release, but using this tag forces Kubernetes to always pull the image from the registry and requires the image to be available there.
====
