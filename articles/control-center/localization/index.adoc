...
image::../localization/images/feature-toggle.png[Localization View with Feature Disabled]
...
image::../localization/images/upload-dialog.png[Upload Dialog]
...
image::../localization/images/add-language.png[Adding a new language]
...
image::../localization/images/editing-translations.png[Translations View with Toolbar and Grid]
