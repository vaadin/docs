...
By identifying and highlighting any false positives associated with Vaadin Flow and its dependencies, AppSec Kit makes it easier for developers to identify the vulnerabilities that need addressing. 

AppSec Kit flags “false positive” vulnerabilities that were identified in the dependencies of the Vaadin platform. It shows the analysis from Vaadin’s security team, describing why it was considered a false positive. This allows you to focus on the vulnerabilities that matter, and to avoid distractions caused by false alarms.
