...
AppSec Kit flags any “false positive” vulnerabilities that were identified in the dependencies of the Vaadin platforml. It shows the analysis from Vaadin’s security team, describing why it was considered a false positive. This allows you to focus on the vulnerabilities that matter, and to avoid distractions caused by false alarms.
