...
The basic building blocks of the Lumo theme is a set of _design tokens_, which are essentially a set of CSS custom properties for things like colors, font sizes, and other typographic and layout settings.
Lumo theme combines these design tokens to provide Vaadin applications and components with their default look and feel.
...
For example, you can use Lumo dark mode variant to create a dark theme for your application.
...
For instance, you can add a small margin around all views and components in your application by adding the following to a CSS stylesheet:
