...
This page lists Lumo size and space <<{articles}/components/ds-resources/customization/css-custom-properties#,CSS Custom Properties>>, which you can use to apply consistent sizing and spacing across your application.

Note that there is a built-in <<{articles}/styling/lumo/variants/compact#, Lumo compact mode variant>> that you can enable to reduce the font size and the sizing and spacing of all components, allowing you to place more components on the screen.
