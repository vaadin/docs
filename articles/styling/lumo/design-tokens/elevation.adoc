...
This page lists Lumo elevation-related <<{articles}/components/ds-resources/customization/css-custom-properties#,CSS Custom Properties>>, which you can use to create visually consistent elevation styles.
