...
The dark variant can also be https://cookbook.vaadin.com/os-light-dark-theme:[applied automatically based on the operating system's light/dark mode setting,window_blank]. It’s exposed to the browser through the `prefers-color-scheme` CSS feature.
