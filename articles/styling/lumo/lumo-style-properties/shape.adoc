...
This page lists Lumo shapes-related <<{articles}/styling/custom-theme/css-custom-properties#,CSS Custom Properties>>, which you can use to adjust the visual style of component shapes.
