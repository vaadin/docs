...
You can either follow the _web_ approach and use the pointer (hand) cursor for clickable items, or take the _desktop_ approach and use the default (arrow) cursor.
