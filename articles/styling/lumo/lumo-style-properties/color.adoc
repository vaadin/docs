...
You can use the built-in <<{articles}/styling/lumo/variants/light-dark#, Lumo light and dark mode variants>> to switch the color palette of all components in your application.
