...
This page lists Lumo size and space <<{articles}/styling/custom-theme/css-custom-properties#,CSS Custom Properties>>, which you can use to apply consistent sizing and spacing across your application.

You can enable the built-in <<{articles}/styling/lumo/variants/compact#, Lumo compact mode variant>> to reduce the font size and the sizing and spacing of all components, allowing you to place more components on the screen.
