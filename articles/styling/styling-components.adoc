...
Aura style properties are prefixed with `--aura-` while Lumo style properties are prefixed with `--lumo-`. The theme style properties are listed on the <<themes/base#, Aura>> and <<themes/base#, Lumo>> reference pages.
