...
Lumo is available in a light and dark variant. The light variant is the default. You can switch to the dark variant statically, or let the OS or browser settings determine which is used:
