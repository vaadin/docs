...
One way to do this is to use the `Style` API in Flow to set inline CSS properties on the root element directly, supplying either hardcoded or dynamically generated values:
