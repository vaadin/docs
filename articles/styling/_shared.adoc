...
In order to increase the roundness of the corners, you can override the default value of this variable.
Specifically, you can add the following inside the [filename]`styles.css` file in order to increase the default roundness value:
