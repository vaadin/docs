...
For example, if we give a ComboBox a class name from the Java API, only the `vaadin-combo-box` element will get this class name in the DOM, not the `vaadin-combo-box-overlay` element.
