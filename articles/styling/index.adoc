...
Vaadin themes can be loaded with the [classname]`@StyleSheet` annotation or with a CSS `@import` rule in your own stylesheet. The [classname]`Aura` and [classname]`Lumo` Java classes provide constants for the stylesheet path that can be used with the [classname]`@StyleSheet` annotation.
