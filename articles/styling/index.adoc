...
By default, Vaadin components are rendered with their minimalistic built-in base styles, which are a good starting point if you want to customize the look and feel extensively. Vaadin also ships with two themes, <<{articles}/components/themes/aura#, Aura>> and <<{articles}/components/themes/lumo#, Lumo>>, that provide a more polished look and feel for Vaadin components.
...
Both themes provide a comprehensive set of style properties (CSS custom properties) that make them easily customizable without complex CSS selectors. These properties are listed on the <<{articles}/components/themes/aura#, Aura>> and <<{articles}/components/themes/lumo#, Lumo>> reference pages.
