...
By default, Vaadin components are rendered with their minimalistic built-in <<themes/base#, base styles>>, which are a good starting point if you want to customize the look and feel extensively. Vaadin also ships with two themes, <<themes/base#, Aura>> and <<themes/base#, Lumo>>, that provide a more polished look and feel for Vaadin components.
...
Both themes provide a comprehensive set of style properties (CSS custom properties) that make them easily customizable without complex CSS selectors. These properties are listed on the <<themes/base#, Aura>> and <<themes/base#, Lumo>> reference pages.
