...
|`--aura-red` | `--aura-red-text` xref:./#read-only-properties[Read-only,role=badge] xref:#light-dark-function[light-dark(),role="badge light-dark"]
|`--aura-orange` | `--aura-orange-text` xref:./#read-only-properties[Read-only,role=badge] xref:#light-dark-function[light-dark(),role="badge light-dark"]
|`--aura-yellow` | `--aura-yellow-text` xref:./#read-only-properties[Read-only,role=badge] xref:#light-dark-function[light-dark(),role="badge light-dark"]
|`--aura-green` | `--aura-green-text` xref:./#read-only-properties[Read-only,role=badge] xref:#light-dark-function[light-dark(),role="badge light-dark"]
|`--aura-blue` | `--aura-blue-text` xref:./#read-only-properties[Read-only,role=badge] xref:#light-dark-function[light-dark(),role="badge light-dark"]
|`--aura-purple` | `--aura-purple-text` xref:./#read-only-properties[Read-only,role=badge] xref:#light-dark-function[light-dark(),role="badge light-dark"]
|===
