...
`--aura-base-font-size`::
A number without a unit (i.e., _not_ a CSS length value) that represents the M size in pixels.
...
A number without a unit (i.e., _not_ a CSS length value), relative to the corresponding font size.
