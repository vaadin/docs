...
Lumo supports automatic color scheme selection based on the user's operating system or browser preference. See <<{articles}/styling/themes#color-schemes,Color Schemes>> for how to apply different color schemes in your application.
