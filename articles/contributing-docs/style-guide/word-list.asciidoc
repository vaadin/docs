...
On the other hand, _like_ "expects" to be followed by a noun phrase (that's a phrase that has the grammatical function of a noun). +
For example:
...
*or* +
_It's hoped that the new version will be released at the beginning of July._
====
...
=== "justified"
Text that's _justified_ is aligned on the left and on the right.
...
[.discussion-id]
ECF2A383-1FCE-4659-9697-480EA3A257AF
