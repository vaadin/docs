...
On the other hand, in a _passive_ sentence, the subject of the verb is *not* the _agent_; that is, it isn't the person or thing that performs the verb. +
...
Although split infinitives are generally considered to be acceptable these days, it's worth considering whether you could easily write your sentence so as to avoid it.
