...
----
+
The [classname]#PersonModel# here is generated alongside a [classname]#Person# TypeScript data interface from the `Person.java` bean. It describes the structure of the data and the validation-related metadata for the form binding.
