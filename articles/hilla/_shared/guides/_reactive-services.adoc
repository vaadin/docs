...
Start with a Vaadin project that has browser-callable services enabled: see <<{articles}/getting-started#,Getting Started>> for creating a project, and <<browser-callable-services#enabling,Enabling Browser-Callable Services in a Vaadin Project>> for the dependency they need.
