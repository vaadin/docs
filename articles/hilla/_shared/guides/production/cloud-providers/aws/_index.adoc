...
Download a minimal Vaadin project as described in the <<{articles}/getting-started/quick-start#,Quick Start>> guide, and unpack the downloaded ZIP file into a folder on your computer.

== Step 3: Change the Server Port

AWS Elastic Beanstalk is configured to forward requests to port 5000 by default, whereas the starter application runs on port 8080.
