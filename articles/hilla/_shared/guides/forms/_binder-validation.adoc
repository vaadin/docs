...
This example uses a third-party library to measure the password strength with a custom validator. Add a dependency to your [filename]`pom.xml`:
...
This example uses a third-party library to measure the password strength with a custom validator. Add a dependency to your [filename]`package.json`:
