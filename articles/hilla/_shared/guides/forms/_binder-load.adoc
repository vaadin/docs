...
Below is an example in which [methodname]`submit` behavior is set to submit to a service method:
...
Below is an example in which [methodname]`submitTo()` is set to submit to a service method:
