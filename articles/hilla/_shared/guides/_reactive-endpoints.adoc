...
Start with a Vaadin project that has endpoints enabled: see <<{articles}/getting-started#,Getting Started>> for creating a project, and <<endpoints#enabling,Enabling Endpoints in a Vaadin Project>> for the dependency they need.
