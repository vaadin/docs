...
The data should go to browser-callable services, and those services should be protected instead. Read <<./configuring#, Configuring Security>> on protecting services to learn more about this.
