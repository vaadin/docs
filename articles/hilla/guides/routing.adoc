...
= [since:com.vaadin:vaadin@v24.4]#File-system Based Routing#

Since Vaadin 24.4, Hilla React applications are using the file-system based router. This documentation can guide you through the basics of using routing in your application.
