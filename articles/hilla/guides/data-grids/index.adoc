---
title: Data Grids
page-title: How to work with data grids in Hilla | Vaadin
description: Quickly create data grids using the Auto Grid feature.
meta-description: Learn to create and manage advanced data grids in applications using Vaadin's Hilla for data visualization.
order: 65
---
...
This guide assumes a Vaadin project with React views. See <<{articles}/getting-started#,Getting Started>> for creating a project, and <<../browser-callable-services#enabling,Enabling Browser-Callable Services in a Vaadin Project>> for the dependency that browser-callable services and React views need.
...
To have some example product data, download this SQL script and put it in the `src/main/resources` folder:

++++
<p>
<a
class="button primary water"
href="https://cdn.githubraw.com/vaadin/docs/latest/articles/hilla/guides/data-grids/data.sql"
style="color:#FFFFFF"
