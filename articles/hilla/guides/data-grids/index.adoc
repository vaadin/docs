...
This guide assumes a Vaadin project with React views. See <<{articles}/getting-started#,Getting Started>> for creating a project, and <<../endpoints#enabling,Enabling Endpoints in a Vaadin Project>> for the dependency that endpoints and React views need.
