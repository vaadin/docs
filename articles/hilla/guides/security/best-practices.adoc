...
By default, a browser-callable service requires requests to be authenticated.
...
Vaadin always recommends developers to set up secure server services and run all communication exclusively under HTTPS.
