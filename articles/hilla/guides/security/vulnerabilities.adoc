...
However, SQL injections can be completely blocked in Hilla applications by validating and escaping data as described in <<best-practices#, Security Best Practices>>, as well as by following standard secure database access practices.

Most providers have their own ways of dealing with injections out of the box, and following those guides is recommended.
