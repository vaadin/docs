...
The discovery needs the Spring Boot application class on the module's classpath. When that class is in another module, configure the discovery explicitly, as described in <<endpoint-discovery, Explicit Discovery of Browser-Callable Classes>>.
