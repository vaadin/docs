...
page-title: Connection indicator reference for Hilla apps | Vaadin
...
meta-description: Understand the Hilla connection indicator and how it helps manage connectivity in web applications.
...
The connection indicator can be configured from TypeScript in the frontend entry point -- [filename]`index.tsx` in a React application, or [filename]`index.ts` in a Lit application.
