...
include::{articles}/hilla/react/components/_input-field-common-features.adoc[tags=basic-intro;label;helper;placeholder;tooltip;]
...
[source,html]
----
include::{articles}/hilla/react/components/_shared-code-snippets.adoc[tags=aria-label-dtp-typescript,indent=0,group=TypeScript]
----
endif::[]
...
[source,java]
----
include::{articles}/hilla/react/components/_shared-code-snippets.adoc[tags=aria-label-dtp-java,indent=0,group=Java]
----
endif::[]
--
====
...
include::{articles}/hilla/react/components/_input-field-common-features.adoc[tag=readonly-and-disabled]
...
include::{articles}/hilla/react/components/_input-field-common-features.adoc[tags=styles-intro;text-alignment;small-variant;helper-above-field;borders]
