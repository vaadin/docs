...
href="https://cdn.githubraw.com/vaadin/docs/hilla/articles/hilla/react/guides/data-grids/data.sql"
style="color:#FFFFFF"
...
Next, create a view that renders the product data. Create a [filename]`ProductsView.tsx` file in the [filename]`frontend/views` folder with the following content:
...
For more information about the Auto Grid feature, see the <<{articles}/hilla/react/components/auto-grid#,Auto Grid>> documentation.
