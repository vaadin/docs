...
Hilla also supports <<{articles}/hilla/react/guides/production/native#,compiling GraalVM native images>> to optimize further the startup time or the memory consumption.
