...
----
<1> The `padding` property is defined using the <<{articles}/components/themes/lumo/lumo-style-properties/size-space#space,spacing properties>> to be consistent with the rest of the app.
