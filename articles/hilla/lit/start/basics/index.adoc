...
Next, you create a view for adding and viewing to-do items. You can choose to build it step by step, learning some concepts along the way, or to copy the complete view implementation if you are in a hurry. When you're ready, you can learn more about <<{articles}/hilla/lit/components/create#,creating components>>.
