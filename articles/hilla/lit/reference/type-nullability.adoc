...
While Hilla supports using any annotation that has the name `nonnull` (case-insensitive), Vaadin recommends using the `org.jspecify.annotations.NonNull`. Below are some examples of other supported `nonnull` annotations:
