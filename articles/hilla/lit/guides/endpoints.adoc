...
By default, the generated files are located under `{project.basedir}/src/main/frontend/generated`. You can change the folder by providing the path for the generator in the `generatedFrontendDirectory` property for the Hilla Maven plugin.
