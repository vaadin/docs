...
[NOTE]
====
The `'Frontend/'` path prefix is an alias for the `{project.basedir}/src/main/frontend` directory in your application project (or `{project.basedir}/frontend` if using the default convention from before Vaadin 24.4).
