...
Hilla uses the <<{articles}/components/themes/lumo#,Vaadin Lumo theme>> as a base for component and application styling.
Lumo is based on a set of <<{articles}/components/themes/lumo/lumo-style-properties#,CSS custom properties>> that you can use to achieve a consistent look and feel across applications.
