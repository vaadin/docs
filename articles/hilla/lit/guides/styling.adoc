...
Lumo is based on a set of <<{articles}/styling/themes/lumo/lumo-style-properties#,CSS custom properties>> that you can use to achieve a consistent look and feel across applications.
