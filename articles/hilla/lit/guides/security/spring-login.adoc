...
Next, you'd implement <<Implement Client-Side Security, Client-Side Security>>, including user information endpoint, `useAuth` and `AuthProvider` objects and their use. Also, implement <<Create a Login View, Login View>>. 
