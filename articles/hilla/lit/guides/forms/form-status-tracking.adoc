...
.OfficeService.java
----
include::{root}/src/main/java/com/vaadin/demo/fusion/forms/formchange/OfficeService.java[]
----
[source,java]
.CompanyOffice.java
----
include::{root}/src/main/java/com/vaadin/demo/fusion/forms/formchange/CompanyOffice.java[]
----
[source,java]
.Country.java
----
include::{root}/src/main/java/com/vaadin/demo/fusion/forms/formchange/Country.java[]
----
[source,java]
.City.java
----
include::{root}/src/main/java/com/vaadin/demo/fusion/forms/formchange/City.java[]
----
--
====
