...
You define your server-side services here, using Java packages and classes. <<browser-callable-services,Browser-callable services>> allow your client-side views access to the back-end data.
+
