...
Re-routing to a custom access denial views is also possible with annotation [annotationname]`@AccessDeniedErrorRouter`, see <<{articles}/advanced/custom-error-handler#, Customizing Error Messages for Unauthorized Views>>.
