...
In many use cases, this is fine, but if you expect to share links to the target view, the target view must maintain enough details in the URL and deserialize the parameters, as described in <<route-parameters#, Route Parameters>>.
