...
== Maintaining Route Parameters without Navigation

Route parameters are most often defined in a link pointing to a specific view with the desired state and when navigating to view the Router calls the view's [methodname]`setParameter` method.
