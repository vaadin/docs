...
Custom theme files are served separately from the front-end bundle. They can be modified on the fly; the browser live-reload triggers a refresh immediately -- no re-compilation is needed.
