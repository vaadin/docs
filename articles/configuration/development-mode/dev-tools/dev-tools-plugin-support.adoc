...
[NOTE]
Plugin script file should be located under `./frontend/` if it is only used inside the project and under `./src/resorces/META-INF/frontend/` for add-on packaged dev plugins.
