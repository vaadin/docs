...
We suggest running your Vaadin project with https://github.com/TravaOpenJDK/trava-jdk-11-dcevm/releases[TravaOpenJDK Dynamic Code Evolution Virtual Machine] (DCEVM), version 11.0.7+2 or later, which includes HotswapAgent with full live reload support.
