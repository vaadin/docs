...
If your project includes such components or tools, the commercial license will only be needed for development and to build the production application.
...
Under the hood, a license file will be created in your machine at the following location:
...
If your local development environment is offline and cannot reach https://vaadin.com[vaadin.com], you need to download an offline license.
...
This will generate an [filename]#offlineKey# file that you should place in your _home_ directory:
...
. Alternatively, you can supply the license information using a system property
+
