...
updateV14Branch() {
  ...
  #https://github.com/vaadin/docs/blob/v14/articles/flow/tools/mpr/configuration/mpr-cdi-tutorial.asciidoc
  sed -i "s/version>14.*/version>$1<\/version>/g" "articles/flow/tools/mpr/configuration/mpr-cdi-tutorial.asciidoc" || exit 1
  
  #https://github.com/vaadin/docs/blob/v14/articles/flow/tools/mpr/introduction/step-1-maven-v7.asciidoc
  sed -i "s/version>14.*/version>$1<\/version>/g" "articles/flow/tools/mpr/introduction/step-1-maven-v7.asciidoc" || exit 1

  #https://github.com/vaadin/docs/blob/v14/articles/flow/tools/mpr/introduction/step-1-maven-v8.asciidoc 
  sed -i "s/version>14.*/version>$1<\/version>/g" "articles/flow/tools/mpr/introduction/step-1-maven-v8.asciidoc" || exit 1
}
 
# update versions in latest branch
updateLatestBranch() {
  #https://github.com/vaadin/docs/blob/latest/articles/flow/_vaadin-version.adoc
  sed -i "s/vaadin-version\:.*/vaadin-version: $1/g" "articles/flow/_vaadin-version.adoc" || exit 1
}
