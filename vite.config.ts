  ...
  plugins: [
    {
      ...
      transform(code, id) {
        if (id.endsWith('src/main/frontend/generated/flow/generated-flow-webcomponent-imports.js')) {
          return code
            .split('\n')
            .filter((row) => {
    ...
    },
    {
      ...
      transform(_code, id) {
        ...
        // (like src/main/frontend/generated/flow/web-components/accordion-basic-wc.ts)
        ...
        // (in src/main/frontend/demo/example-resources.ts).
