...
@customElement('scroller-overflow-indicator-bottom')
  ...
  protected override render() {
    return html`
      <vaadin-card style="max-width: 400px">
        <div slot="title" style="">Summer Tech Conference 2025</div>
        <!-- tag::snippet[] -->
        <vaadin-scroller
          theme="overflow-indicator-top"
          style="max-height: 300px; --vaadin-scroller-padding-block: 1rem"
        >
