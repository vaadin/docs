        ...
        <div>
          ...
          <vaadin-side-nav style="width:100%">
            <vaadin-side-nav-item path="/inbox">
              ...
              Inbox
              <span theme="badge contrast pill" aria-label="12 unread messages" slot="suffix">12</span>
            </vaadin-side-nav-item>
            <vaadin-side-nav-item path="/calendar">
              <vaadin-icon icon="vaadin:calendar" slot="prefix"></vaadin-icon>
              Calendar
              <vaadin-icon icon="vaadin:bell" theme="badge error pill"
                style="padding:var(--lumo-space-xs)" aria-label="Upcoming appointment"
                slot="suffix"></vaadin-icon>
            </vaadin-side-nav-item>
          </vaadin-side-nav>
          <!-- end::snippet[] -->
        </div>
