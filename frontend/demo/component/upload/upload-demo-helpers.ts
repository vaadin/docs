import type { UploadFile } from '@vaadin/vaadin-upload';
...
export function fakeErrorResponse(event: CustomEvent) {
  (event.detail.xhr.status as any) = 500;
}

export function fakeErrorResponseWrapper(callback: (event: CustomEvent) => void) {
