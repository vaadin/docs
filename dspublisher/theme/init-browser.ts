...
export class Header extends LitElement {
  ...
  protected firstUpdated(): void {
    ...
    if (localStorage.getItem('vaadin.docsApp.preferredTheme') === null) {
      document.documentElement.setAttribute('theme', 'dark');
      localStorage.setItem('vaadin.docsApp.preferredTheme', 'dark');
    }
  }
  ...
  render() {
    return html`
        <div class="hilla-header-wrapper">
            <div class="hilla-header hilla-header--container">
                <div>
                    <a class="hilla-header--logo"
                       href="/">
                        <svg width="90"
                             height="30"
                             fill="none"
                            ...
                            <g clip-path="url(#c)"
                               fill="var(--docs-heading-text-color)">
                                <path
